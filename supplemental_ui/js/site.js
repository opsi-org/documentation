!(function () {
    ...
    a.addEventListener("click", function (e) {
        ...
        t.classList.add("is-clipped--nav"), a.classList.add("is-active"), i.classList.add("is-active");
    ...
    var e,
        ...
        r,
        s,
        l = i.querySelector("[data-panel=menu]");
    function t() {
        var e,
            t,
        ...
        if (n && (n.indexOf("%") && (n = decodeURIComponent(n)), !(e = l.querySelector('.nav-link[href="' + n + '"]')))) {
            ...
            if (n)
                for (var i = n, a = document.querySelector("article.doc"); (i = i.parentNode) && i !== a; ) {
                    var c = i.id;
                    if ((c = !c && (c = o.test(i.className)) ? (i.firstElementChild || {}).id : c) && (e = l.querySelector('.nav-link[href="#' + c + '"]'))) break;
                }
        }
        if (e) t = e.parentNode;
        else {
    ...
    function u(e) {
        ...
        e.classList.remove("is-clipped--nav"), a.classList.remove("is-active"), i.classList.remove("is-active"), e.removeEventListener("click", u);
    }
    function v(e) {
        e.stopPropagation();
    }
    function p(e, t) {
        ...
        "sticky" === a.position && (i -= n.top - parseFloat(a.top)), (e.scrollTop = Math.max(0, 0.5 * (t.getBoundingClientRect().height - i) + t.offsetTop));
    }
    function h(e, t) {
    ...
    l &&
        ...
        l.querySelector('.nav-link[href^="#"]') && (window.location.hash && t(), window.addEventListener("hashchange", t)));
})();
!(function () {
    "use strict";
    ...
    if (e) {
        ...
        if (!(t < 0)) {
            ...
            var c,
                s,
                l,
                u = ((c = n.join(",")), (s = d.parentNode), [].slice.call((s || document).querySelectorAll(c)));
            if (!u.length) return e.parentNode.removeChild(e);
            var f = {},
                ...
                p = e.querySelector(".toc-menu");
            p || ((p = document.createElement("div")).className = "toc-menu");
            var v = document.createElement("h3");
            (v.textContent = e.dataset.title || "Contents"), p.appendChild(v), p.appendChild(m);
            e = !document.getElementById("toc") && d.querySelector("h1.page ~ :not(.is-before-toc)");
            e && (((v = document.createElement("aside")).className = "toc embedded"), v.appendChild(p.cloneNode(!0)), e.parentNode.insertBefore(v, e)),
    ...
    function h() {
        var t,
            ...
            o = 1.15 * g(document.documentElement, "fontSize"),
            n = d.offsetTop;
        if (e && window.innerHeight + e + 2 >= document.documentElement.scrollHeight) {
            ...
            return (
                u.forEach(function (e, t) {
                    var o = "#" + e.id;
                    t === r || e.getBoundingClientRect().top + g(e, "paddingTop") > n ? (i.push(o), l.indexOf(o) < 0 && f[o].classList.add("is-active")) : ~l.indexOf(o) && f[l.shift()].classList.remove("is-active");
                }),
                (m.scrollTop = m.scrollHeight - m.offsetHeight),
                void (l = 1 < i.length ? i : i[0])
            );
        }
        Array.isArray(l) &&
            ...
            (l = void 0)),
            u.some(function (e) {
                return e.getBoundingClientRect().top + g(e, "paddingTop") - o > n || void (t = "#" + e.id);
            }),
            t
                ? t !== l && (l && f[l].classList.remove("is-active"), (e = f[t]).classList.add("is-active"), m.scrollHeight > m.offsetHeight && (m.scrollTop = Math.max(0, e.offsetTop + e.offsetHeight - m.offsetHeight)), (l = t))
                : l && (f[l].classList.remove("is-active"), (l = void 0));
    }
    function g(e, t) {
    ...
    t &&
        t.addEventListener(
            ...
            function (t) {
                ...
                e.classList.toggle("is-active") && ((e.style.maxHeight = ""), (t = window.innerHeight - Math.round(e.getBoundingClientRect().top)), parseInt(window.getComputedStyle(e).maxHeight, 10) !== t && (e.style.maxHeight = t + "px"));
            }.bind(t)
        );
})();
!(function () {
    ...
    [].slice.call(document.querySelectorAll(".doc pre.highlight, .doc .literalblock pre")).forEach(function (e) {
        ...
        ((c = document.createElement("div")).className = "source-toolbox"),
            ...
            window.navigator.clipboard &&
                ...
                "svg" === r.svgAs
                    ? ((o = document.createElementNS("http://www.w3.org/2000/svg", "svg")).setAttribute("class", "copy-icon"),
                      ...
                      o.appendChild(i),
                      n.appendChild(o))
                    : (((a = document.createElement("img")).src = window.uiRootPath + "/img/octicons-16.svg#view-clippy"), (a.alt = "copy icon"), (a.className = "copy-icon"), n.appendChild(a)),
