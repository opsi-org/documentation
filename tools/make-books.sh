...
AVAILABLE_MANUALS=(manual getting-started releasenotes windows-client linux-client macos-client opsi-script quickinstall opsi-script-reference-card supportmatrix)
