...
Add the abo repositories to the '/etc/opsi/opsi-package-updater.conf'
...
[source,prompt]
----
opsi-package-updater -p "mshotfix,mshotfix-win7-x86-glb,mshotfix-win7-win2008r2-x64-glb"
----
...
We now provide an updated package link:https://download.uib.de/abo/mshotfix/opsi4/misc/dotnetfx-hotfix_201705-1.opsi[dotnetfx-hotfix_201705-1.opsi].
