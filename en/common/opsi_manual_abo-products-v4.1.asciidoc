...
If you want to define different default properties, install the packages once with `opsi-package-manager -p ask -i <packagename>.opsi`.
...
CAUTION: Windows 10 1511 is not supported anymore since 12/2017.
