...
[cols="12,3,5"]
|==========================
|  Netboot product   | Opsi 4.0.7 | Remark
...
|ubuntu16-04    | image:supported.png[width=15] | ubuntu16-04_4.0.7.2-1
|ubuntu14-04    | image:develop.png[width=15]   |
|debian9	| image:supported.png[width=15] | debian9_4.0.7.2-1.opsi
|debian8        | image:supported.png[width=15] | debian8_4.0.7.2-1.opsi
...
|opensusel42-2  | image:supported.png[width=15] |opensusel42-2_4.0.7.2-2
|opensusel42-1  | image:supported.png[width=15] |opensusel42-1_4.0.7.2-2
...
|sles11sp3      | image:supported.png[width=15]    |
|==========================
