...
.product-group menue
image::../images/configed_productgroup_en.png[width=300]
...
image::../images/configed_serverconfiguration_en.png[width=300]
...
image::../images/editconfigdefaults.png[width=300]
...
image::../images/opsi-configed-hostparameters.png[width=300]
...
image::../images/opsi-software-on-demand_en.png[width = 300]
...
image::../images/opsi-software-on-demand_actions_en.png[width=300]
