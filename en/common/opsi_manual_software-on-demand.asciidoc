...
|software-on-demand.active|activates or deactivates the module, is used as a flag for the migration (<<software-on-demand_kiosk_migration, Automatic migration of the kiosk from the opsi-client-agent (>=4.1.1.6.5)>>). It's irrelevant for the opsi-client-kiosk with version >=4.1.1.6-5. |true/false
