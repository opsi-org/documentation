...
image::../images/opsi-configed-mode-selection.png["opsi-configed: Menu bar with button licenses (rightmost)", width="50mm"]
...
.License management: Tab '{license-pool}s' 
image::../images/licensemanagement-licensepools.png["License management: Tab license-pools", width="180mm"]
...
.Tab "New license" from the licence management window
image::../images/licensemanagement-createlicense.png["Tab 'New license'", width="120mm"]
...
The unique contract ID (licenseContractId) is for identifiying the licence contract in the licence management database.  
...
.License management: tab "Edit licenses" from the licence management window
image::../images/licensemanagement-editlicense.png["License management: tab 'Lizenzierungen bearbeiten'", width="120mm"]
...
image::../images/licensemanagement-editlicense-copying-license-id.png["License management: copying the licene ID", width="120mm"]
...
This method registers a new licence contract record with the ID licenseContractId. 
...
.License management: tab "Licenses usage" from the licence management window
image::../images/licensemanagement-usages.png["License management: tab Licenses usage", width="120mm"]
...
image::../images/licensemanagement-reconciliation.png["License management: tab "Reconciliation" (data matching) with the inventory, width="120mm"]
...
image::../images/licensemanagement-statistics.png["License management: tab Statistics from the license management window", width="120mm"]
...
Examples can be found in the products 'license-test-....opsi' from http://download.uib.de/opsi4.0/products/license-management/. 
After installing these packets with 'opsi-package-manager -i *.opsi', 
in the directory '/opt/pcbin/install/<produktname>' the scripts 'create_license-*.sh' can be found.
As an example here the script `script create_license-mixed.sh`
