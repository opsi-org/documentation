...
size it is easy to determine how much space opsi logs will require.
...
For 100 Clients we then should reserve up to 2530MB for the logs of opsi.
Da 'logrotate' normalerweise zeitgesteuert aktiv wird, empfehlen wir diese
Zahl aufzurunden. Dadurch erhält man außerdem etwas Reserve, falls man sich
dazu entschließt neue Clients hinzuzufügen.
