...
Additionally, if necessary, the option 'bind_user' can be used.
This can be used to define which user name should be passed when authenticating to the LDAP/AD. Here the placeholders '{username}' and '{base}' can be used.
