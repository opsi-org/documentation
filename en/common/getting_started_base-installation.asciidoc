...
For a description of the management interface check <<firststeps-software-deployment-configed-start>>.

You have a running opsi server now, i.e. the opsi application itself is fully configured.

You can now proceed with:

* <<firststeps-software-deployment-client-integration,Integration of existing Windows clients”>>

* <<firststeps-osinstall,Installation of a new Windows PC with opsi (OS Installation)>>
