...
NOTE: Starting from opsi-script v. 4.12.5, opsi-script allows TOML files handling. +
...
NOTE: Please refer to the official documentation of TOML files to respect the official data formats : https://toml.io/en/ +
...
NOTE: Keep in mind that adding new values must respect the TOML notation within the input String parameter according to the official documentation : https://toml.io/en/ +
...
<value> = ' True ' +
- if you want to add a Number type value with the content 1.1 (Floats are written with a . not a , ), it should be written as follows : +
<value> = ' 1.1 ' +
