...
* `contains(`<str>, <substr>, <case sensitive>='true'`)` [W/L/M] +
Boolean function which returns 'true' if <str> contains <substr>. This function is case sensitive by default.
Since opsi-script 4.12.5.0 you can use a third parameter <case sensitive> to determine whether the comparison should be case sensitive or not. +
...
if contains($ConstTest$, $CompValue$, 'true')
	comment "passed"
else
	set $TestResult$ = "not o.k."
	LogWarning "failed"
...
if contains($ConstTest$, $CompValue$, 'false')
	comment "passed"
else
	set $TestResult$ = "not o.k."
	LogWarning "failed"
...
* `contains(`<str>, <substr>, <case sensitive>='true'`)` [W/L/M] +
Boolean function which returns 'true' if <str> contains <substr>. This function is case sensitive by default.
Since opsi-script 4.12.5.0 you can decide with the third parameter <case sensitive> whether the comparison should be case sensitive or not. +
Available since 4.11.3 +
see also : <<contains>>
