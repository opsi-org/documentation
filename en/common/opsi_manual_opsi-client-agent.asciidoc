...
WARNING: This chapter is only relevant for opsi-client-agent versions \<= 4.1.0.0. Since 4.1.1.0 the kiosk is outsourced and available as opsi-client-kiosk package. For description of the opsi-client-kiosk see: <<software-on-demand>>
