...
Even if opsi is open source, there are some additional components that were created or maintained as part of a co-financing project and are not (yet) free of charge.
...
As part of participation in the corresponding co-funding projects, you will receive an activation file for the permanent and normal use of the activated components.
