...
|Ubuntu Xenial 16.04           | image:supported.png[width=15] |    ubuntu |    image:supported.png[width=15]  | image:supported.png[width=15]
...
|Ubuntu Vivid 15.04            | image:discontinued.png[width=15] |    ubuntu,ubunt15-04 |    image:supported.png[width=15]  | image:unsupported.png[width=15] 
|Ubuntu Utopic 14.10           | image:discontinued.png[width=15] |    ubuntu |    image:supported.png[width=15]  | image:unsupported.png[width=15] 
...
|SLES 11SP4                    | image:supported.png[width=15] |      |  image:supported.png[width=15]  | image:develop.png[width=15] 
