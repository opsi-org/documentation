...
.Supported Linux OS as Client in opsi 4.1 and 4.0.7
[cols="11,3,7,3,3"]
|==========================
...
|Ubuntu Boinic 18.04 LTS       | image:develop.png[width=15]    | ubuntu, ubuntu18-04 | image:develop.png[width=15] | image:supported.png[width=15]
...
.Linux netboot products and the used installer type in opsi 4.1 and 4.0.7
[cols="4,4,3,5"]
|==========================
...
|ubuntu18-04     | distribution | image:develop.png[width=15] |
