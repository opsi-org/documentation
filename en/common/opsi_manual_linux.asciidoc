...
Size of the system partition. The size may be given as percent of the harddisk size or as absolut size (G=Gigabyte). If you choose a other value the  100% , the rest will be used as  data_partition.

* `swap_partition_size`: +
Size of the  swap partition.

* `data_partition_create`: +
Create a data partition if there is space left. (true/false)
...
* `language`: +
Which language / locale should be installed ?
