...
values: ["ucs.test", "example.com"]
default: ["ucs.test"]

name: ldap_base
multivalue: False
editable: True
description: Example dc=example,dc=com
values: ["dc=ucs,dc=test","dc=example,dc=com"]
default: ["dc=ucs,dc=test"]

name: ucs_code_name
multivalue: False
editable: True
description: ucs_code_name
values: ["ucs410"]
default: ["ucs410"]
...
multivalue: False
editable: True
description: What is the name of the organisation (needed for ucs) ?
values: ["uib gmbh"]
default: ["uib gmbh"]

multivalue: False
editable: True
description: What is the name of the windows domain ?
values: ["MYDOMAIN"]
default: ["MYDOMAIN"]
...
multivalue: False
editable: True
description: What is the IP Number of the UCS Domain Controller (needed for other roles to join) ?
values: ["10.10.10.10"]
default: ["10.10.10.10"]

name: ucs_master_admin_passwd
multivalue: False
editable: True
...
multivalue: False
editable: False
description: Which UCS Role should be installed ?
values: ["domaincontroller_master","domaincontroller_backup","domaincontroller_slave","memberserver","base"]
...
FILE=http://download.uib.de/opsi4.0/products/opsi-linux/univention-repository/univention-repository-4.1.tgz
mkdir -p ${DOCUMENTROOT}/opsi
cd ${DOCUMENTROOT}/opsi
wget ${URL}/${FILE}
tar xzf ${FILE}
...
UCS_RELEASE_PATH=dists/ucs410/main/binary-amd64/Release
