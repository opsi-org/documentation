...
In this directory are the log-files of the '{opsi-winst}' running on the client.  The client log files will be named `<client FQDN>.log`. On the client you will find this file at `C:\opsi.org\log\instlog.txt`
