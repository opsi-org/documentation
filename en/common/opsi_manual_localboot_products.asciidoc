...
* *disable_sensors*: Windows 10 logs informations on the current geolocation of the device. This property makes it possible to disable this logging.
...
* *sync_settings*: Windows 10 makes it possible to synchronise made settings with an account and restore these saved settings on another device running Windows 10.dd
