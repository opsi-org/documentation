...
To use this procedure you first add a <<firststeps-osinstall-create-client,client to opsi>> and then perform an <<firststeps-osinstall,OS installation>>.

////
ifdef::gstarted[see also: <<firststeps-osinstall,OS installation>>]
ifdef::linclientmanual[see also: <<firststeps-osinstall,OS installation>>]
ifdef::winclientmanual[see also: <<firststeps-osinstall,OS installation>>].
////
