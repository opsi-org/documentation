...
image::../images/configed-masterbuttons.png["Showing the properties of a depot",width=200]
...
image::../images/configed-depotsettings.png["Depot properties from the opsi-configed",width=400]
