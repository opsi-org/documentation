...
If +webdav+ is used as +clientconfig.depot.protocol+ respectively +clientconfig.depot.sync_protocol+, the '{opsi-depotserver}' will also be verified accordingly.
...
To release the clients manually you can use the admin page https://<opsi-server>:4447/admin (see <<opsi-manual-configuration-tools-opsi-interface-page>>).
