...
To tell the clients that they now have to use this new share, you should execute at your '{opsi-configserver}' the following script:
...
----
Run the following command at your '{opsi-configserver}' to to create this configuration entry for all clients:
