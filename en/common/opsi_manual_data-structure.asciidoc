...
CAUTION: Communicating with an opsi 4.0 webservice leads to a HTTP
header _content-type_ that does not match the real content encoding.
Since release of opsi 4.0.6 it is possible to activate a https://www.ietf.org/rfc/rfc2616.txt[RFC 2616]
