...
* Section [Package] +
Description of the package version and packages required for installation on an {opsi-depotserver}.
* Section [Product] +
...
* [Package]-'depends' +
refers to an package required for installation of this package on an {opsi-depotserver}.
