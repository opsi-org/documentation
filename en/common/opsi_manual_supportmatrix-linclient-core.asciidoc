...
|SLES 12.4                     | image:supported.png[width=15]      | sles12sp4 | image:supported.png[width=15] | image:develop.png[width=15]
|SLES 12.3                     | image:supported.png[width=15]      | sles12sp3 | image:supported.png[width=15] | image:develop.png[width=15]
