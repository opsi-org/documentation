...
[[opsi-manual-wimcap]]
=== opsi extension 'opsi WIM Capture'
...
The name of the image created can't be automatically added to the list of installable images at the current time. You have to keep the name in mind and state the image name when deploying!
