...
unlike the 'install.wim' which must be copied into the directory. +
...
* All software, which should be installed in the image, on the computer.
...
*Apply the new image on the computer:*
