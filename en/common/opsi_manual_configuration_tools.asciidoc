...
Accessing the https://<opsi-server>:4447/info website renders 'opsiconfd' actual tasks, sessions, load and cpu/memory utilization during the last hour/day/month/year  in a graphic time chart, besides other tabular information.
