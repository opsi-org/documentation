...
image::../images/opsi_with_sql_file_backend.png["Scheme: opsi with File / MySQL backend", width=430]
...
image::../images/configed-masterbuttons2.png["{opsi-configed}: Button bar", width=400]
