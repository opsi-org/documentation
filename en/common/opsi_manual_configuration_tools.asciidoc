...
NOTE: Since Java version 1.6.24 Oracle has deactivated the 'Copy & Paste' from a Java Applet in the browser for security reasons. But 'Drag & Drop' is still working'
...
You may sen the selected clients a shutdown or reboot signal. You have to confirm this command at the opsi-configed.
