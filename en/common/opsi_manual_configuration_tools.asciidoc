...
This in most cases on a '{opsi-depotserver}' the central '{opsi-configserver}'. So on any call of the 'opsi-product-updater' the '{opsi-product-packages}' wil be fechted from the '{opsi-configserver}'. This can be done for example by a cronjob.
