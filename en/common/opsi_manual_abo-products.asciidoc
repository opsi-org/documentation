...
version:: Here you can switch which Versions should be installed, 3.5 includes all other versions before. 4.7.1 includes all 4.x versions Note: Win7 has 3.5 by default. "all" means 4.6
...
We provides patches from Microsoft for

Microsoft .NET Framework 4 and above for Windows 7 / 8.1
