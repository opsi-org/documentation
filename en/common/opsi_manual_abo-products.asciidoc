...
An equivalent approach ist the usage of for example an `/etc/opsi/opsi-package-updater.conf.abo.standard` which can  encalled via `opsi-package-updater -c /etc/opsi/psi-product-updater.conf.abo.standard`
