...
----
ooffice                         4.1.1-2                   Apache OpenOffice
----
...
libreoffice-version::
description: 'Stable' - is an Extended Support Release from LibreOffice for the conservative user - default version (4.2.6.6); 'Experimental' is a version for the experimental user from LibreOffice (4.3.1)
