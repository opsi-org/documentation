...
=== Server-Console
CAUTION: The following feature only works with python-opsi version 4.0.7.40 (???). This include the "Predefined commands with input masks" and the execution of the predefined commands.
...
Deactivate the "Server-Console" menu. (Default: true)
...
* Set opsi-rights ... +
This menu uses the script opsi-set-rights to set rights on a directory (optional).
