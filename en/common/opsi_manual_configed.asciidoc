...
* via the webstart link on the general server page https://<servername>:4447
* by the URL https://<servername>:4447/configed
* or by directly calling https://<servername>:4447/configed.jnlp

It may as well be called via  

javaws  https://<servername>:4447/configed.jnlp

which can be produces by local start menu entry (such as configured by the opsi product opsi-configed).
