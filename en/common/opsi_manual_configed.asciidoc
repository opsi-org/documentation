...
* Download from data ... +
Any data file can be downloaded from the Internet also can be download with the "wget"-command and stored in a certain path on the Server. This could be used for example to download opsi-packages from download.uib.de
...
If the zsync and md5 files of an opsi package are to be downloaded, the switch "zsync and md5 include" must be activated.
Thus the url of the packages is added accordingly and the additional files are also obtained. +
