...
=======
In non-opsi systems the '{opsi-configed}' can be simply installed by copying the required jar archive files as contained e.g. in the opsi-package.
In order to automate this, the setup program `opsi-configed-setup.exe` for Windows clients or `opsi-configed-linux-setup.tar.gz` can be downloaded from link:http://download.uib.de/opsi4.1/misc/helper/[].
>>>>>>> e5ad48a2fc53469187e0aad5db6af0077c3dd323
...
=======
Without a graphical desktop there exist only the following non-gui start options:
>>>>>>> e5ad48a2fc53469187e0aad5db6af0077c3dd323
