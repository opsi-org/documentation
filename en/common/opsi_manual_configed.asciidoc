...
=== Server-Console
CAUTION: The following feature only works with python-opsi version 4.0.7.38. This include the "Predefined commands with input masks" and the execution of the predefined commands.
