...
* the property name contains the String 'password', or
* the property name begins with the String 'secret'

then instead of the property value '*****' is displayed. Only if you click on the value field and confirm that the 
real value should be displayed it will become visible. 
