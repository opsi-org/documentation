...
image::../images/netboot-pxeos.png["PXE-Boot loaded with bootimage preparing hard disk for operating system installation",width=300]
...
image::../images/netboot-win-nt6-properties.png["NT6 product properties",width=200]
...
.NT6 image names
image::../images/netboot-win-nt6-properties-imagenames.png["NT6 image names",width=200]
...
system_keyboard_layout:: Select keyboard language

.Select keyboard language
image::../images/netboot-win-nt6-properties-keyboards.png["Select keyboard language",width=200]
...
image::../images/netboot-win-nt6-properties-winpartionsize.png["Size of the system partion",width=200]
