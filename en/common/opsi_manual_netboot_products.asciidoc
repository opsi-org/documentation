...
sets the value 'timeout' in `/etc/opsi/dhclient.conf` within the opsi-linu-bootimage (default 30 seconds).
...
architecture:: Select the bootimage architecture (e.g. 32/64 Bit). This will not (!) affect the architecture of the installed Operating System. +
