...
image::../images/opsi-configed-client-reachable.png["Client reachable",width=10]

.'{opsi-configed}': Client not reachable
image::../images/opsi-configed-client-unreachable.png["Client not reachable",width=10]
...
image::../images/opsi-configed-failedactions-today_en.png["{opsi-configed}: Failed Actions - today", width=250]
...
image::../images/opsi-configed-produkt-defaultproperties-jedit-different-values_en.png["{opsi-configed}: Product default properties", width=500]
