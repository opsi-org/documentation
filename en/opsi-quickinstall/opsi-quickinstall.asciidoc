...
opsi-manual under chapter '9.5.10.1 The product l-opsi-server' : https://download.uib.de/opsi_stable/doc/opsi-handbuch-stable-en.pdf . There you also find the default values of the properties.
