...
[lime-background]#https://download.uib.de/...#
...
[lime-background]#opsi-manual under chapter '9.5.10.1 The product l-opsi-server'#: [lime-background]#https://download.uib.de/opsi_stable/doc/opsi-handbuch-stable-en.pdf#
...
* type nothing in and press Enter to use the default value for this question. You can find the default values in the [lime-background]#opsi-manual under chapter '9.5.10.1 The product l-opsi-server'#: [lime-background]#https://download.uib.de/opsi_stable/doc/opsi-handbuch-stable-en.pdf#
