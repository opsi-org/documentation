...
* The local configed can be set to the previous protocol version by the Java call parameter '-Dhttps.protocols=TLSv1', the call is named (depending on the other configuration) +
[source, prompt]
----
