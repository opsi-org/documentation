...
image::opsi-client-kiosk.png["opsi-kiosk-client: Main Window", width=500]

.'opsi-client-kiosk': Actionrequest confirmation
image::opsi-client-kiosk2.png["opsi-kiosk-client: Actionrequest confirmation", width=300]
