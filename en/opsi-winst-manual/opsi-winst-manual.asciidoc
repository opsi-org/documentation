...
As of version 4.11.4 there is a Linux port of 'opsi-script' with the name 'opsi-script'.

As of version 4.12.1 there is a MacOS port of 'opsi-script' with the name 'opsi-script'.
...
[[opsi-script-global-const-list-winst]]
...
include::../../en/common/os-lib_uib_macos_install.asciidoc[]
