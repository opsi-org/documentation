...
[options="header"]
|==========================
| Key | Ubuntu | Debian | openSUSE | SLES | CentOS
|Distributor ID | Ubuntu |  |  | SUSE LINUX | CentOS
|Release | 12.04 |  |  | 11 | 6.5
|Codename | precise |  | n/a |  | Final
|==========================
...
.Installing a package at Ubuntu / Debian
...
.Installing a package at CentOS / Redhat
