...
opsi-winst / opsi-script Manual (4.11.4)
========================================
...
|Ubuntu Precise| Ubuntu | 12.04 | precise |  
|Ubuntu Trusty| Ubuntu | 14.04 | trusty | 
|Debian 6 | Debian | 6.0.10 | squeeze | Debian GNU/Linux 6.0.10 (squeeze)
|Debian 7 | Debian | 6.0.10 | wheezy | 
|openSUSE 12.3 | openSUSE project | 12.3 |  | 
|openSUSE 13.1 | openSUSE project | 13.1 | Bottle | 
|SLES11SP3 | SUSE LINUX | 11 | n/a | 
|Fedora20 | Fedora | 20 |  | 
|CentOS 6.5 | CentOS | 6.5 | Final | 
|CentOS 7.0 | CentOS | 7.0 | Final | 
|==========================
...
Since 4.11.4.2 there is a shortcut for this expression:
