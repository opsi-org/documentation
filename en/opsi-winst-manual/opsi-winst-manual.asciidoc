...
|UCS-2LE    |   ucs2le   |		(UTF-16-LE, Windows NT Standard)
...
CAUTION: The old function `LogLevel=` is deprecated since '{opsi-script}' version 4.10.3. For backward compatibility reasons Loglevels ste by this old function will be increased by 4 before they are used.
