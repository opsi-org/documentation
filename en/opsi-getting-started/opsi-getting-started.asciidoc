...
Next, add the opsi RHEL Repository:
...
If necessary, adapt the file `/etc/apt/apt.conf` to your network configuration (enter the correct proxy, or comment/delete unnecessary lines). You can edit your file with a program like â€žmidnight commanderâ€œ:
