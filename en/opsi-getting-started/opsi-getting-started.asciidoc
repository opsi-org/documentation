...
'opsifileadmins' group will no longer be fix, but will be self-assigned in UDM, which will also
...
TIP: If you use UCS 4.0 or higher and you have no existing opsi installtion, you can skip the following steps and can continue with adding the repositories.
