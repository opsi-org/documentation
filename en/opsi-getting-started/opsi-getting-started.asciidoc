...
CAUTION: Ubuntu 14.04, codename Trusty Tar, is currently not officially supported but repositories for this Ubuntu version exist. Problems may still occur. We do not recommend using this in a productive environment.
