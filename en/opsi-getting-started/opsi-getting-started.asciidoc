...
CAUTION: SLES is currently not officially supported but repositories exist. Problems may still occur. We do not recommend using this in a productive environment.
