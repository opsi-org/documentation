...
* Download the file 'opsi4.0-servervm.soa' from the internet.

* Start the Virtualbox. At the menue 'File' / 'Import Appliance' select your `*.soa` file and import it.
...
opsi 4.0 is tested and released for UCS 2.4, 3.0 and 3.1
