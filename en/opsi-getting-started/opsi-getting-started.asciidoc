...
* Download the file 'opsi4.0.5-2-servervm.zip' from the internet.
...
opsi 4.0 is tested and released for UCS 3.2 and UCS 4.0
...
Next, activate the opsi4ucs repository (UCS 3.2 is also installed from the 3.0 repository):
...
* opsi 4.0 is built and tested for openSUSE 12.3 und openSUSE 13.1 .

* The support for openSUSE 11.3, 12.1, 12.2 is deprecated.
...
* opsi 4.0 is build and tested for RHEL 6 & 7.
...
* opsi 4.0 is built and tested for CentOS 6 & 7.
