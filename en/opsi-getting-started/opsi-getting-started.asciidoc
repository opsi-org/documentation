...
* Download the file 'opsi4.0.5-1-servervm.zip' from the internet.
...
CAUTION: Ubuntu 14.04, codename Trusty Tahr, is currently not officially supported but repositories for this Ubuntu version exist. Problems may still occur. We do not recommend using this in a productive environment.
...
opsi 4.0 is tested and released for UCS 3.2.
...
image::../images/boot-cd-authent.png["Screenshot: bootimage / boot-cd: Authenticate as member of {opsiadmin} group",width=400]
