...
* The Ignore-List of the Samba4-Connector will be modified: the user pcpatch will be removed if found as a entry in the ignorelist.

* The MySQL-Backend will be configured to use for inventorydata in opsi (dispatch.conf will be modified).
...
It is possible to install opsi4ucs on a UCS Master, Backup, or Slave but not on Member.
