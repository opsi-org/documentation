...
* Download the file 'opsi4.x-servervm.zip' from the internet.
...
* Download the file 'opsi4.x-servervm.ova' from the internet.
...
CAUTION: UCS 3.0, UCS 3.1 and UCS 3.2 is not supported by the new opsi 4.0.5. Even if there are rebositories you should wait for the official release before using opsi 4.05 in a productive environment together with UCS.
...
CAUTION: UCS 3.0, UCS 3.1 and UCS 3.2 are currently not officially supported but repositories exist. Problems may still occur. We do not recommend using this in a productive environment.
...
Next, activate the opsi4ucs repository (UCS 3.1 and 3.2 are also installed from the 3.0 repository):
