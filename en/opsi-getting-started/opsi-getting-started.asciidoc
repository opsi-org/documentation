...
If you want to use the opsi server as DHCP server, you have to install the DHCP server package. After the installation you must configure the dhcp configuration for opsi. This is done by the following command:
[source,prompt]
----
