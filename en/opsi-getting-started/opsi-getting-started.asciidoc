...
* The configuration is not realized automatically during the opsi installation on an active UCS-Infraestructure because the configurations already exists.
