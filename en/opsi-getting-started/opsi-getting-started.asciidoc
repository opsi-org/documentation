...
----
+
have to send the IP-adress of the network gateway the client connected with. If the command send the result '127.0.0.1' or '127.0.0.2' then file `/etc/hosts` have to be corrected.
