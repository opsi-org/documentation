...
By performing a double click the Icon 'opsi-product-updater FirstRun' the minimal opsi Products will be installed. To do this please introduce the current password for the adminuser.
...
In this chapter, we assume you are familiar with the debian-package system (you will find information about the debian-package in the appropriate Debian books, in the manual pages or in the link:https://www.debian.org/doc/[Debian documentation].
...
You can use the tools shown in <<opsi-getting-started-softwintegration-tutorial-analyse-and-repackage>>.
