...
[[opsi-script-rc]]
= opsi-script reference card (4.12.4.35)
...
ifdef::manual[see also: <<opsi-script-global-const-list-system-base>>]
...
ifdef::manual[see also : <<opsi-script-global-const-list-commondir>>]
...
ifdef::manual[see also : <<opsi-script-global-const-list-defaultdir>>]
...
ifdef::manual[see also : <<opsi-script-global-const-list-currentuser>>]
...
ifdef::manual[see also : <<opsi-script-global-const-list-allntuser>>]
...
ifdef::manual[see also : <<opsi-script-global-const-list-oscript>>]
...
ifdef::manual[see also : <<opsi-script-global-const-list-network>>]
...
ifdef::manual[see also : <<opsi-script-global-const-list-service>>]
...
ifdef::manual[see also : <<replaceOpsiConstants_list>>]

`replaceOpsiConstants(`<string>`) : string`  //since 4.12.3.6 [W/L/M]
ifdef::manual[see also : <<replaceOpsiConstants_string>>]
...
ifdef::manual[see also : <<opsi-script-prim-section>>]
...
`LogLevel`  (deprecated)
ifdef::manual[see also : <<opsi-script-params-loglevel>>]
...
ifdef::manual[see also : <<opsi-script-configs_ScriptErrorMessages>>]
...
ifdef::manual[see also : <<opsi-script-configs_AutoActivityDisplay>>]

`forceLogInAppenMode =` <boolean value>  // (default=false); if true log will be send in append mode . //since 4.12.3.6
ifdef::manual[see also : <<forceLogInAppenMode>>]
...
ifdef::manual[see also : <<asConfidential_str>>]

`asConfidential(` <secret stringlist expression> `) : stringlist` //since 4.12.4.15 [W/L/M]
ifdef::manual[see also : <<asConfidential_list>>]
...
ifdef::manual[see also : <<runningInWanMode>>]
...
ifdef::manual[see also : <<opsi-script-strvar>>]
...
ifdef::manual[see also : <<opsi-script-lstvar>>]
...
ifdef::manual[see also : <<GetMsVersionName>>]
...
ifdef::manual[see also : <<getOSArchitecture>>]
...
ifdef::manual[see also : <<getRegistryValue>>]
...
ifdef::manual[see also : <<RandomStrWithParameters>>]

`RandomIntStr(`<number str>`) : string` [W/L/M]
ifdef::manual[see also : <<RandomIntStr>>]
...
ifdef::manual[see also : <<getRegistryKeyList>>]
...
ifdef::manual[see also : <<getRegistryVarList>>]
...
----
ifdef::manual[see also : <<listFiles>>]
...
ifdef::manual[see also : <<opsi-script-commands-if-else-bool-functions>>]
...
ifdef::manual[see also : <<DirectoryExists>>]

`FileOrFolderExists` (<file or folder path> [,<access str>]) : boolean [W/L/M]
'sysnative' is the default for <access str>. Otherwise, it can be '32bit', '64bit' or 'sysnative'
ifdef::manual[see also : <<FileOrFolderExists>>]

`fileIsSymlink (`<file name>`)` // since 4.12.4.21 [W/L/M] +
ifdef::manual[see also : <<fileIsSymlink>>]
...
ifdef::manual[see also : <<runningInPE>>]
...
ifdef::manual[see also : <<runningWithGui>>]
...
ifdef::manual[see also : <<saveUnicodeTextFile>>]
...
<access str> = one of 32bit, 64bit, sysnative ; default sysnative
ifdef::manual[see also : <<RegKeyExists>>]

`RegVarExists(`<regkey>, <var str> [,<access str>]`) : bool` //since 4.12.0.16 [W] +
<access str> = one of 32bit, 64bit, sysnative ; default sysnative
ifdef::manual[see also : <<RegVarExists>>]

`isPingReachable(<host>) : boolean`     //since 4.12.3.6   [W/L/M]
ifdef::manual[see also : <<isPingReachable>>]

`isValidFQDN(<domain name>) : boolean`     //since 4.12.4.4 [W/L/M]
ifdef::manual[see also : <<isValidFQDN>>]

`fileHasBom (`<file name>) : boolean` //since 4.12.4.17 [W/L/M]
ifdef::manual[see also : <<fileHasBom>>]

`SaveToTOMLFile(`<TOMLcontents: String> , <TOML file Path: String>`) : boolean`   //since 4.12.4.37 
ifdef::manual[see also : <<SaveToTOMLFile>>]

`ConvertTOMLfileToJSONfile(`<TOMLfilePath: String> , <JSONfilePath: String>`) : boolean`   //since 4.12.4.37 +
ifdef::manual[see also : <<ConvertTOMLfileToJSONfile>>]
...
----
ifdef::manual[see also : <<requiredOpsiscriptVersion>>]
...
ifdef::manual[see also : <<opsi-script-winbatch>>]
...
ifdef::manual[see also : <<opsi-script-dosbatch>>]
...
ifdef::manual[see also : <<opsi-script-execwith>>]
...
ifdef::manual[see also : <<opsi-script-files>>]
...
ifdef::manual[see also : <<opsi-script-registry>>]
...
ifdef::manual[see also : <<opsi-script-patches>>]
...
ifdef::manual[see also : <<opsi-script-patchtextfile>>]
...
ifdef::manual[see also : <<opsi-script-linkfolder>>]
...
ifdef::manual[see also : <<opsi-script-opsiservicecall>>]
...
ifdef::manual[see also : <<opsi-script-patchhosts>>]
...
ifdef::manual[see also : <<opsi-script-xml2-sections>>]
...
If the file not exits it will be created with <node name> as root node name.
...
A line of xml node names with optional one attribute seprated by '` // `' +
...
ifdef::manual[see also : <<opsi-script-xml2-functions>>]

[[opsi-script-rc-XMLPatch]]
=== XMLPatch [W]

ifdef::manual[see also : <<opsi-script-xmlpatch>>]

Function: edit XML files +
Depricated: please use xml2 sections: <<opsi-script-rc-XML2-sections>> +
and xml2 functions: <<opsi-script-rc-xml2-functions>>
...
ifdef::manual[see also : <<opsi-script-execpython>>]
...
ifdef::manual[see also : <<opsi-script-ldapsearch>>]
...
ifdef::manual[see also : <<opsi-script-commands-localfunctions>>]
...
ifdef::manual[see also : <<opsi-script-commands-libraryfunctions>>]
...
ifdef::manual[see also : <<opsi-script-encoding, '{opsi-script}' encoding>>]
...
ifdef::manual[see also : <<resolveSymlink>>]
...
ifdef::manual[see also : <<forcePathDelims>>]
...
ifdef::manual[see also : <<ExtractFileExtension>>]

`ExtractFileName (`<path>`) : string` [W/L/M]  //since 4.12.1
ifdef::manual[see also : <<ExtractFileName>>]

see also: <<opsi-script-rc-files>>

see also: <<opsi-script-rc-patchtextfile>>
...
ifdef::manual[see also : <<GetSectionFromInifile>>]
...
ifdef::manual[see also : <<opsi-script-files-commands>>]
...
----
ifdef::manual[see also : <<SetLogLevel>>]
ifdef::manual[see also : <<opsi-script-configs_default_loglevel>>]
ifdef::manual[see also : <<opsi-script-configs_force_min_loglevel>>]
...
ifdef::manual[see also : <<opsi-script-configs_SupressSystemEncodingWarning>>]

`opsi-script.global.ReverseProductOrderByUninstall` : boolean ; product list is reordered for uninstall; default: false +
ifdef::manual[see also : <<opsi-script-configs_ReverseProductOrderByUninstall>>]

`opsi-script.global.log_rotation_count` : boolean ; number of opsi-script.log backups; default: 8 +
ifdef::manual[see also : <<opsi-script-configs_log_rotation_count>>]

`opsi-script.global.configs_writeProductLogFile` : boolean ; logs for every single opsi product; default: false +
ifdef::manual[see also : <<opsi-script-configs_writeProductLogFile>>]
...
ifdef::manual[see also : <<getMacosVersionInfo>>]

`getMacosVersionMap : stringlist`  //macOS Version map  //since 4.12.1.0 [M]
ifdef::manual[see also : <<getMacosVersionMap>>]
...
ifdef::manual[see also : <<install_macos_app>>]

`install_macos_pkg($mypkg$ : string) : string`  [M] +
ifdef::manual[see also : <<install_macos_pkg>>]

`install_macos_dmg($mydmg$ : string) : string`  [M] +
ifdef::manual[see also : <<install_macos_dmg>>]

`install_macos_zip($myzip$ : string) : string`  [M] +
ifdef::manual[see also : <<install_macos_zip>>]

`install_macos_generic($myfile$ : string) : string`  [M]
ifdef::manual[see also : <<install_macos_generic>>]
...
ifdef::manual[see also : <<getListFromWMI>> and <<opsi-wmi-test.exe>> (small helper application works like getListFromWMI)]
...
ifdef::manual[see also : <<opsi-script-json>>]
...
ifdef::manual[see also : <<powershellCall_list>>]
...
ifdef::manual[see also : <<powershellCall>>]
...
ifdef::manual[see also : <<powershellCall_str>>]
...
----
ifdef::manual[see also : <<getOutStreamFromSection>>]
ifdef::manual[see also : <<opsi-script-dosbatch-catchout>>]
...
ifdef::manual[see also : <<executeSection>>]
...
ifdef::manual[General Info: : <<opsi-script-regularexpression>>]

`isRegexMatch(<string>, <pattern>) : boolean`  //since 4.12.1
ifdef::manual[see also : <<isRegexMatch>>]

`getSubListByContainingRegex(<pattern>, <target list>) : stringlist`  //since 4.12.1
ifdef::manual[see also : <<getSubListByContainingRegex>>]
...
ifdef::manual[see also : <<getRegexMatchList>>]
...
ifdef::manual[see also : <<removeFromListByContainingRegex>>]
...
ifdef::manual[see also : <<opsi-script-64bit>>]
...
ifdef::manual[see also : <<opsi-script-string>>]
...
ifdef::manual[see also : <<getIndexFromListByContaining>>]
...
ifdef::manual[see also : <<EscapeString>>]
...
ifdef::manual[see also : <<opsi-script-stringlist>>]
...
for %s% in $list1$ do sub_test_string
----
ifdef::manual[see also : <<opsi-script-stringlist-iteration>>]
...
ifdef::manual[see also : <<areListsEqual>>]
...
ifdef::manual[see also : <<getXml2DocumentFromFile>>]
...
ifdef::manual[see also : <<opsi-script-toml-functions>>]
