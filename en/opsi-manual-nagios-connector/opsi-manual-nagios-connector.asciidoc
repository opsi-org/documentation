...
.Verteilte Checks
image::../images/verteilte_checks_en.png["opsi verteilte checks",width=400]
...
At the moment this package is only available for Debian/Ubuntu. Packages for other distribution will follow later. Nevertheless the plugin it self is written in python and should ran at any distribution.
