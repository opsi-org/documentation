...
[[opsi-Nagios-Connector-checks-result-conditions]]
==== Result conditions
...
In a opsi environment with multiple depot servers you have to use additional options to check also the clients that are not assigned to the configs servers depot.
