...
image::opsi-configed-hostparameters.png["{opsi-configed}: Tab host parameter (server and client configuration)", width=400]
...
image::opsi-configed-logfiles.png["{opsi-configed}: Tab Logfiles", width=400]
