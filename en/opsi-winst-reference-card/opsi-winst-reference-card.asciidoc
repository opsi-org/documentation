...
`isValidFQDN(`<domain name> `) : boolean`     //since 4.12.4.4 
...
ifdef::manual[see also : <<getListFromWMI>> and <<wmitestgui.exe>> (small helper application works like getListFromWMI)]
