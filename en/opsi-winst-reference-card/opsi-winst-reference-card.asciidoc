...
opsi-winst reference card (4.11.1.6)
====================================
...
`GetRegistryStringValue32 (`"[key] var"`)`   //4.10.8

`GetRegistryStringValue64 (`"[key] var"`)`   //4.10.8

`GetRegistryStringValueSysNative (`"[key] var"`)`    //4.10.8
...
`convert2Jsonstr(`<string>`)`  //4.10.8.3
