...
[[opsi-winst-rc]]
= opsi-winst / opsi-script reference card (4.12.3.x)
...
=== opsi-winst Path and Directories [W/L/M]:
...
`getFileBom (`<file name>, var <encoding>`) : boolean` //since 4.12.4.17 [W/L/M]
ifdef::manual[see also : <<getFileBom>>]
...
[[opsi-winst-rc-XML2-sections]]
=== XML2 Sections (Experimental) [W/L/M]

ifdef::manual[see also : <<opsi-winst-xml2-sections>>]
...
ifdef::manual[see also : <<opsi-winst-xml2-functions>>]
...
Function: edit XML files +
Depricated: please use xml2 sections: <<opsi-winst-rc-XML2-sections>> +
and xml2 functions: <<opsi-winst-rc-xml2-functions>>
...
[[opsi-winst-rc-regularexpression]]
=== Regular expression related functions [W/L/M]:

ifdef::manual[General Info: : <<opsi-winst-regularexpression>>]
...
ifdef::manual[see also : <<opsi-winst-string>>]
...
ifdef::manual[see also : <<opsi-winst-stringlist>>]
...
see also : <<opsi-winst-rc-XML2-sections>>
