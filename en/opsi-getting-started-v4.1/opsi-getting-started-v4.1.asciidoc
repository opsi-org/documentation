...
Through this installation the actual stock of opsi-products, incl. templates for Windows- and Linux-OS, will be downloaded from http://download.uib.de/opsi4.1/ and installed on the server. For more information you can see here <<opsi-getting-started-installation-config-get-essential-products>>.
