...
If other ways to distribute software already exist, it is also possible to distribute the opsi-client-agent and execute the script `silent_setup.cmd` included in the package.
...
This method is the first choice for installations on a single computer.
