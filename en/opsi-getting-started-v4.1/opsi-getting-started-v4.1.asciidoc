...
Using '{opsi-configed}', in the mode 'Configuration of clients', choose the appropriate client by pressing the tab 'Clients'.
...
Finally, save the new action with a click on the checkmark button at the top (or by right clicking the mouse and selecting 'save').
