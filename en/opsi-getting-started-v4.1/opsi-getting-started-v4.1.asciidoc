...
zypper -v install opsi-depotserver
zypper -v install opsi-windows-support
----
...
You need a physical or virtual computer with a minimum of 1536 RAM that is able to boot per PXE over the network.
...
[source,prompt]
----
opsi-set-rights /var/lib/opsi/depot/win7/installfiles
----
