...
When {opsi-configed} is first started, a login window will appear. Log in with the member account of the group {opsi-admin-group} (at the opsi VM you may use root since you have created new user accounts).
