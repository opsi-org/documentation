...
* In the case of Red Hat Enterprise Linux, you must register with the Red Hat Network to have access to all required packages in Red Hat repositories:
...
More information about the activation of co-financed modules can be found in the opsi manual.
