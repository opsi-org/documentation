...
** UCS 3.0 (with digitec-opsi-listener)
...
The server should be updated before the opsi-Products. You can use the opsi-product-updater to update your opsi-Products:
