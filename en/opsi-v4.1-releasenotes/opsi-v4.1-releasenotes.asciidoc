...
IMPORTANT: If you changed the configuration file of `opsi-product-updater`, i.e. when using additional repositories or because you are synchronising your products from another opsi server, you should <<opsi-releasenotes-4.1-changes-opsi-package-updater-configfile,migrieren>> your settings before updating the packages.
