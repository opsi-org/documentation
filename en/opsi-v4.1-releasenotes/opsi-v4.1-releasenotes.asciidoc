...
TIP: The co-existance of opsi 4.0 and opsi 4.1 repositories on the same machine is usually no problem. However it is recommended to disable the old repository right during the migration.
