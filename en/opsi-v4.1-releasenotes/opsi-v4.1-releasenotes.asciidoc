...
In the backend an automatic conversion to the new format takes place that will use the ports 7, 9 & 12287 by default. This should match most popular hardware.
