...
<<<<<<< HEAD
* New opsi-bootimage based on Ubuntu Trusty / PXELinux 6.03 / Kernel 4.1 supporting new hardware.
...
>>>>>>> - restructrued opsi-bootimage section
...
This chapter lists some distributions, that for several reasons are not supported by opsi anymore.
...
** Extended logrotate configuration file `/etc/logrotate.d/opsiconfd`.
