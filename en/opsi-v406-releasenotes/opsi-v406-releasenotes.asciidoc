...
If you are using an OS version which is not contained in the chapter above, we recommend updating the OS before installing opsi v 4.0.6.

* New opsi-bootimage based on Ubuntu Precise / Kernel 4.0.1 supporting new hardware.
