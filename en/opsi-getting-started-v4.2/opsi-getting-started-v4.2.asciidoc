...
echo "deb [signed-by=/usr/local/share/keyrings/opsi-keyring.gpg] https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/xUbuntu_20.04/ /"  | sudo tee /etc/apt/sources.list.d/opsi.list > /dev/null
curl -fsSL https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/xUbuntu_20.04/Release.key | gpg --dearmor | sudo tee /usr/local/share/keyrings/opsi-keyring.gpg > /dev/null
----
...
----
sudo mkdir -p /usr/local/share/keyrings
echo "deb [signed-by=/usr/local/share/keyrings/opsi-keyring.gpg] https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/xUbuntu_18.04/ /"  | sudo tee /etc/apt/sources.list.d/opsi.list > /dev/null
curl -fsSL https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/xUbuntu_18.04/Release.key | gpg --dearmor | sudo tee /usr/local/share/keyrings/opsi-keyring.gpg > /dev/null
----
...
----
sudo mkdir -p /usr/local/share/keyrings
echo "deb [signed-by=/usr/local/share/keyrings/opsi-keyring.gpg] https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_11/ /" >  | sudo tee /etc/apt/sources.list.d/opsi.list > /dev/null
curl -fsSL https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_11/Release.key | gpg --dearmor | sudo tee /usr/local/share/keyrings/opsi-keyring.gpg > /dev/null
----
...
----
sudo mkdir -p /usr/local/share/keyrings
echo "deb [signed-by=/usr/local/share/keyrings/opsi-keyring.gpg] https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_10/ /"  | sudo tee /etc/apt/sources.list.d/opsi.list > /dev/null
curl -fsSL https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_10/Release.key | gpg --dearmor | sudo tee /usr/local/share/keyrings/opsi-keyring.gpg > /dev/null
----
...
----
sudo mkdir -p /usr/local/share/keyrings
echo "deb [signed-by=/usr/local/share/keyrings/opsi-keyring.gpg] http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_9.0/ /"  | sudo tee /etc/apt/sources.list.d/opsi.list > /dev/null
curl -fsSL https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_9.0/Release.key | gpg --dearmor | sudo tee /usr/local/share/keyrings/opsi-keyring.gpg > /dev/null
----
...
`/usr/local/share/keyrings/opsi-keyring.gpg
---------------------------------------
