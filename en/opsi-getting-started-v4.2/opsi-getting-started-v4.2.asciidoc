...
The {opsi-server} needs access to a Redis-Server (>=5) with RedisTimeSeries module installed (https://github.com/RedisTimeSeries/RedisTimeSeries).
You can use a existing Redis-Server or install an instance on the {opsi-server}:
...
[source,prompt]
----
wget -q -O - https://download.opensuse.org/repositories/home:uibmz:opsi:4.2:stable/Debian_10.0/Release.key | sudo apt-key add -
----
...
[source,prompt]
----
zypper addrepo http://download.opensuse.org/repositories/home:uibmz:opsi:4.2:stable/openSUSE_Leap_42.3/home:uibmz:opsi:4.2:stable.repo
----
...
[source,prompt]
----
   Importing GPG key 0xD8361F81 "home:uibmz OBS Project <home:uibmz@build.opensuse.org>" from http://download.opensuse.org/repositories/home:/uibmz:/opsi:/opsi4.2/CentOS_CentOS-8/repodata/repomd.xml.key
   Is this ok [y/N]: y
----
Please answer with 'y'.
