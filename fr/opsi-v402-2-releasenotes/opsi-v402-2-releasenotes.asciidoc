...
image::configed_clientselection.png["{opsi-configed}: Définir la fenêtre de recherche des clients", scaledwidth="50%"]
...
image::configed_clientselection2.png["{opsi-configed}: Recherches sauvegardées", scaledwidth="50%"]
...
Si un groupe d'ordinateurs a des pilotes qui ne font pas partie de l'installation par défaut de Windows, il est préférable de mettre ces ordinateurs dans un pool et d'intégrer leurs pilotes au cours de l'installation.
...
.opsi setup detector
image::opsi-setup-detector.png[scaledwidth="50%"]
...
image::opsi-setup-detector-context-small-en.png[scaledwidth="50%"]
...
image::waitforprocess_scheme_std.png["waitforprocess_scheme_std", scaledwidth="50%"]
...
image::waitforprocess_scheme_fork1.png["waitforprocess_scheme_fork1", scaledwidth="50%"]
...
image::waitforprocess_scheme_fork2.png["waitforprocess_scheme_fork2", scaledwidth="50%"]
