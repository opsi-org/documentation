...
image::winst-interactive.png["Screenshot: opsi-Winst démarré en mode interactif",400]
...
link:https://download.uib.de/opsi4.0/doc/opsi-winst-reference-card-en.pdf[opsi-script reference card]

Tous les détails de la syntaxe sont décrites dans le manuel opsi-winst :
link:https://download.uib.de/opsi4.0/doc/opsi-winst-manual-en.pdf[opsi-script manual]
...
Les nouvelles versions de {opsi-winst} ont des commandes spéciales pour traiter ces problèmes. Alors, lisez le manuel opsi-winst (link:https://download.uib.de/opsi4.0/doc/opsi-winst-manual-en.pdf[opsi-script manual]) pour ces problèmes.
