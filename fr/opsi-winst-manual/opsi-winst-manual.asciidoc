...
lets  '{opsi-winst}'  display the value of the String expression resp. the  sequence of chars in the batch window in the top information line. Le texte est maintenu aussi longtemps qu'aucune nouveau `message` est fixé. +
Exemple:
[source,winst]
----
