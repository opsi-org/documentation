...
image::opsi-configed-hostparameters.png["{opsi-configed}: Onglet paramètres de l'host (configuration serveur et client)", width=400]
...
image::opsi-configed-logfiles.png["{opsi-configed}: Onglet fichiers de log", width=400]
