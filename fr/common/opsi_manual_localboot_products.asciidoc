...
image::../images/configed_serverconfiguration_fr.png["opsi-configed: configuration du serveur",width=500]
...
image::../images/opsi-setup-product_sort_algorithm_fr.png["Choisissez l'algorithme de tri: Partie 1",width=300]

.Choisissez l'algorithme de tri: Partie 2
image::../images/opsi-setup-product_sort_algorithm2_fr.png["Choisissez l'algorithme de tri: Partie 2",width=300]
