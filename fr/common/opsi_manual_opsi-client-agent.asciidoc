...
image::../images/opsiclientd-blocklogin-notifier.png["opsiclientd notification blocklogin",width=80]

event notifier::
Affiche des informations sur l'événement en cours.

.opsiclientd notification événement
image::../images/opsiclientd-event-notifier.png["opsiclientd notification événement",width=150]

action notifier::
Montre l'état ​​de traitement de l'événement.

.opsiclientd notification de l'action
image::../images/opsiclientd-action-notifier.png["opsiclientd notification de l'action",width=150]
...
image::../images/opsiclientd-shutdown-notifier.png["opsiclientd notification d'arrêt",width=150]
...
image::../images/eventflowchsrt.png["flux de travail simplifié d'un 'standard event'",height=400]
...
image::../images/opsiclientd-event-processing-flow.png["le flux de travail complét d'un événement",height=650]
...
image::../images/opsiclientd-configuration-via-configed-serverdefault.png["Réglage de la configuration du serveur par défaut pour opsiclientd",width=400]
...
image::../images/opsiclientd-configuration-via-configed.png["configuration spécifique au client {opsiclientd} via {opsi-configed}",width=400]
...
image::../images/opsiclientd_infopage_event_on_demand.png["Page d'information de {opsiclientd} après l'installation poussée avec le cache activé du produit",width=400]
...
image::../images/opsiclientd-control-server-web-interface.png["Service Web de {opsiclientd}",width=400]
