...
voir aussi +
link:https://opsi.org/extensions/[Extensions d'opsi]
...
Les plugins que opsiclientd peut appeler doivent être compatibles avec la *Nagios plug-in development guidelines*.
