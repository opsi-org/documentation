...
Les conditions préalables techniques sont opsi 4.0.1 avec le suivant paquets et versions de produits:
...
Les configurations des clients OPSI doivent être placés dans un répertoire propre. Ils doivent être définis comme ceci:
