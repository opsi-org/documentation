...
Seit Version 4.11.4 steht _opsi-script_ auch unter Linux zur Verfügung.

Seit Version 4.12.1 steht _opsi-script_  auch unter macOS zur Verfügung.
...
_opsi-script_ unter Linux und macOS ist ein Kommandozeilen Programm, welches auch ohne Zugriff auf ein Display gestartet werden kann.
