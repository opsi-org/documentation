...
Die WakeOnLan-Funktion wurde erweitert, sodass sie im Hintergrund standardmäßig alle 10 Minuten die Erreichbarkeit zu den Clients testet und diese in der Client-Tabelle anzeigt. Das Intervall lässt sich in der Anmeldemaske ändern. +
 image:../images/opsi-configed-wakeonlan_status_true.png["Client erreichbar",width=20] : Client erreichbar +
 image:../images/opsi-configed-wakeonlan_status_false.png["Client nicht erreichbar",width=20] : Client nicht erreichbar
