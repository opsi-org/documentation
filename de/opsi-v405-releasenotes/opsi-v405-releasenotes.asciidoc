...
Durch Änderungen in lshw kann es sein, dass die von einem Rechner ausgelesene Modellbezeichnung sich ändert. Das kann zu unerwartetem Verhalten bei der Treiberintegration führen, falls diese auf dem Modellnamen basieren.
