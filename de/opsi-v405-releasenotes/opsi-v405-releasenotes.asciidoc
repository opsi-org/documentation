...
Wir Empfehlen den Property Wert uac_level=0 als Serverdefault einzustellen. 
Dies kann mit Hilfe des neuen configed einfach getan werden.
...
image::opsi-configed-depotserver-auswahl.png["{opsi-configed}: Auswahl der Depot-Server", width=250]
...
image::opsi-configed-failedactions-heute.png["{opsi-configed}: Fehlgeschlagene Aktionen - heute", width=250]
...
image::opsi-configed-produkt-defaultproperties-jedit-verschiedene-werte.png["{opsi-configed}: Produkt-Defaultproperties: jEdit", width=500]
