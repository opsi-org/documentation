...
=== Migration eines opsi 4.2 Servers
...
Um die Fehlermeldungen: "mysql server has gone away" zu vermeiden, wurde die Standardkonfiguration des MySQL Backends gändert. Die Option `connectionPoolRecycling` hat nun als Standardwert: _28800_.
