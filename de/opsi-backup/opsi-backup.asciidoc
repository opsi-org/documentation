...
|ldap|komplette Datenhaltung in einem LDAP-Verzeichnis (nicht mehr unterstützt)
|univention|angepasstes LDAP Backend für UCS-Systeme (nicht mehr unterstützt)
|==========================
...
Die Depotfiles sind deshalb interessant, da Sie die eigentlichen Dateien der zu verteilenden Software enthalten. Die Localboot-Produkte, wie auch die Netboot-Produkte haben Ihre Files jeweils unterhalb von _/var/lib/opsi/depot_.
