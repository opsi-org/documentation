...
|SLES 12.2                     | image:supported.png[width=15] |  sles12sp2 |    image:supported.png[width=15]  | image:unsupported.png[width=15]
...
|openSuse Leap 42.2            | image:supported.png[width=15] |   opensusel42-2 |   image:supported.png[width=15]  | image:unsupported.png[width=15]
