...
.Unterstützte Linux-OS in opsi 4.0.6
[cols="12,3,5,3,5"]
|==========================
...
|Ubuntu Utopic 14.10           | image:supported.png[width=15] |    ubuntu |    image:supported.png[width=15]  | image:unsupported.png[width=15] 
|Ubuntu Vivid 15.04            | image:supported.png[width=15] |    ubuntu,ubunt15-04 |    image:supported.png[width=15]  | image:unsupported.png[width=15] 
|Ubuntu Wily 15.10             | image:supported.png[width=15] |    ubuntu,ubunt15-10 |    image:supported.png[width=15]  | image:unsupported.png[width=15] 
|Ubuntu Xenial 16.04           | image:supported.png[width=15] |    ubuntu |    image:supported.png[width=15]  | image:develop.png[width=15] 
...
|Fedora 20                     | image:discontinued.png[width=15] |     |  |
|Fedora 21                     | image:unsupported.png[width=15] |      |  |
|Fedora 22                     | image:unsupported.png[width=15] |      |  |
|Fedora 23                     | image:develop.png[width=15] |          |  |
|SLES 11SP3                    | image:supported.png[width=15] |  sles11sp3      | image:supported.png[width=15] | image:unsupported.png[width=15]
|SLES 11SP4                    | image:develop.png[width=15] |      |  image:develop.png[width=15]  | image:develop.png[width=15] 
...
|openSuse 13.1 RC2             | image:supported.png[width=15] |        |  |
...
.Linux Netboot-Produkte nach Installer-Typ in opsi 4.0.6
[cols="4,4,3,5"]
|==========================
