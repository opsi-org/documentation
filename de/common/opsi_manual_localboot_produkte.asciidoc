...
* *config-updates* erlaubt es die Quelle der Updates zu Ändern. Die Updates werden dann entweder direct von Microsoft Servern, einem lokalen Peer-To-Peer Netz oder einem Peer-To-Peer Netz aus dem Internet geladen. Die Option 'disable' ist derweil in ein eigenes Property namens 'disable_updates'
