...
* *no_new_app_install_notification*: Ermölicht es eine Benachrichtigung für neue Apps zu deaktivieren. Zum Deaktivieren der Benachrichtigung muss das Property den Wert 'true' haben.
