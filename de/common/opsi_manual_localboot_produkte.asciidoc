...
zu den weiter unten beschriebenen Netboot Produkten.
...
Hinweis:+
Diese Funktionalität ist unter Windows 2000 nicht gegeben. Hier muss eine neuer 
'{opsi-winst}' im Rahmen eines '{opsi-client-agent}' updates eingespielt werden.

[[opsi-manual-localboot-javavm]]
==== javavm: Java Runtime Environment

Das Produkt javavm stellt die für den '{opsi-configed}' benötigte Java 1.6
Laufzeitumgebung für die Clients zur Verfügung.

[[opsi-manual-localboot-opsi-adminutils]]
==== '{opsi-admin} utils'

Das Produkt '{opsi-admin} utils' bietet neben einigen Hilfsprogrammen vor allem eine
lokale Installation des '{opsi-configed}'.

[[opsi-manual-localboot-jedit]]
==== jedit

Java basierter Editor mit Syntax Highlightning für '{opsi-winst}' Scripte.
...
image::../images/configed_serverconfiguration.png[width=500]
...
image::../images/opsi-setup-product_sort_algorithm.png[width=300]

.Wählen des Sortieralgorithmus: Teil 2
image::../images/opsi-setup-product_sort_algorithm2.png[width=300]
