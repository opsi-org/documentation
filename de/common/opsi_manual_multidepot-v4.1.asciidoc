...
Sofern der neue Depotserver sich lediglich opsi-Pakete vom zentralen Server holen soll, sollte nur das Repository in `/etc/opsi/package-updater.repos.d/opsi-server.conf` aktiv bleiben.
