...
Um die Roaming Profiles Erweiterung zu nutzen muss in der Konfiguration des opsiclientd das Loginevent aktiviert werden und dann der '{opsi-winst}' mit dem ergänzenden Parameter '/allloginscripts' gestartet werden. 
