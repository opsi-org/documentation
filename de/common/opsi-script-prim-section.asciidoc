...
Boolsche Funktion welche 'true' liefert wenn <substr> in <str> enthalten ist. Die Funktion arbeitet case sensitive per default.
Seit opsi-script 4.12.5.0 können Sie einen dritten Parameter <case sensitive> verwenden, um festzulegen, ob der Vergleich case sensitiv durchgeführt werden soll oder nicht. +
Seit 4.11.3 +
Beispiel:
[source,opsiscript]
----
