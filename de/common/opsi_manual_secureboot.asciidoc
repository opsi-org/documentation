...
Zusätzlich müssen in der Konfigurationsdatei des `opsipxeconfd` (etc/opsi/opsipxeconfd.conf) die Template Dateien für die UEFI Installation geändert werden.
