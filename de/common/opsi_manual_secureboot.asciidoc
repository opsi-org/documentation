...
Microsoft liefert mit Secureboot (manchmal auch _Secure Boot_ geschrieben) eine zusätzliche Sicherheitsebene, mit der nur autorisierte Software und Betriebssysteme installiert werden können.
...
|==========================
|Paket|Version
|opsi-linux-bootimage|>= 20190829-5
...
[source,prompt]
----
opsi-admin method configState_create "clientconfig.dhcpd.filename" "<hier host id einfügen>" "linux/pxelinux.cfg/shimx64.efi.signed"
----
