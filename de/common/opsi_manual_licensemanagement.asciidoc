...
image::opsi-configed-mode-selection.png["{opsi-configed}: Leiste mit Schaltfläche Lizenzen (rechts)", width="80mm"]
...
image::licensemanagement-table-sw-contextmenu01.png["Kontextmenü Softwaretabelle", width="140mm"]

Nach Betätigen der Auswahlfunktion:

.Softwaretabelle, reduziert auf die Zuordnungen zum ausgewählten Lizenzpool
image::licensemanagement-table-sw-contextmenu02.png["Kontextmenü Softwaretabelle", width="140mm"]
