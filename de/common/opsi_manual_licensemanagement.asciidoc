...
Um die komplexen Verhältnisse bei einer Lizenzverwaltung abzubilden verwendet opsi auch ein relativ komplexes Datenbankmodell. 
...
da die Tabelle der Lizenzpools gewissermaßen die Verknüpfung zwischen den beiden Datensphären herstellt.
