...
In der Welt der nicht freien Software ist Lizenzverwaltung stets ein komplexes Thema. Um es abzubilden verwendet opsi auch ein relativ komplexes Datenbankmodell. 
