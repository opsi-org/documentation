...
image::../images/opsi_with_sql_file_backend.png["Schema: opsi mit File- und SQL-Backend", width=430]
...
image::../images/configed-masterbuttons2.png["{opsi-configed}: Schaltflächen", width=400]
...
image::../images/opsi-configed-treeview-directory.png["{opsi-configed}: Treeview", width="66mm"]
...
image::../images/opsi-configed-client-contextmenu.png["{opsi-configed}: Kontextmenü der Clientliste", width="90mm"]
...
image::../images/opsi-configed-editlist1.png["{opsi-configed}: Property-Tabelle", width="80mm"]
...
image::../images/opsi-configed-editlist2.png["{opsi-configed}: Listen-Editor, Auswahlliste", width="80mm"]
...
image::../images/opsi-configed-editlist3.png["{opsi-configed}: Listeneditor, Editierfeld", width="80mm"]
...
image::../images/configed_package-actions.png["{opsi-configed}: Produktaktionen", width=400]
