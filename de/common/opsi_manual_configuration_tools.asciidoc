...
usage: opsi-package-updater list [-h]
                                 [--active-repos | --products | --products-and-installationstatus | --product-differences | --updatable-products | --search-product text]

optional arguments:
  -h, --help            show this help message and exit
  --active-repos        Lists all active repositories
  --products            Lists the repositories and the products they provide.
  ...
  --product-differences
                        ...
                        different.
  --updatable-products  Lists packages that have updates in the remote
                        repositories.
  --search-product text
...
==== Serverprozess: opsi-tftpd

Der opsi-tftpd ist ein standard tftp-hpa, welche um Fähigkeit erweitert wurde mit 'named pipes' umzugehen.
