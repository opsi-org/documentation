...
Nein, das macht keinen Sinn da diese im Moment des Login des Benutzers gestartet werden um Änderungen an roaming-Profiles vorzunehmen, die bei WAN-Clients nicht verwendet werden können. Der Eintrag im opsi-configed für opsiclientd.event_user_login.active sollte daher auf false gesetzt werden.
