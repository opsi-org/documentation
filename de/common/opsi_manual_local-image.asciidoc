...
Zur Installation der Produkte aktivieren stellen Sie bitte in der Datei `/etc/opsi/opsi-product-updater.conf` das Attribut *active* des Repositories *uib_local_image* auf 'True'.
