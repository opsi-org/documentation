...
Parameter: `clientId actionRequest` +
Diese Methode wird nur intern verwendet und dient dazu alle Produkte für die es ein Update gibt auf setup zusetzen.
...
Keine besonder Konfiguration notwendig.
