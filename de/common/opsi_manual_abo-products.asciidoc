...
CAUTION: Die Pakete für Windows 8 / 8.1 / Windows 2012 / 2012 R2 benötigen opsi-winst >= opsi-winst_4.11.3.11-1.opsi und opsi-client-agent >= opsi-client-agent_4.0.4.4-1.opsi

CAUTION: Die Pakete für Windows 10 werden im WAN/VPN-Modus noch nicht unterstützt
...
firefox-version :: Firefox '38.0esr' - is the Extended Support Release from Mozilla.org (38.8.0esr); New Extended Support Release 'esr' (45.1.1esr); (46.0.1)     is the Mozilla.org standard version
values: ["38.0esr", "esr", "standard"]
default: ["38.0esr"]
...
----
Das javavm-Paket beinhaltet die Oracle Jre 8.x ( cpu und psu )
...
javaversion::
description:  which version has to be installed (JRE 8 = 1.8.x); jre8 1.8.0_91-b14 (CPU); jre8psu 1.8.0_92-b14 (PSU (OTN))
