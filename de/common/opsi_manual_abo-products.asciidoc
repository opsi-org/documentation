...
Zur Bereitstellung der benötigten Pakete können Sie diese manuell herunterladen oder aber alle Pakete nach Anpassung der '/etc/opsi/opsi-package-updater.conf' mittels `opsi-package-updater -ivv` in einem Rutsch installieren.
...
[source,prompt]
----
opsi-package-updater -i -p "mshotfix,mshotfix-win7-x86-glb,mshotfix-win7-win2008r2-x64-glb"
----
