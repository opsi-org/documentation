...
Eine gleichwertige Variante ist für jedes Repository z.B. eine eigene `/etc/opsi/opsi-product-updater.conf.abo.standard` zu erstellen, die dann über `opsi-product-updater -c /etc/opsi/psi-product-updater.conf.abo.standard`
