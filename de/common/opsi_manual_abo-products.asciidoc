...
die mit dem Adobe Customization Wizard erstellt ist.
Abweichend davon können im Share `opsi_depot` im Verzeichnis 
`/var/lib/opsi/depot/acroread/custom` eigene MST-Dateien abgelegt werden, die über diese 
Property ausgewählt werden können.
...
----
flashplayer                      13.0.0.250-2 Adobe Flashplayer
----
...
==== Oracle Jre : javavm
----
javavm              1.7.71-1          Oracle Java Run
----
Das javavm-Paket beinhaltet die Oracle Jre 7.x ( cpu und psu ) und Jre 8.x
...
Die Oracle JRE 7.x wird dabei mit "Patch-in-place configuration" installiert (seit jre 1.6.0_10 )
