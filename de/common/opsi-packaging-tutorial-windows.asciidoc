...
image::winst-interaktiv.png["Screenshot: {opsi-winst} im interaktiven Modus", pdfwidth=90%]
...
image::winst-log-view.png[Screenshot: opsi-winst Log View Fenster, pdfwidth=90%]
