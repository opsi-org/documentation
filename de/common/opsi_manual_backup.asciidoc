...
Weiterhin ist sind hier Backend-Erweiterungen untergebracht, die Konfiguration des 'opsipxeconfd', des 'opsi-package-updater' und auch die modules-Datei, die Ihnen Ihre kofinanzierten Module freischaltet.
