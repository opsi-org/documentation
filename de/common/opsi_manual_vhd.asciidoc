...
Diese Vorgänge werden automatisiert durchgeführt durch das Produkt `opsi-vhd-auto-upgrade`.
...
Das Produkt opsi-vhd-auto-upgrade hat eine sehr niedrige Priorität (-97),
