...
Da im LAN die Kompression im Normalfall kaum einen Unterschied macht, bei WAN-Verbindungen jedoch meist vorteilhaft ist,
...
* im Namen des Properties irgendwo 'password' vorkommt oder
* der Property-Name mit 'secret' beginnt

wird der Property-Wert bei der Anzeige durch fünf  _*_  ersetzt und erst - nach Vorwarnung - sichtbar gemacht, wenn er angeklickt wird.  
