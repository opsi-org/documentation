...
IMPORTANT: Ab Version 4.0.7.5.22 wird der '{opsi-configed}' in einer Fassung ausgeliefert, die mit Java 1.8 kompiliert ist und daher zum Ablauf eine eine Java-Laufzeitumgebung mindestens der Version 1.8 benötigt.
...
ist der '{opsi-configed}' auch einen Menüeintrag startbar.
