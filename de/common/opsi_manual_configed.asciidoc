...
* configed.ssh_menu_config.active: +
De-/aktiviert die Verbindungseinstellungen. 

* configed.ssh_menu_control.active: +
De-/aktiviert die Befehlsbearbeitung. 

* configed.ssh_menu_main.active: +
De-/aktiviert das gesamte Menü "Server-Konsole". 

* configed.ssh_menu_shell.active: +
...
Neben der Möglichkeit die Eingabe durch Sternchen (*) zu ersetzen, was für Passwort-Eingaben empfohlen wird, kann auch ein Prozess mit Hilfe des Buttons "Prozess/Verbindung beenden" oder durch die Tasten "Strg+C" unterbrochen werden. +
