...
=== Server-Konsole
CAUTION: Eine der folgend beschriebenen Configed-Funktionen wird mit der kommenden python-opsi Version 4.0.7.40 (?)  freigeschaltet. Darunter zählt vorallem die Befehlsbearbeitung (<<opsi-manual-configed-serverkonsole-commandcontrol>>) und die Ausführung der darüber hinterlegten Befehle im Configed.
