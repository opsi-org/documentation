...
Läuft der opsiconfd auf einem anderem als dem Standardport 4447 verwendet werden, so ist dieser beim Start des  '{opsi-configed}'  dem Hostnamen mitzugeben (`host:port`).
