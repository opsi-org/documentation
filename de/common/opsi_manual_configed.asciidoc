...
insbesondere eine ausgewählte Client-Gruppe. Entsprechend schlägt er auch, wenn mit mehreren opsi-Servern  (z.B. einem produktiven und einem Test-Server) gearbeitet wird, in der Auswahlliste an oberster Stelle den zuletzt verbundenen vor.
...
Für den Fall, dass Passwörter als Property-Werte erscheinen, ist folgende Vorkehrung getroffen (als "Hack", bis ein spezifischer Datentyp eingerichtet ist):
