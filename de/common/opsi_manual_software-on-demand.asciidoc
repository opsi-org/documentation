...
|==========================
**ab opsi-client-agent Version >=4.1.1.6-5 wird der Kiosk als eigenständiges Produkt (opsi-client-kiosk) geführt. Er wird aber bei der Installation des opsi-client-agents automatisch mit installiert falls er nicht vorhanden ist. Für mehr Details siehe nächstes Kapitel.
...
*Installation über einen alten opsi-client-agent installiert der den alten Kiosk noch enthält (d.h. enthält das Verzeichnis opsiclientkiosk, bzw. \<=4.1.0.0)*
