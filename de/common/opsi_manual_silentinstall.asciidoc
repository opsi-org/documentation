...
Im folgenden werden die Standardkonfiguration dieses Features erläutert. Als erstes gibt folgendes Event in der Standard-opsiclientd.conf. Das Listing zeigt nur die wichtigen Optionen:
