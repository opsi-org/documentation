...
Der restliche Quellcode ist veröffentlicht unter der GPLv3 und wird im Rahmen von opsi 4.0.3 auf AGPLv3 umgestellt:

image::../images/gplv3-127x51.png["gplv3",width=100]
