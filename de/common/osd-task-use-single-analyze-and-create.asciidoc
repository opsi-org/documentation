...
In diesem Dialog kann geählt werden ob die Erzeugung abgebrochen wird, oder ob die Erzeugung nach dem Muster eines wählbaren bekannten Installers fortgesetzt werden soll.
...
image::osd_password_dlg.png["Dependency Editor", pdfwidth=40%]
