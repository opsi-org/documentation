...
* Einen externen DHCP-Server müssen Sie so konfigurieren, dass er ein PXE-Boot über den {opsi-Server} ermöglicht. Als Bootfile ist einzutragen: 'linux/pxelinux.cfg/shimx64.efi'
