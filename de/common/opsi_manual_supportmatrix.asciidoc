...
|Ubuntu 18.04 LTS _Bionic Beaver_      | image:develop.png[width=18] |  image:unsupported.png[width=18]
...
|UCS 4.3            | image:develop.png[width=18] |  image:unsupported.png[width=18]
