...
Dabei sind '<params>' kein, ein oder auch mehrere durch Komma getrennte Strings. Seit opsi-script 4.12.4.37 ist es möglich, Zahlenwerte und boolsche Werte in '<params>' auch ohne Anführungszeichen zu schreiben.
