...
Nun erscheint die Maske zu dem {opsi-configserver} an dem sich dieser Server als {opsi-depotserver} anmelden soll. Diese Anmeldung muss mit einem User authorisiert werden, welcher auf dem {opsi-configserver} Mitglied in der Gruppe 'opsiadmin' ist.
