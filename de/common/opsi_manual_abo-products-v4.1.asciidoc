...
----
Das javam8 Paket enthält die Open JDK 8 LTS Implementationen von Amazon (Amazon Corretto) und ojdkbuild (https://github.com/ojdkbuild/ojdkbuild).
Letzteres enthält eine auf Iced-Tea basierende Webstart-Komponente.
