...
[source,prompt]
----
# Beispiel: Pakete fuer mshotfix, Plattform Windows 7 x64 / Server 2008 R2 und Windows 10 / 2016 / 2019 x64 installieren
...
CAUTION: Wan/VPN Modul Die Pakete für Windows 8.1 / 2012 R2 benötigen opsi-winst >= 4.11.3.11-1 und opsi-client-agent >= 4.0.4.4-1

CAUTION: Wan/VPN Modul Die Pakete für Windows 10 /2016 benötigen opsi-client-agent >= 4.0.7.9-2

CAUTION: Wan/VPN Modul Die modularen Pakete für Windows 10 / 2016 / 2019 benötigen opsi-client-agent >= 4.1.0.0-27 bzw. opsiclientd >= 4.0.95
