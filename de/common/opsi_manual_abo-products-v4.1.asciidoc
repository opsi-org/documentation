...
Die zentrale Konfigurationsdatei mms.cfg wird bei jedem neu "auf setup" setzen neu erstellt und gemaess den Produktproperties angepasst (Ausnahme: Verwendung einer custom mms.cfg)
