...
Sie können Opsi-Quickinstall als ZIP-Datei unter folgendem Link herunterladen: [lime-background]#https://download.uib.de/opsi4.2/experimental/quick-install/FILENAME# .
...
Mehr Informationen zu den Properties, nach denen QuickInstall fragt, finden Sie im Opsi-Handbuch unter Kapitel "9.5.10.1 Das Produkt l-opsi-server" : https://download.uib.de/opsi4.2/testing/documentation/opsi-manual-v4.2-de.pdf . Dort können Sie auch die Default-Werte der Properties nachlesen.
