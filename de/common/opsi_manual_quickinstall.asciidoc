...
image::quickinstallQuickInstall.png["Screenshot: Sprache und Art der Installation",width=1200]
...
[[Information]]
.Informationen
image::quickinstallInfo.png["Screenshot: Informationen",width=1200]
...
.Ergebnis
image::quickinstallFailed.png["Screenshot: Ergebnis",width=1200]
...
.Ergebnis
image::quickinstallNoGuiFailed.png["Screenshot: Ergebnis",width=1200]
