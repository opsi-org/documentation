...
Dieses Verzeichnis enthält alle Programme des '{opsi-client-agent}' wie z.B. den '{opsiclientd}', die '{opsiclientd-notifier}', den '{opsi-script}' und einige Bibliotheken. Weiterhin finden sich hier die Konfigurationsdateien und grafischen Vorlagen der genannten Programme. +
