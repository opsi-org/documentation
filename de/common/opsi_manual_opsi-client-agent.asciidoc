...
image::../images/opsiclientd-blocklogin-notifier.png["Abbildung: opsiclientd blocklogin notifier",width=80]
...
image::../images/opsiclientd-event-notifier.png["Abbildung: opsiclientd event notifier",width=150]
...
image::../images/opsiclientd-action-notifier.png["Abbildung: opsiclientd action notifier",width=150]
...
image::../images/opsiclientd-shutdown-notifier.png["Abbildung: opsiclientd shutdown notifier",width=150]
...
Wenn man möchte, kann man das ganze jetzt in eine selbstextrahierende exe mit Programm aufruf verpacken z.B. über das Programm filzip.
