...
Templates für diese Dateien finden Sie unter `/var/lib/opsi/depot/opsi-client-kiosk/files/app/ock_custom/skin`
bzw. `C:\Program Files (x86)\opsi.org\opsi-client-agent\opsiclientkiosk\ock_custom\skin`

Das jeweils verwendete Icon kann durch Ablegen einer `kiosk.ico` Datei unter `/var/lib/opsi/depot/opsi-client-kiosk/files/app/ock_custom/skin` verändert werden.
...
Eine nachträgliche Bereinigung der Datei-Zugriffsrechte hilft Fehler zu vermeiden:
