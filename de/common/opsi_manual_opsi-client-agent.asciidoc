...
Ein Hilfsprogramm zur Auswahl von Farben und deren richtigen Schreibweise finden Sie unter link:http://download.uib.de/opsi40/helper/opsi-colorchooser.exe
...
Ein Hilfsprogramm mit dem Sie schnell prüfen können ob eine gegeben Bitmap Grafik korrekt angezeigt werden wird, finden Sie unter link:http://download.uib.de/opsi40/helper/opsi-bitmapviwer.exe
