...
WARNING: Durch die eingeschränkten AD-Zugriffsrechte des Member-Servers muss die Änderung des Kennworts des technischen Benutzers `pcpatch` auf einem Server mit Schreibrechten im AD vorgenommen werden - ein Master, Backup oder Slave.
