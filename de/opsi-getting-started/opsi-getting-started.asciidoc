...
CAUTION: UCS 3.0, UCS 3.1 und UCS 3.2 werden momentan von opsi 4.0.5 noch nicht offiziell unterstützt, obwohl es dafür bereits Repositories gibt. Es kann hierbei noch zu Problemen kommen, weshalb wir vom Einsatz in einer produktiven Umgebung abraten.
