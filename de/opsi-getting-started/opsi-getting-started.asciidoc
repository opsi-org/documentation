...
Wenn Sie in einem Browser (irgendwo im Netz) die Adresse   https://<opsidepotserver>:4447/configed.jnlp eingeben, erscheint eine Webseite mit als Applet eingebettetem {opsi-configed}. Damit es funktioniert, müssen Sie auf dem aufrufenden Rechner eine Java-Version >= 1.7 installiert haben. 
