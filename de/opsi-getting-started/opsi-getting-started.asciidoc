...
Die erste Variante wird auf dem Client das Depot-Verzeichnis des
opsi-Servers einbinden und von dort die Daten zur Installation auf die
lokale Festplatte kopieren.
...
Mit dem `opsi-deploy-client-agent` Skript kann auch eine ganze Liste von Clients bearbeitet werden. Das Skript findet sich unter '/var/lib/opsi/depot/opsi-client-agent' Führen Sie das Script mit root Rechten aus.
