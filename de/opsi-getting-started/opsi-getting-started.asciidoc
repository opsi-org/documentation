...
Wenn Sie das {mysql-Backend} verwenden wollen (z.B. für die Inventarisierung), so muss dieses nun mit dem Befehl `opsi-setup --configure-mysql` initialisiert werden:
