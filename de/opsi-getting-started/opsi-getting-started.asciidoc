...
CAUTION: Ubuntu 14.04, Codename Trusty Tar, wird momentan noch nicht offiziell unterstützt, obwohl es dafür bereits Repositories gibt. Es kann hierbei noch zu Problemen kommen, weshalb wir vom Einsatz in einer produktiven Umgegbung abraten.
