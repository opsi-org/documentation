...
* Laden Sie die Datei `opsi4.0.5-2-servervm.zip` aus dem Internet.
...
* Debian : Squeeze, Wheezy, Jessie (Testing)
...
[source,configfile]
----
deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/opsi40-testing/Debian_8.0 ./
----
...
[source,prompt]
----
wget -O - http://download.opensuse.org/repositories/home:/uibmz:/opsi:/opsi40-testing/Debian_8.0/Release.key | apt-key add -
----
...
opsi 4.0 ist getestet und freigegeben für UCS 3.2 und UCS 4.0.
...
Das Installations-App für opsi befindet sich in der UCS-Management-Oberfläche in der Kategorie "System". Über das App-Center kann opsi nur auf den UCS-Servern Master und Backup installiert werden. Falls Sie ein Update einer vorhandenen opsi-Umgebung durchführen möchten, lesen Sie bitte auch das darauf folgende Kapitel. +
...
Eine der wichtigsten Änderungen, die mit dem Update für opsi 4.0.5 kommen, ist die Unterstützung der Gruppe 'opsifileadmins'. Diese Gruppe ersetzt in UCS
...
*WARNUNG:* + 
Um diese Anforderungen sauber in das Integrationspaket implementieren zu können, wird die Gruppe 'pcpatch', falls vorhanden, automatisch über das Integrationspaket in 'opsifileadmins' umbenannt.
...
*Um nun opsi zu installieren, tragen Sie das entsprechende Repository in die Datei '/etc/apt/sources.list' ein:*

.UCS 3.2: +
[source,prompt]
----
echo "deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/opsi40/Univention_3.2 ./" >> /etc/apt/sources.list
----

.UCS 4.0: +
[source,prompt]
----
echo "deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/opsi40-testing/Univention_4.0 ./" >> /etc/apt/sources.list
----
...
[source,prompt]
----
wget -O - http://download.opensuse.org/repositories/home:/uibmz:/opsi:/opsi40-testing/Univention_4.0/Release.key | apt-key add -
----
