...
////
[[opsi-getting-started-overview]]
== opsi-server Overview: Directories, Binaries, Log files
...
Für ein Win10- PE folgen Sie bitte der Anleitung unter https://forum.opsi.org/viewtopic.php?&p=33997 . 
...
oder unter Verwendung des aktuelleren dism - Befehls
[source,prompt]
----
...
oder unter Verwendung von dism
[source,prompt]
----
...
Achtung: dieses Verzeichnis heißt in neueren AIKs C:\winpe\media , der Inhalt ist genauso zur Erstellung des PE geeignet.
