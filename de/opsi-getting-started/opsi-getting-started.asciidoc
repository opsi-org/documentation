...
Bitte stellen Sie sicher, daß Ihre iptables und SE-Linux Konfiguration die folgemnden Ports erlaubt: tftp Port (69/UDP) und die opsi ports (4447/TCP und 4441/TCP).
...
* Die RHEL Pakete für opsi 4.0 sind gebaut für CentOS 5 und CentOS 6.
