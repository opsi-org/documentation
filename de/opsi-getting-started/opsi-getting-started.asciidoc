...
Bei der Verwendung der vorkonfigurierten VMware-Maschine muss ein angemessener Wirtsrechner genutzt werden. Es sollte mindestens ein Dualcore Prozessor und 4GB RAM vorhanden sein.
...
. Vervollständigen der Betriebssystem-Basispakete für Windows von den Original-Median
