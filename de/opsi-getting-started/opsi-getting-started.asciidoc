...
CAUTION: Achtung bei Clients mit einer über 2TB großen Festplatte. In einem nicht UEFI-System beträgt die größte Partitionsgröße 2TB. Sofern eine größere Partition angelegt werden Soll schlägt die Installation fehl. Dies ist technisch durch die Standard-Partitionstabelle bedingt. Sie müssen die Festplatte in zwei Partitionen aufteilen. Dies können Sie über die Product-Properties steuern. Oder Sie erwerben das UEFI-Modul, wodurch diese technische Limietierung entfällt.
