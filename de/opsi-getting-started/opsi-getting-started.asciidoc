...
Siehe auch: +
link:http://de.wikipedia.org/wiki/Domain[Wikipedia: Domain] +
link:http://de.wikipedia.org/wiki/Hostname#Richtlinien[Wikipedia:Hostname - Richtlinien]
...
* *Per ssh* +
(in Linux-Systemen stets vorhanden, unter Windows mit link:http://www.chiark.greenend.org.uk/~sgtatham/putty/[putty]) +
...
In diesem Abschnitt wird davon ausgegangen, dass Sie mit dem Debian-Paketsystem vertraut sind (Informationen zu diesem Thema finden Sie in den einschlägigen Büchern, in den man-pages oder im link:http://www.debiananwenderhandbuch.de/[Debian GNU/Linux Anwenderhandbuch]).
...
yum remove tftp-server
yum install opsi-depotserver opsi-configed
   Importing GPG key 0xD8361F81 "home:uibmz OBS Project <home:uibmz@build.opensuse.org>" from http://download.opensuse.org/repositories/home:/uibmz:/opsi:/opsi40/Fedora_20/repodata/repomd.xml.key
   Is this ok [y/N]: y
service opsiconfd restart
service opsipxeconfd restart
opsi-setup --auto-configure-samba
...
Solche allg. Treiber Pakete finden Sie unter link:http://driverpacks.net/[DriverPacks.net]. +
...
siehe auch: +
* link:http://www.autoitscript.com/wiki/FAQ#Why_doesn.27t_my_script_work_on_a_locked_workstation.3F[AutoIT FAQ: Why doesn't my script work on a locked workstation?]
* link:http://www.autoitscript.com/autoit3/docs/[AutoIT Dokumentation]
* link:http://www.autoitscript.com/autoit3/docs/intro/controls.htm[AutoIT: Dokumentation: Controls]
* link:http://www.autoitscript.com/autoit3/docs/functions.htm[AutoIT: Dokumentation: Functions]
