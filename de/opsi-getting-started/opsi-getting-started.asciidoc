...
Der opsiconfd nutzt derzeit nur einen Kern.Dieser eine Kern wird auch nur dann ausgelastet, wenn viele (>100) opsi-clients exeact gleichzeitig auf den Server zugreifen. Aber das Betriebsystem, Samba und Datenbank-Server haben auch CPU Bedürfnisse.
