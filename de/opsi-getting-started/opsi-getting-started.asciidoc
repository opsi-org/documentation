...
Als nächstes wird das opsi4ucs-Repository aktiviert (auch UCS 3.1 und 3.2 werden aus dem 3.0 Repository installiert):
...
Unter RHEL / CentOS 7 wurde mysql-server durch mariadb-server ersetzt.
