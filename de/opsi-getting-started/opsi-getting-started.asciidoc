...
Wenn root nicht Mitglied von {opsi-admin-group} ist, kann er auch nicht die opsi-Administrationskommandos ausführen!
...
Loggen Sie sich als ein User ein, der Mitglied der Gruppe {opsi-admin-group} ist (in der VMware-Appliance als root, solange Sie keinen anderen User eingerichtet haben).
