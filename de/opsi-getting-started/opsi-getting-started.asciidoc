...
* Laden Sie die Datei `opsi4.0.3-2-servervm.zip` aus dem Internet.
...
* Laden Sie die Datei `opsi4.0.3-servervm.ova` aus dem Internet.
...
Die Pakete finden Sie unter http://download.uib.de/opsi4.0/products/ in den Verzeichnissen netboot/ und localboot/  
