...
Wenn die Netzwerkanbindung funktioniert, können jetzt die opsi-Pakete eingespielt bzw. aktualisiert (Kapitel <<opsi-getting-started-installation-config,Aktualisieren und Konfigurieren des {opsi-Servers}>>) und schließlich die Umgebung für den ersten Installationstest hergestellt werden.
