...
|Ubuntu 14.04 LTS _Trusty Tahir_:
[source,configfile]
----
...
CAUTION: Unter Debian 9 kann es zu folgender Meldung kommen:
[source,configfile]
----
W: GPG-Fehler: http://download.opensuse.org/repositories/home:/uibmz:/opsi:/opsi40-testing/Debian_9.0 ./ Release: Die folgenden Signaturen waren ungültig: 2371C96FC045365D00729A19520B97144DC87421
E: The repository 'http://download.opensuse.org/repositories/home:/uibmz:/opsi:/opsi40-testing/Debian_9.0 ./ Release' is not signed.
N: Updating from such a repository can't be done securely, and is therefore disabled by default.
----

Diese Meldung können Sie umgehen indem aptitude mit dem Parameter '--allow-unauthenticated' aufgerufen wird. Dieser Parameter muss bei jedem Aufruf mitgegeben werden. Für eine permanente Lösung empfehlen wir die Prüfung zu deaktivieren. Dies kann man im Verzeichnis '/etc/apt/apt.conf.d/' die Datei '99opsi' mit fogendem Inhalt angelegen:
[source,configfile]
----
...
opsi4ucs, opsi-atftpd, p7zip-full, cabextract.
...
Falls ein existierender Configserver entdeckt wird, so wird 'opsi-package-updater' so konfiguriert, dass er die Pakete von diesem Server bezieht.
...
[source,prompt]
----
echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/opsi40/Univention_4.2/ /' > /etc/apt/sources.list.d/opsi.list
----
...
univention-install p7zip-full cabextract wimtools
----
...
Unter <<opsi-getting-started-installation-base-ucs-listener>> wird eine Lösung dafür beschrieben.
...
[source,prompt]
----
zypper addrepo http://download.opensuse.org/repositories/home:uibmz:opsi:opsi40/openSUSE_Leap_42.3/home:uibmz:opsi:opsi40.repo
zypper refresh
----
...
[source,prompt]
----
zypper addrepo http://download.opensuse.org/repositories/home:uibmz:opsi:opsi40/openSUSE_Leap_42.2/home:uibmz:opsi:opsi40.repo
zypper refresh
----
