...
CAUTION: Verwenden Sie in den Passwörtern kein '§' da dies bei der Verbinung zum opsi-Service nicht erlaubt ist.
...
==== NT 6 Familie: Vista / 2008 / Win7 / Win8
...
Attention:: Für Windows 8 Installationen erstellen Sie ein PE auf Basis von Windows 7
...
Es wird (teil-automatisiert) untersucht, welche Komp﻿onenten auf einem Test-PC,
