...
Dieser eine Kern wird auch nur dann ausgelastet, wenn viele (>100) opsi-clients exakt gleichzeitig auf den Server zugreifen.
Aber das Betriebssystem, Samba und Datenbank-Server haben auch CPU Bedürfnisse.
