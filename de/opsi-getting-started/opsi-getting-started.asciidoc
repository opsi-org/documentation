...
* Laden Sie die Datei `opsi4.0.1-servervm.zip` aus dem Internet.
...
opsi 4.0 ist getestet und freigegeben für UCS 2.4
...
opsi 4.0 ist getestet und freigegeben für openSUSE 11.3

Zunächst ein paar allgemeine Hinweise:

* Diese Pakete sind getestet unter openSUSE 11.3. Zu anderen Versionen können wir keine Aussagen machen.
...
Bitte beachten:
* Die RHEL Pakete für opsi 4.0 sind gebaut für RHEL 5.
* Es liegen noch keine Betriebserfahrungen mit opsi auf RHEL vor.

Zunächst ein paar allgemeine Hinweise:
* Zu anderen RHEL Versionen können wir keine Aussagen machen.
* Zu Evaluierung von opsi empfiehlt die uib gmbh weiterhin dringend die Verwendung der opsi-VM.
...
Bitte beachten:
* Die CentOS Pakete für opsi 4.0 sind gebaut für CentOS 5.
* Es liegen noch keine Betriebserfahrungen mit opsi auf CentOS vor.

Zunächst ein paar allgemeine Hinweise:
* Zu anderen CentOS Versionen können wir keine Aussagen machen.
* Zu Evaluierung von opsi empfiehlt die uib gmbh weiterhin dringend die Verwendung der opsi-VM.
...
. Mounten Sie den share `\\<opsiserver>\opt_pcbin` auf einen Laufwerksbuchstaben.
. Starten Sie das Script `install\opsi-client-agent\service_setup.cmd`
