...
[[opsi-winst-lection3]]
=== 3. Übung
In einer Kommentarzeile soll die Anzahl der DDL-Files unter System32 ausgegeben werden.
...
[[opsi-winst-lection4]]
=== 4. Übung
Gibt es eine kernel32.dll in system32 und wenn ja welche Größe hat sie?
