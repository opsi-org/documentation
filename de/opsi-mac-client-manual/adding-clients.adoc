...
Ansonsten müssen Sie hier angeben:app-name: 
...
Die nachfolgend Beschriebenen Methoden: service_setup.cmd / silent_setup.cmd dienen nur noch zur Abwärtskompatibilität.
