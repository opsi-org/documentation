...
siehe auch: https://download.uib.de/opsi_stable/doc/html/opsi-winst-manual/opsi-winst-manual.html#opsi-script-rc-linux-specific
...
Siehe auch: +
https://download.uib.de/4.2/documentation/html/opsi-winst-manual/opsi-winst-manual.html#opsi-script-rc-linux-specific +
#####################
