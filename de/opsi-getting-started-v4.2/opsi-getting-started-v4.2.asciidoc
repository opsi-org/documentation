...
[subs="attributes"]
----
echo "deb https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/xUbuntu_20.04/ /" > /etc/apt/sources.list.d/opsi.list
curl -fsSL https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/xUbuntu_20.04/Release.key | gpg --dearmor | sudo tee /etc/apt/trusted.gpg.d/opsi.gpg > /dev/null
----
...
[subs="attributes"]
----
echo "deb https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/xUbuntu_18.04/ /" > /etc/apt/sources.list.d/opsi.list
curl -fsSL https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/xUbuntu_18.04/Release.key | gpg --dearmor | sudo tee /etc/apt/trusted.gpg.d/opsi.gpg > /dev/null
----
...
[subs="attributes"]
----
echo "deb https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_11/ /" > /etc/apt/sources.list.d/opsi.list
curl -fsSL https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_11/Release.key | gpg --dearmor | sudo tee /etc/apt/trusted.gpg.d/opsi.gpg > /dev/null
----
...
[subs="attributes"]
----
echo "deb https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_10/ /" > /etc/apt/sources.list.d/opsi.list
curl -fsSL https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_10/Release.key | gpg --dearmor | sudo tee /etc/apt/trusted.gpg.d/opsi.gpg > /dev/null
----
...
[subs="attributes"]
----
echo "deb https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_9.0/ /" > /etc/apt/sources.list.d/opsi.list
curl -fsSL https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.2:/{release}/Debian_9.0/Release.key | gpg --dearmor | sudo tee /etc/apt/trusted.gpg.d/opsi.gpg > /dev/null
----
