...
Die Pakete finden Sie unter https://download.uib.de/opsi4.1/stable/packages/windows/ in den Verzeichnissen `netboot/`, `localboot/`, für Linux-Clients zusätzlich unter `https://download.uib.de/opsi4.2/stable/packages/linux/`.
