...
.Informationen
image::../images/quickinstallDistribution.png["Screenshot: Informationen",width=1200]
...
Danach zeigt QuickInstall Ihnen eine Übersicht an, in der Sie nochmal alle Ihre Antworten kontrollieren können. Wenn alles korrekt ist, drücken Sie Enter, um die Installation des Opsi-Server zuz starten.
