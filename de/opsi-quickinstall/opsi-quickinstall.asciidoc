...
Diese Anleitung beschreibt detailliert die Installation eines {opsi-Server}s mit opsi-quickinstall.

Für Voraussetzungen etc. siehe [opsi-getting-started]
...
== {opsi-Server} Installation mit opsi-quickinstall

Dieses Kapitel beschreibt die Installation eines opsi-Servers mit opsi-quickinstall.
...
...quickinstall runteladen...

...quickinstall starten...

[[opsi-getting-started-installation-base-vm-lang]]
===== Sprachauswahl
Nach dem Start von opsi-quickinstall wählen Sie zuerst die gewünschte Sprache und die Art der Installation aus:

.Sprache und Art der Installation
image::quickinstall1.png["Screenshot: Sprache und Art der Installation",width=400]

...Standard...

...Benutzerdefiniert...

Danach werden Sie gefragt, ob quickinstall Ihr Betribssystem richtig erkannt hat:

.Betriebssystem
image::quickinstallDistr.png["Screenshot: Betriebssystem",width=400]

Ist dies nicht der Fall, editieren Sie das Betriebssystem. Unterstützte Systeme sind:

CentOS 7, +
Debian 8, Debian 9, Debian 10, +
openSUSE 15.1, openSUSE 42.3, +
RedHatEnterprise 7, RedHatEnterprise 8, +
Univention 4.3, Univention 4.4, +
...
* *Per ssh* +
(in Linux-Systemen stets vorhanden, unter Windows mit link:https://www.chiark.greenend.org.uk/~sgtatham/putty/[putty] +
...
Nun installieren Sie den MySQL-Server, damit Sie MySQL als Backend z.B. für die Inventarisierungsdaten und Lizenzmanagement verwenden können:
...
* Im Fall von Red Hat Enterprise Linux müssen Sie sich beim Read Hat Network registrieren, um Zugriff auf alle benötigten Pakete in den Repositories von Red Hat zu haben:
+
[source,prompt]
----
rhn_register
...
In diesem Kapitel wird der installierte {opsi-Server} fertig eingerichet.
