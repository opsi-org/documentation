...
Service neu gestartet wird. Dadurch wird es einfacher mit dem Webservice
zu kommunizieren. Da dieses Verhalten möglicherweise dazu führt, dass
alte Clients, welches das alte Verhalten erwarteten, nicht mehr mit dem
Service kommunzieren können ist dies standardmäßig nicht aktiviert.
