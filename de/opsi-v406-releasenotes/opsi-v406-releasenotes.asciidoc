...
Falls der Webservice momentan kommuniziert, liefert er einen HTTP-Header
...
Drittherstellern mit dem Webservice zu kommunizieren. Da dieses
Verhalten möglicherweise dazu führt, dass alte Clients, welches das alte
