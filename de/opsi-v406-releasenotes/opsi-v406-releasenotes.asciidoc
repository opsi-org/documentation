...
** config_updates: Windows 10 bietet verschiedene Möglichkeiten Updates auf dem Internet zu laden.
*** AllowPeerToPeer: Erlaubt es das Updates von Microsoft und von beliebigen peer-to-peer Clients auf dem Internet zu beziehen.
*** LocalPeerToPeer: Erlaubt es Updates von Microsoft und von einem lokalen peer-to-peer Cliebnt zu beziehen.
...
** disable_customer_experience: Ermöglich es das Kundenzufriedesnheitsprogramm von Microsoft zu deaktivieren.
