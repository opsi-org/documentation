...
* Neues opsi-bootimage basierend auf Ubuntu Trusty / Kernel 4.1.0 / PXELinux 6.03 mit Unterstützung für aktuelle Hardware
** HINWEIS: Das neue pxelinux.0 schreibt keine punkte mehr beim Laden des bootimages. Man muß also ohne Rückmeldung auf den start des bootimages warten.
...
nicht mehr weiter pflegen. Wer hierzu Fragen oder Probleme hat möge sich bei uns melden.
...
Dieses Paket dient hauptsächlich dazu Sicherheitseinstellungen innerhalb von Windows 10 zu ändern. Zum einen bietet es bekannte Möglichkeiten wie das abschalten des Lockscreens oder des Hibernation Bootvorgangs. Zudem ist es möglich das Updateverhalten von Windows zu ändern. Hinzu kommen sicherheitsrelevante Einstellungsmöglichkeiten der folgenden Features: Telemetrie, Cortana Sprachassistent, Tools zur Entfernung bösartiger Software und das Programm zur Kundenzufriedenheit.
...
besteht.
Viele Backend-Objekte haben zusätzliche verbesserte Repräsentationen für
Ausgaben bekommen, wodurch bspw. Log-Ausgaben einfacher zu
interpretieren sind.
