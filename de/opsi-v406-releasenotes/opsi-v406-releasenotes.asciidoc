...
Fehler werfen.
Erkennt eine der Methoden zur Bestimmung der Produktreihenfolge eine
zirkuläre Abhängigkeit, so wird ein Fehler geworfen - vorher war dieses
Verhalten nicht durchgängig implementiert.
