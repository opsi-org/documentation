...
Installieren Sie die Standard opsi-Produkte durch Doppelklick auf das Icon 'opsi-package-updater FirstRun'. Bitte geben Sie das Passwort für den adminuser ein.
...
[source,prompt]
----
aptitude install wget lsof host p7zip-full cabextract pigz
----
...
[source,prompt]
----
echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/testing/xUbuntu_16.04/ /' > /etc/apt/sources.list.d/opsi.list
----

Debian 9 _Stretch_:
[source,prompt]
----
echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/testing/Debian_9.0/ /' > /etc/apt/sources.list.d/opsi.list
----

Debian 8 _Jessie_:
[source,prompt]
----
echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/testing/Debian_8.0/ /' > /etc/apt/sources.list.d/opsi.list
----
...
[source,prompt]
----
wget -nv https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/xUbuntu_16.04/Release.key -O Release.key
...
[source,prompt]
----
wget -nv https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/Debian_9.0/Release.key -O Release.key
...
[source,prompt]
----
wget -nv https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/Debian_8.0/Release.key -O Release.key
apt-key add - < Release.key
apt-get update
----
...
Die Vorbereitung beinhaltet das Anlegen von benötigten Benutzern und Gruppen sowie das Einrichten von Freigaben.
...
opsi4ucs, opsi-tftpd-hpa, p7zip-full, cabextract, mysql-server.
...
[source,prompt]
----
echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/testing/Univention_4.2/ /' > /etc/apt/sources.list.d/python-opsi.list
----
...
[source,prompt]
----
wget -nv https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/Univention_4.2/Release.key -O Release.key
apt-key add - < Release.key
----
...
[source,prompt]
----
zypper addrepo https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/openSUSE_Leap_42.3/home:uibmz:opsi:4.1:testing.repo
----
...
[source,prompt]
----
zypper addrepo https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/SLE_12_SP3/home:uibmz:opsi:4.1:testing.repo
----

*SLES 12SP2:*
[source,prompt]
----
zypper addrepo https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/SLE_12_SP2/home:uibmz:opsi:4.1:testing.repo
----

*SLES 12SP1:*
[source,prompt]
----
zypper addrepo https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/SLE_12_SP1/home:uibmz:opsi:4.1:testing.repo
----

*SLES 12:*
[source,prompt]
----
zypper addrepo https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/SLE_12/home:uibmz:opsi:4.1:testing.repo
----
...
----
cd /etc/yum.repos.d/
wget https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/RHEL_7/home:uibmz:opsi:4.1:testing.repo
yum makecache
----
...
----
cd /etc/yum.repos.d/
wget https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:testing/CentOS_7/home:uibmz:opsi:4.1:testing.repo
yum makecache
----
...
In diesem Fall muss auf dem opsi-Server die Java Laufzeitumgebung installiert sein.
...
* link:https://www.microsoft.com/de-de/download/confirmation.aspx?id=30652[ADK Windows 8]
* link:http://go.microsoft.com/fwlink/p/?LinkId=526740[ADK Windows 10]
