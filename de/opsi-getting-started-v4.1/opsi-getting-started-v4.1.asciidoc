...
Bei der Verwendung des App-Center wird der Wechsel auf eine neue UCS-Version (bspw. von UCS 4.0 nach UCS 4.1) vom Betriebssystem blockiert, bis alle Apps unter der neuen Betriebssystemversion zur Verfügung stehen.
