...
[source,prompt]
----
sudo sh -c "echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/stable/xUbuntu_16.04/ /' > /etc/apt/sources.list.d/opsi.list"
----
...
[source,prompt]
----
echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/stable/Univention_4.2/ /' > /etc/apt/sources.list.d/python-opsi.list
----
