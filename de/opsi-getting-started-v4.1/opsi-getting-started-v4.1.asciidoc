...
[source,prompt]
----
echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/testing/Univention_4.2/ /' > /etc/apt/sources.list.d/opsi.list
----
...
systemctl enable opsiconfd.service
systemctl enable opsipxeconfd.service
