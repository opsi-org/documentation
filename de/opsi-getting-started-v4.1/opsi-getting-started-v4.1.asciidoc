...
Zur Installation des {opsi-server}s werden automat{opsi-server}Pakete installiert: 'opsi-tftpd-hpa', 'opsi-windows-support', 'univention-mariadb' bzw. 'univention-mysql'.
