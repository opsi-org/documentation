...
Die Defaulteinstellung bei Installation der Pakete ist das {file-Backend} als Haupt-Backend und mit Verwendung des {mysql-Backend} für Lizenzmanagement-Daten und Inventur-Daten.
