...
In link:https://www.samba.org/samba/docs/man/Samba3-ByExample/secure.html[Samba 3 by Example] wird folgendes für Samba empfohlen:
...
Es wird ein Sicherheitszuschlag von 50% dieser geschätzten Werte empfohlen.
