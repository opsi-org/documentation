...
Über das App-Center kann opsi nur auf den 'Master', 'Backup' und 'Slave' installiert werden.
...
Zur Installation des {opsi-server}s werden automatisch weitere Pakete installiert: 'opsi-tftpd-hpa', 'p7zip-full', 'cabextract', 'mysql-server'.
