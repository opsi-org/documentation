...
[source,prompt]
----
sudo sh -c "echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/experimental/xUbuntu_16.04/ /' > /etc/apt/sources.list.d/opsi.list"
----

Debian 9 _Stretch_:
[source,prompt]
----
echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/experimental/Debian_9.0/ /' > /etc/apt/sources.list.d/opsi.list
----

Debian 8 _Jessie_:
[source,prompt]
----
echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/experimental/Debian_8.0/ /' > /etc/apt/sources.list.d/opsi.list
----
...
[source,prompt]
----
wget -nv https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/xUbuntu_16.04/Release.key -O Release.key
...
[source,prompt]
----
wget -nv https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/Debian_9.0/Release.key -O Release.key
...
[source,prompt]
----
wget -nv https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/Debian_8.0/Release.key -O Release.key
apt-key add - < Release.key
apt-get update
----
...
[source,prompt]
----
echo 'deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.1:/experimental/Univention_4.2/ /' > /etc/apt/sources.list.d/python-opsi.list
----
...
[source,prompt]
----
wget -nv https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/Univention_4.2/Release.key -O Release.key
apt-key add - < Release.key
----
...
[source,prompt]
----
zypper addrepo https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/openSUSE_Leap_42.3/home:uibmz:opsi:4.1:experimental.repo
----
...
[source,prompt]
----
zypper addrepo https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/SLE_12_SP3/home:uibmz:opsi:4.1:experimental.repo
----

*SLES 12SP2:*
[source,prompt]
----
zypper addrepo https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/SLE_12_SP2/home:uibmz:opsi:4.1:experimental.repo
----

*SLES 12SP1:*
[source,prompt]
----
zypper addrepo https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/SLE_12_SP1/home:uibmz:opsi:4.1:experimental.repo
----

*SLES 12:*
[source,prompt]
----
zypper addrepo https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/SLE_12/home:uibmz:opsi:4.1:experimental.repo
----
...
----
cd /etc/yum.repos.d/
wget https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/RHEL_7/home:uibmz:opsi:4.1:experimental.repo
yum makecache
----
...
----
cd /etc/yum.repos.d/
wget https://download.opensuse.org/repositories/home:uibmz:opsi:4.1:experimental/CentOS_7/home:uibmz:opsi:4.1:experimental.repo
yum makecache
----
