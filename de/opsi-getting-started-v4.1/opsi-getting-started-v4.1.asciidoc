...
Zur Installation des {opsi-server}s werden automatisch weitere Pakete installiert: 'opsi-tftpd-hpa', 'opsi-windows-support', 'univention-mysql'.
...
* `univention-mysql` sollte installiert sein
