...
Loggen Sie sich als ein User ein, der Mitglied der Gruppe {opsiadmin} ist (in der virtuellen Appliance als root, solange Sie keinen anderen User eingerichtet haben).
