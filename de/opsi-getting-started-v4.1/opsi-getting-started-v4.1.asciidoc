...
Hierdurch werden automatisiert die aktuellen opsi-Pakete, incl. Templates für Windows- und Linux-Betriebssysteminstallationen, von http://download.uib.de/opsi4.1/ geholt und auf dem Server installiert. Für weitere Informationen siehe auch <<opsi-getting-started-installation-config-get-essential-products>>.
