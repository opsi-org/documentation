...
Prinzipiell gibt es zwei Verfahren der Einbindung eines Softwarepakets in die automatische Softwareverteilung für Windows-Betriebssysteme, zuzüglich einer Variante, die sich auf die Pakete für den Microsoft Installer Service bezieht.
...
NOTE: Opsi unterstützt alle zwei Varianten. In der Praxis werden sie häufig ergänzend verwendet.
