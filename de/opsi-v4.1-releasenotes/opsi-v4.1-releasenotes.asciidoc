...
Im Backend wird das alte Format automatisch konvertiert und dabei werden standardmäßig die Ports 7, 9 & 12287 verwendet. Dadurch sollte gängige Hardware abgedeckt werden.
