...
Anschließend müssen auf den Konfigservern die Backends Aktualisiert, die aktuelle Konfigration angewendet und die Dienste neu gestartet werden. (Auf Depotservern sind diese Arbeiten 
[source,prompt]
----
