...
Als erstes müssen die opsi 4.1 Repositories der Server-Pakete in den Paketquellen. Im opsi 4.1 Release wird der 'opsi-atftpd' durch den neuen 'opsi-tftpd-hpa' ersetzt. Hierbei ist zu beachten das eine bestehende Konfiguration der Datei '/etc/inetd.conf' bzw. '/etc/xinetd.conf' bzw. '/etc/default/atftpd' rückgängig gemacht werden muss.
