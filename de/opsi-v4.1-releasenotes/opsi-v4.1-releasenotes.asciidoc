...
Für den Fall, dass Sie an der `opsi-product-updater.conf` bislang keine Veränderungen vorgenommem haben können Sie direkt zum  Kapitel <<opsi-4.1-releasenotes-installation-migration-opsi-packages-standard, Verwendung der Standard Konfiguration>> gehen. 
