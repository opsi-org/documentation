...
Es ist außerdem empfohlen, dass 'opsi-winst', 'opsi-client-agent' bzw. 'opsi-linux-client-agent' auf den Clients auf den aktuellsten Stand gebracht werden.
...
[source,prompt]
----
opsi-package-updater repo --list-products
----
