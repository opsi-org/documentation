...
CAUTION: Die alte Konfigurationsdatei enthält opsi 4.0-Repositories. Die Weiterverwendung dieser Konfiguration kann dazu führen, dass nicht die neuesten Paketversionen verwendet werden.
