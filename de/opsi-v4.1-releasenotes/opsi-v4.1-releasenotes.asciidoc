...
* `opsi-makeproductfile` wird automatisch ergänzende .md5 und .zsync-Dateien bei der Erstellung eines Produkts erstellen. Die kann durch `--no-md5` bzw. `--no-zsync` unterdrückt werden.
