...
----
die eine Überprüfung der `dispatch.conf`, `hostcontrol.conf` und `opsiconfd.conf`  nach sich ziehen. 
...
* opsi-local-image Win NT6 Produkte in der Version 4.1.0.0-1
...
* Win NT6 Produkte in der Version 4.1.0.0-1
