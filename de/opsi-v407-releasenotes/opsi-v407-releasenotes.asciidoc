...
** WakeOnLan auch für Clients an Depotserver
...
** Der Sortieralgorithmus 1 ist repariert.
** Die Abfolge der Produkte mit Aktionen, wie sie der opsi-winst sieht,  bleibt auch nach partiell durchgeführten Installation konstant.
...
Mit dem debian8 und Ubuntu16-04 Paket ist es nun möglich von einem lokalen Apache2 Repository zu installieren. Das opsi-linux-server Paket installiert dass
hierfür benötigte Paket und erstellt auch die benötigten Ordner. Dieser muss danach mit den von uns bereitgestellten Repositories gefüllt werden. Die Repositories finden Sie auf unserem üblichen download Server.
...
image::opsi-client-kiosk.png["opsi-client-kiosk: Hauptfenster", width=400]
...
macht jetzt (wieder), was er laut Handbuch machen soll.  In Version 4.0.6 war er durch Überlappung mehrerer Fehler
