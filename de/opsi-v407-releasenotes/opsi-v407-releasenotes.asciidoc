...
macht jetzt (wieder), was er laut Handbuch machen soll. Die Produktreihenfolge, die je nach Einstellung im Server-Config
mit Algorithmus 1 oder 2 berechnet ist, wird jetzt bei der
Produktinstallation durch den opsi-winst (konstant) eingehalten.
** Bei der Verwendung der Option 'resolveHostAddress' bei den Backends HostControl und HostControlSafe +
wird bei einem fehlgeschlagenen Versuch der Namensauflösung eine eventuell
hinterlegte IP-Adresse verwendet.
