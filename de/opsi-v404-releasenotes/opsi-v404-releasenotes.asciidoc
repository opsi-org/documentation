...
Im 4.0.4 Release wurde das Problem dadurch behoben, dass die Gruppe pcpatch und opsifileadmins als adminusers in der Share-Konfiguration vom opsi_depot-Share aufgenommen wurden. Dadurch verhalten sich die Zugriffe auf den opsi-Depotshare wieder wie gewohnt.
