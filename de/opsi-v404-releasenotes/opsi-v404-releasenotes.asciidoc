...
mkdir opsi404
cd opsi404
wget -r -l1 -nc -nd -A "*.opsi" http://download.uib.de/opsi4.0/testing/opsi404/products/
...
[[opsi-404-releasenotes-executablebit]]
...
[[opsi-404-releasenotes-sambareload]]
=== UCS Samba Reload
