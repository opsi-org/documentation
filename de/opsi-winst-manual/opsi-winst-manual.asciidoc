...
* Default Name für die Logdatei ist unter Windows `C:\tmp\instlog.txt`
...
Die default Protokolldateien werden in das Verzeichnis 'c:\tmp' geschrieben, welches der '{opsi-winst}/opsi-script' zu erstellen versucht. Wenn der '{opsi-winst}/opsi-script' nicht erfolgreich bei der Erstellung diese Protokollverzeichnisses ist, wird das Benutzer TEMP-Verzeichnis zum Speichern der Protokolldatei genutzt. 
