...
[[opsi-winst-skins]]
=== Skinnable '{opsi-winst}/opsi-script'
...
[[opsi-winst-prim-section]]
== Syntax und Bedeutung der primären Sektionen eines '{opsi-winst}/opsi-script' Skripts 
...
==== Benötigte '{opsi-winst}/opsi-script' Version
