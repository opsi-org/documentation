...
Di Funktion arbeitet nur korrekt, wenn '{opsi-winst}/opsi-script' im opsi service mode aufgerufen wird. +
...
==== (Wieder-) Gewinnen von Einzelstrings aus String-Listen [W/L] 
