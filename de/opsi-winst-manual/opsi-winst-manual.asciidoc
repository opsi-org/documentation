...
'opsi-script' ist im Moment ein GUI Programm, welches ohne Zugriff auf ein X Display nicht gestartet werden kann. Eine Version 'opsi-script-nogui' welches sich auch ohne X starten lässt, ist in Vorbereitung.
...
=== Fehlgeschlagene Installation anzeigen [W/L] 
