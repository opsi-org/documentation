...
----
öffnet einen Texteditor und zeigt die Sektionszeilen an (allerdings keine Zeilen die mit einem Semikolon	 starten, da der '{opsi-winst}' solche Zeilen als Kommentarzeile ausliest und sie eliminiert bevor sie ausgeführt werden).
