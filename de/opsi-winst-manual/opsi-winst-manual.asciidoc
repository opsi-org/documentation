...
NOTE: Die opsi Erweiterung 'Roaming Profile Support' ist derzeit (19.10.2011) ein Kofinanzierungsprojekt. Dies Bedeutet, dass es nicht frei ist, sondern käuflich erworben werden muss um es zu verwenden.
