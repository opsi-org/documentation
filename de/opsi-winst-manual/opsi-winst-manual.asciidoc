...
- Die komplette Zeichenkette besteht insgesamt nicht mehr als aus 254 Zeichen
...
- Die Zeichenketten, bis auf die Letzte, dürfen Buchstaben, ganze Zahlen und Minuszeichen enthalten, das Minuszeichen darf aber nicht am Anfang stehen
...
* `isValidFQDN (`<domainName>`) : boolean`  //since 4.12.4.4  +
Gibt true (wahr) zurück wenn die Zeichenkette einem Fully Qualified Domain Name (FQDN) entspricht und false (falsch) wenn nicht.
Ein Fully Qualified Domain Name (FQDN, deutsch in etwa "vollständiger Name einer Domain") hat folgende Eigenschaften:
- Die Länge darf 254 Zeichen nicht überschreiten
- Er sollte mindestens drei durch Punkte getrennte Zeichenketten enthalten
- Jede Zeichenkette darf nicht länger als 63 Zeichen sein
- Die Zeichenketten, bis auf die Letzte, dürfen Buchstaben, ganze Zahlen und das Minuszeichen enthalten, dieses darf aber nicht an erster Stelle einer Zeichenkette stehen.
- Die letzte Zeichenkette (TLD, Top-Level-Domain) darf nur Buchstaben enthalten und muss mindestens eine Länge von 2 Buchstaben haben

Beispiel:
[source,winst]
----
Message "Testen von isValidFQDN"
SetLogLevel=7
