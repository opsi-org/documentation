...
opsi-script Handbuch (4.12.4.27)
================================
...
Verweise auf diese und weitere Linux-spezifische Bibliotheks Funktionen finden Sie hier: <<opsi-script-rc-linux-specific, Linux specific functions>>
...
Verweise auf weitere macOS-spezifische Bibliotheks Funktionen finden Sie hier: <<opsi-script-rc-macos-specific, macOS specific functions>>
...
siehe auch: <<opsi-script-skins, Skinnable '{opsi-script}'>>
...
Diese neue 'XML2' Sektion und die 'XML2' Funktionen ersetzen die alte und nur für Windows verfügbare <<opsi-script-xmlpatch, XMLPatch Sections>>.
