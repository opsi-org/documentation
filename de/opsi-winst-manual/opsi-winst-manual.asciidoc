...
interprets the specified file as an inifile, looks for the list related to the +
'[<ini-file-section>]' chosen in input +
and returns the complete stringlist of that section.
...
see <<opsi-winst-64bit,Kapitel 64 Bit-Unterstützung>>
