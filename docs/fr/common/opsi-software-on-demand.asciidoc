...
WARNING: The customization will not automatically be saved at the moment. If you install {opsi-client-agent} again you will loose the changes. Don't forget to save the files, before upgrading the system.
