...
WARNING: Pleaes notice the minimum requirements of the opsi-depotserver-package. +
...
WARNING: Die Änderungen werden momentan nicht gesichert und würden bei einer Neuinstallation des opsi-Pakets opsi-client-agent überschrieben werden. Bitte denken Sie daran, die Dateien vor einem Upgrade zu sichern.
