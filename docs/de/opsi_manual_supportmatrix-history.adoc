...
|UCS 3.2                    | image:supported.png[width=15] | nicht auf Role Member | image:supported.png[width=15]  | nicht auf Role Member
|UCS 4.0                    | image:develop.png[width=15] | nicht auf Role Member | image:supported.png[width=15] | nicht auf Role Member
|UCS 4.1                    | image:unsupported.png[width=15] | nicht auf Role Member | image:supported.png[width=15] | nicht auf Role Member
|==========================
