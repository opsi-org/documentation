...
-> hier nur allgemeine Infos, Kapitel unterteilen in
* Windows
* Linux
* macOS
...
Mit diesem neuen Feature ist es über die Konfiguration möglich, die Liste der ab zu bearbeitenden Produkte über {product-groups} zu steuern.
