...
include::4.3@opsi-docs-en:common:partial$os-lib-uib-lin-install.adoc[leveloffset=4]
...
include::4.3@opsi-docs-en:common:partial$firststeps-opsi-template-lin.adoc[]
