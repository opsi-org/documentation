...
= Einspielen der minimalen Windows {opsi-products}
...
== Automatisches Einspielen der minimalen Windows {opsi-products}
...
== Manuelles Einspielen der Windows {opsi-products}
