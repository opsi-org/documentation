...
TIP: Nach erfolgreicher Installation laden Sie alle Daten in der xref:modules:common:partials:firststeps-configed.adoc[Management-Oberfläche `opsi-configed`] neu, damit die neuen Produkte dort sichtbar werden.
