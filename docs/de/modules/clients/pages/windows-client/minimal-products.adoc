...
WARNING: Beachten Sie, dass Produkte zur Betriebssystem-Installation wie z.B. win10-x64 nach dem Einspielen nicht sofort einsatzbereit sind. Sie müssen noch durch die Installationsdateien des entsprechenden Installationsmediums ergänzt werden (siehe Kapitel xref:clients:windows-client/os-installation.adoc[Windows mit opsi installieren]).
