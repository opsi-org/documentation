...
CAUTION: Die Freigabe muss über das SMB Protokoll (cifs) erfolgen, da WebDav unter macOS in Zusammenhang mit signierten Apps teilweise buggy ist und anscheinend auch nicht weiter gepflegt wird.
