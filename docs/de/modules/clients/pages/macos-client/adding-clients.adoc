...
Gegebenenfalls ist es erforderlich, Festplattenvollzugriff für den `opsiclientd` zu gewären, siehe xref:clients:macos-client/general-notes.adoc#opsi-macclient-hints-fulldiskaccess[Freigeben von Festplattenvollzugriff] für Details.
