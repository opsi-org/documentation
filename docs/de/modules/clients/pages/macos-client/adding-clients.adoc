...
Sobald der Agent installiert ist, können vorhandene {opsi-products} auf diesen Clients xref:rollout-products.adoc#firststeps-software-deployment-product-tests[installiert] werden.
...
* Username (Mitglied der {opsi-admin} Gruppe)
