...
image::clients:macos_sharing_ssh_login.png["Unter macOS aktivieren Sie den SSH-Zugriff.", width=800, pdfwidth=80%]
...
image::clients:opsi-deploy-agent.png["Die Onlinehilfe von *opsi-deploy-client-agent*", pdfwidth=80%, width=800]
