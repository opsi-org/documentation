...
include::4.3@opsi-docs-en:common:partial$os-lib-uib-macosinstalllib.adoc[leveloffset=4]
...
include::4.3@opsi-docs-en:common:partial$firststeps-opsi-template-mac.adoc[]
