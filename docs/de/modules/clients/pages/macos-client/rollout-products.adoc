...
image::clients:install-m-homebrew.png["Installieren Sie die beiden Produkte *m-xcode-tools* und *m-homebrew*.", width=800, pdfwidth=80%]
...
image::clients:install-mac-opsi-configed.png["Installieren Sie das Produkt *opsi-configed*." width=800, pdfwidth=80%]
