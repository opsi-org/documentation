...
* Alternativ statten Sie einen Rechner über opsi zunächst mit einem neuen Betriebssystem aus. Dabei wird der benötigte Agent automatisch installiert (siehe Kapitel xref:clients:windows-client/adding-clients.adoc[Neue Clients hinzufügen]).
