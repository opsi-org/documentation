...
Zusätzlich kann der _{opsi-configed}_ auch als Portable für die Betriebssysteme Windows, Linux und MacOS unter :http://download.uib.de/4.2/stable/misc/[] heruntergeladen werden. Auf diese Weise lässt sich das Programm ohne Installation herunterladen.
