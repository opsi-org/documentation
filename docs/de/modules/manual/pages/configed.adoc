...
._{opsi-configed}_: Validierungsstatus der opsi-Module
...
Beim Starten des {opsi-configed} wird auf existierende Warnzustände hingewiesen. Dies kann mit der Checkbox 'Warnungen beim Start anzeigen' oder direkt über das Config _licensing.show_warning_on_start_ konfiguriert werden. 
