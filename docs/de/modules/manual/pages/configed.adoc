...
Zur Änderung des Loglevels gibt es auf die Kommandozeile die Option --loglevel [LEVEL] . Die Verwendung von Level 7 oder höher ist nur angezeigt, wenn bereits der configed-Start
