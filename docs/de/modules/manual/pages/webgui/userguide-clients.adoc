...
In der Schnellnavigation werden die Gruppen und ihre Clients in einer Baumstruktur unter dem Reiter <image> angezeigt.
// TODO: new image clientgroup tab in quick panel
Die Zahl neben dem Icon entspricht der Anzahl der ausgewählten Clients.
Der erste Reiter <image> zeigt eine Übersicht dieser.
// TODO: new image info tab in quick panel
