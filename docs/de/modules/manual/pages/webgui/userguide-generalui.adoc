...
Die {opsi-webgui} ist sowohl für Mobilgeräte als auch Desktopgeräte abgestimmt. Darüber hinaus wurde auf Barrierefreiheit geachtet. Damit jeder Benutzer von nahezu jedem Gerät die webgui verwenden kann.
...
[horizontal]
Menü:: die obere Leiste image:webgui/opsi-webgui_breadcrumb.png[Breadcrumb] enthält eine Breadcrumb-Navigation, die Benutzern ihren Standort innerhalb der Anwendung anzeigt.
...
image:webgui/opsi-webgui_buttonlogout.png[Logout]Logout, sowie
...
Die Tabellenzeile enthält Element-spezifische Optionen wieimage:webgui/opsi-webgui_buttonconfig.png[Config]Konfiguration oderimage:webgui/opsi-webgui_buttonlog.png[Logs]Logs, die eine geteilte Ansicht für die gewählte Option öffnet, oder einimage:webgui/opsi-webgui_buttonclientactions.png[Aktionen]Aktionsmenü.
