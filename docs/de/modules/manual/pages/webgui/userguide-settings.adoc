...
= Einstellungen
Die Einstellungen umfassen hauptsächlich Anwendungsoptionen wie Sprache, Theme oder Sofortspeicherung, sowie opsi-spezifische Einstellungen wie opsi-Erweiterungen.
