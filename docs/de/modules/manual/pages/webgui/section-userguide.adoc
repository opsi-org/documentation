...
Dabei kann das anzuzeigende Log-Level (default: `5`) und der Logtyp (`bootimage`, `clientconnect`, default: `instlog`, `opsiconfd`, `userlogin`) ausgewählt werden. Zusätzlich kann die Logausgabe nach einem Text gefiltert werden.
