...
In der Schnellnavigation werden die Gruppen und ihre Produkte in einer Baumstruktur unter dem Reiter <image> angezeigt.
// TODO: new image productgroup tab in quick panel
