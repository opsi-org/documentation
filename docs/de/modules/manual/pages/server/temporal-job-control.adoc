...
Ein weiterer Weg um action requests zu setzen, ist durch
ifeval::["{mode}" == "antora"]
xref:server/configuration-tools.adoc#opsi-cli opsi-manual-configuration-tools-opsi-cli-commands-client-actions[opsi-cli].
endif::[]
ifeval::["{mode}"!= "antora"]
link:opsi-manual-configuration-tools-opsi-cli-commands-client-actions[opsi-cli].
endif::[]
