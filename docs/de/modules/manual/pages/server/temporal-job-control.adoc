...
Ein weiterer Weg um action requests zu setzen, ist durch xref:server/configuration-tools.adoc#opsi-cli opsi-manual-configuration-tools-opsi-cli-commands-client-actions[opsi-cli].
