...
Der Health Check kann auf verschiedearten aufgerufen werden. 
...
Hier wird beshreiben, was der {health-ckeck} alles überprüft und wie der Zustand des Systems bewertet wird.
