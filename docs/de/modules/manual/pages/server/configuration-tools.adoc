...
image::opsi-cli-general-options.png["Ausgabe: opsi-cli self --help", pdfwidth=90%]
...
image::opsi-cli-io-options.png["Ausgabe: opsi-cli self --help", pdfwidth=90%]
...
image::opsi-cli-service-options.png["Ausgabe: opsi-cli self --help", pdfwidth=90%]
