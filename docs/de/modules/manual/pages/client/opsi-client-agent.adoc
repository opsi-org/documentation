...
WARNING: Die Beschreibung für den Kiosk gilt nur für opsi-client-agents \<= 4.1.0.0. Ab Version 4.1.1.0 steht der Kiosk als seperates Paket zur Verfügung. Siehe hierzu Kapitel <<software-on-demand, opsi Software On Demand - opsi Client Kiosk (frei) >>
