...
* den im Hauptfenster ausgewählten Pool allen ID-Varianten zuweisen (das ist vermutlich der Standardfall)
* alles dem ausgewählten Pool zuweisen für den Fall, dass die Varianten verschiedenen Pools zugeordnet sind
...
image::licensemanagement-table-sw-alternative-view.png["Optionen für alternative Zuordnung", width=400]
...
image::licensemanagement-table-sw-modi-primary.png["Optionen der Anzeige der von Software-Items", pdfwidth=80%]
...
. Wenn die Software tatsächlich neu ist, erscheint ein neuer Eintrag in der Software-Tabelle; es können, wenn zum Beispiel Bibliotheken mitinstalliert werden, auch mehrere Einträge sein.
...
image::licensemanagement-createlicense.png["Lizenzmanagement:Tab 'Lizenz anlegen'", pdfwidth=80%]
...
image::licensemanagement-editlicense.png["Lizenzmanagement:Tab 'Lizenzierungen bearbeiten'", pdfwidth=80%]
