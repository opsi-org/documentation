...
Anstelle des Kontextmenüs können Sie auch auch das Filter-Icon neben dem Suchfeld klicken. Wenn ein Filter aktiv ist, erscheint das Symbol durchgestrichen.
...
image::licensemanagement-table-sw-name2pool.png["Inverse Zuordnungen", pdfwidth=80%]
...
image::licensemanagement-table-sw-alternative-view.png["Optionen für alternative Zuordnung", pdfwidth=80%]
