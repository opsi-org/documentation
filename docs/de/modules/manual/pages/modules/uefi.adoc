...
Dieser Eintrag liegt meistens im Bereich 'Boot' oder 'Startup' kann aber auch im Bereich 'Security' liegen. Informationen zur Verwendung von Secureboot gibt es in einem <<opsi-manual-secureboot,eigenem Kapitel>>.
...
* <<opsi-manual-secureboot,Secureboot>> implementiert eine zusätzliche Sicherheit, sodass nur authorisierte Software und Betriebssysteme installiert werden können.
