...
CAUTION: Ein Rechner kann *nicht* gleichzeitig am selben '{opsi-configserver}' Client *und* Server (z.B. '{opsi-depot}' / '{opsi-configserver}') sein. +
...
CAUTION: Derzeit kann eine Maschine nicht gleichzeitig am selben opsi-configserver
