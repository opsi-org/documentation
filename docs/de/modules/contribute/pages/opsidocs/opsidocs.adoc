...
Dieser Abschnitt erklärt, wie Sie die https://docs.opsi.org[opsi-Dokumentation] bearbeiten können.
...
+
image::contribute:readme/opsidoc-edit-page-en.png["Klicken Sie auf _Edit this Page_ im Browser."]
+

. Nach dem Einloggen auf GitHub öffent sich der online Editor.
+
