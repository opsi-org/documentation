...
+
. Der Anmeldedialog unserer https://gitlab.uib.de[GitLab-Instanz] öffnet sich. Melden Sie sich mit Ihren Zugangsdaten an. Falls Sie noch keinen Account haben, lesen Sie bitte [##../contribute.adoc##].
+
image::4.2@opsi-docs-en:manual:readme/opsidoc-gitlab-login.png["Login bei der opsi-GitLab-Instanz"300]
+
. Nach dem Einloggen öffnet sich der GitLab-Editor. 
+
image::4.2@opsi-docs-en:manual:readme/opsidoc-edit.png["Der GitLab-Editor"]
+
