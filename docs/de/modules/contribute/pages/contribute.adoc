...
+
image::contribute:readme/opsidoc-gitlab-register.png["Registrierungs-Dialog der opsi-GitLab-Instanz",300]
+
...
+
image::contribute:readme/opsidoc-gitlab-welcome.png["Eine Rolle bei der opsi-GitLab-Instanz festlegen",300]
+
