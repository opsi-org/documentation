...
Es gibt eine Reihe von Aktionen die für einen bestimmten Client ausgeführt werden können. 

Um diese aufzulisten gehen Sie wie folgt vor:
...
. Wählen Sie die gewünschte Aktion aus und bestätigen Sie den aufkommenden Dialog +
