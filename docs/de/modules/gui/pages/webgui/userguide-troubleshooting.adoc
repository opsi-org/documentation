...
Sind die Navigationsleiste am linken und am oberen Rand sichtbar, bleibt die Anzeige ansonsten aber leer, kann es sein, dass Ihre Session abgelaufen ist. 
Laden Sie die Seite neu, z.{nbsp}B. mit der Tastenkombination [Strg]{plus}[F5]; das leert auch gleichzeitig den Seiten-Cache. 
Alternativ öffnen Sie einen neuen Reiter im Browser und öffnen das WebGUI dort.
