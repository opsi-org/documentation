...
. Wählen Sie Clients aus den xref:gui:webgui/userguide-clients.adoc#opsi-manual-opsiwebgui-opsiclients-groups[Client-Gruppen] oder von der Seite xref:gui:webgui/userguide-clients.adoc#opsi-manual-opsiwebgui-opsiclients[Clients] aus.
...
NOTE: Siehe xref:gui:webgui/userguide-clients.adoc#opsi-manual-opsiwebgui-opsiclients-actions-ondemand[on_demand] wenn Sie diese Installationen sofort auf den Client anwenden möchten.
