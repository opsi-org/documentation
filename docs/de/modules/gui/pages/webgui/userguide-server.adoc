...
opsi kennt zwei verschiedene Server-Varianten: Der Hauptserver ist der opsi-Configserver. Alle anderen heißen opsi-Depotserver (siehe Kapitel xref:server:overview.adoc[opsi-Server]).
...
image::webgui/opsi-webgui_quickpanel_tab_depots_content.png["WebGUI: aktuell ausgewählte Server", width=200, pdfwidth=80%]
