...
Die jeweiligen Tabellen zeigen Elemente, die verzögert nachgeladen werden, wenn Sie nach unten oder oben scrollen. Über die Schaltfläche image::gui:webgui/opsi-webgui_buttonclearselect.png[Auswahl löschen] heben Sie die Auswahl für markierte Elemente auf.
