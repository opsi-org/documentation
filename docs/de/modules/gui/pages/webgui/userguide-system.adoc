...
== Health Check und Diagnostik-Daten
...
Mehr dazu finden Sie unter  xref:server:components/opsiconfd.adoc#server-components-opsiconfd-health-check[Health Check].
