...
._opsi-configed_: Clientauswahl
image::opsi-configed-clientselection.png["opsi-configed: Clientauswahl", pdfwidth=90%]
...
._opsi-configed:_ Suchfunktion für Clientauswahl
...
Im Clientauswahl-Dialog, der über _Auswahl / Auswahl definieren_ oder über das Icon _Auswahl definieren_ gestartet wird, können dynamische
