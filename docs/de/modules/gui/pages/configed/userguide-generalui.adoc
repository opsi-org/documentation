...
image::gui:opsi-configed-toolbar-left.png["*opsi-configed*: Icons auf der linken Seite", pdfwidth=80%]
...
image::gui:opsi-configed-toolbar-right.png["*opsi-configed*: Icons auf der rechten Seite", pdfwidth=80%]
