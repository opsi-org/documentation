...
NOTE: `opsi-configed` speichert auf dem lokalen Rechner (auf dem Sie das Programm gestartet haben) einige Einstellungen, darunter das gewählte Theme und die zuletzt ausgewählten Clients/Gruppen. Beim nächsten Start finden Sie sich also in der gleichen Ansicht wieder.
...
* xref:userguide-server.adoc[Server-Konfiguration]
