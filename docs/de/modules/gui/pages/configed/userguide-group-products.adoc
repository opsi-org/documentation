...
image::gui:configed_groupaction_localimage.png["opsi-configed: Gruppenaktionen (für *opsi-local-image*)", width=800, pdfwidth=80%]
...
image::gui:configed_package-actions.png["*opsi-configed*: Paket- und Produktaktionen", width=800, pdfwidth=80%]
