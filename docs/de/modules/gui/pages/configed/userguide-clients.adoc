...
image::gui:configed_toolbar_icons_filter.png["*opsi-configed*: Über dieses Icon beschränken Sie die Anzeige auf ausgewählte Clients.", pdfwidth=80%]
...
image::gui:opsi-configed-failedactions-today.png["*opsi-configed*: Suchen Sie nach fehlgeschlagenen Aktionen.", width=800, pdfwidth=80%]
