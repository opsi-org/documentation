...
//hier
Die Gruppen, die im Treeview angezeigt werden, sind diejenigen, die Sie entsprechend der Anleitung im Handbuch erstellt haben. Zusätzliche Gruppen können Sie leicht hinzufügen: Klicken Sie einfach mit der rechten Maustaste auf die übergeordnete Gruppe oder den übergeordneten Knoten, zum Beispiel 'GRUPPEN', und wählen Sie 'Untergruppe erzeugen', um eine neue Gruppe zu definieren.
