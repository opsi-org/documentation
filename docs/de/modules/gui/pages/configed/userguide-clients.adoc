...
Die Kommandos bearbeiten Sie im Bereich Server-Konfiguration in der Abteilung _configed_ / _remote_control_:
...
image::gui:opsi-configed-hardwareinfo-treiberintegration.png["*opsi-configed*: Hardware-Information, Treiberupload", width=800, pdfwidth=80%]
...
image::gui:opsi-configed-hostparameters.png["*opsi-configed*: Host-Parameter in der Client-Konfiguration", width=800, pdfwidth=80%]
