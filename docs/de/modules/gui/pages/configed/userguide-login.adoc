...
image::gui:opsi-configed-login.png["*opsi-configed*: Login-Fenster", pdfwidth=80%]
...
image::gui:opsi-configed-ask-for-certificate.png["*opsi-configed*: opsi-CA-Zertifikat verifizieren", pdfwidth=80%]
