...
NOTE: Für die kostenpflichtigen Erweiterungen benötigen Sie eine Lizenz-Datei.
Sie erhalten diese, nachdem Sie die Erweiterung gekauft haben.
Zu Evaluierungszwecken stellen wir Ihnen kostenlos eine zeitlich befristete Lizenz zur Verfügung.
Bitte kontaktieren Sie uns dazu per mailto:sales@uib.de[E-Mail].
...
Sie können die Lizenz und eine Lizenz-Datei kostenfrei über unsere Website beziehen: https://opsi.org/de/opsi-basic
...
image::opsi-modules:configed_validierung-opsi-module.png["Status der Freischaltung in der Management-Oberfläche anzeigen", pdfwidth=70%]
