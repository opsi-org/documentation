...
[source,shell]
----
opsiconfd setup --register-depot --unattended '{"address": "config.server.address:4447/rpc", "username": "adminuserinopsi", "password": "pwoftheuser", "description": "Added with unattended registration."}'
----
