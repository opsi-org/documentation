...
CAUTION: Ändern Sie die Einstellungen der `opsi-local-image-prepare`-Properties nicht mehr, nachdem Sie einen Rechner damit präpariert haben, da die nachfolgenden Produkte auf diese Werte zugreifen.
