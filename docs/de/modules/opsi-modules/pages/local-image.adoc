...
NOTE: Diese Methoden sind veraltet und werden in einer zukünftigen Version entfernt werden. Nutzen Sie stattdessen `setProductActionRequest`, `productPropertyState_getObjects`
