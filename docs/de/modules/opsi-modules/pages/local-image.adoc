...
TIP: Die `opsi-local-image`-Produkte unterstützen auch Systeme mit mehreren Festplatten. Lesen Sie dazu auch den Abschnitt xref:opsi-products:netboot-products#opsi-manual-netboot-nt6[Hinweise zu den NT6-Netboot-Produkten].
