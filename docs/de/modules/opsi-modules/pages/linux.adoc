...
Eine opsilic-Datei mit den benötigten Freischaltungen kann im custom Verzeichnis des Produktes abgelegt werden.
Wird dort eine opsilic-Datei gefunden so wird diese verwendet.
