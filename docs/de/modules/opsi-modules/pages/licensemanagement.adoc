...
image::opsi-modules:mysql-schema-licensemanagement.png["Für das Lizenzmanagement relevante Datenbanktabellen"]
...
.`opsi-configed`: Das Lizenzmanagement erreichen Sie über das unterste Symbol (_Lizenzen_).
image::opsi-modules:configed-masterbuttons.png["`opsi-configed`: Das Lizenzmanagement erreichen Sie über das unterste Symbol (_Lizenzen_).", pdfwidth=50%]
...
image::opsi-modules:licensemanagement-licensepools.png["Der Reiter _Lizenzpools_", pdfwidth=80%]
...
image::opsi-modules:licensemanagement-table-sw-modi-blended.png["Konfiguration Softwaretabelle"]
...
image::opsi-modules:licensemanagement-table-sw-rowcursor.png["Zeilencursor SW-Tabelle", pdfwidth=75%]
...
image::opsi-modules:licensemanagement-table-sw-contextmenu01.png["Kontextmenü Softwaretabelle", pdfwidth=70%]

Nach Betätigen der Auswahlfunktion:

.Softwaretabelle, reduziert auf die Zuordnungen zum ausgewählten Lizenzpool
image::opsi-modules:licensemanagement-table-sw-contextmenu02.png["Kontextmenü Softwaretabelle", pdfwidth=70%]
...
image::opsi-modules:licensemanagement-table-sw-name2pool.png["Inverse Zuordnungen", pdfwidth=70%]
...
image::opsi-modules:licensemanagement-table-sw-alternative-view.png["Optionen für alternative Zuordnung", pdfwidth=55%]
...
image::opsi-modules:licensemanagement-table-sw-modi-primary.png["Optionen der Anzeige der von Software-Items", pdfwidth=55%]
...
image::opsi-modules:licensemanagement-createlicense.png["Lizenzmanagement:Tab 'Lizenz anlegen'", pdfwidth=55%]
...
image::opsi-modules:licensemanagement-editlicense.png["Lizenzmanagement:Tab 'Lizenzierungen bearbeiten'", pdfwidth=55%]
...
image::opsi-modules:licensemanagement-editlicense-copying-license-id.png["Lizenzmanagement:Kopieren der License-ID", pdfwidth=55%]
...
image::opsi-modules:licensemanagement-usages.png["Lizenzmanagement:Tab Lizenzenverwendung", pdfwidth=55%]
...
image::opsi-modules:licensemanagement-reconciliation.png["Lizenzmanagement:Tab Abgleich mit Inventarisierung, pdfwidth=55%]
...
image::opsi-modules:licensemanagement-statistics.png["Lizenzmanagement:Tab Statistik", pdfwidth=55%, width=55%]
...
do
	...
	MYLIC=`opsi-admin -S method createSoftwareLicense "" "c_$PRODUCT_ID" "OEM" "1" "${AKTHOST}" ""`
	opsi-cli jsonrpc execute addSoftwareLicenseToLicensePool "$MYLIC" "p_$PRODUCT_ID" "${PRODUCT_ID}-oem-${AKTKEY}"
done
}
#############
...
opsi-cli jsonrpc execute deleteLicensePool "p_$PRODUCT_ID" true

# delete the existing license contract
echo "deleteLicenseContract c_$PRODUCT_ID"
opsi-cli jsonrpc execute deleteLicenseContract "c_$PRODUCT_ID"
...
opsi-cli jsonrpc execute createLicensePool "p_$PRODUCT_ID" "opsi license test" \'['"'$PRODUCT_ID'"']\' \'['"'$PRODUCT_ID'"']\'
...
opsi-cli jsonrpc execute createLicenseContract "c_$PRODUCT_ID" "uib gmbh" "" "" "" "test contract"
...
do
	...
	MYLIC=`opsi-admin -S method createSoftwareLicense "" "c_$PRODUCT_ID" "RETAIL" "1" "" ""`
	opsi-cli jsonrpc execute addSoftwareLicenseToLicensePool "$MYLIC" "p_$PRODUCT_ID" "${PRODUCT_ID}-retail-${AKTKEY}"
done
...
MYLIC=`opsi-admin -S method createSoftwareLicense "" "c_$PRODUCT_ID" "VOLUME" "10" "" ""`
opsi-cli jsonrpc execute addSoftwareLicenseToLicensePool "$MYLIC" "p_$PRODUCT_ID" "${PRODUCT_ID}-vol-key"#
