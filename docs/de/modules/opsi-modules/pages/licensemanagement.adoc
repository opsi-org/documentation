...
image::opsi-modules:configed-masterbuttons.png["`opsi-configed`: Das Lizenzmanagement erreichen Sie über das unterste Symbol (_Lizenzen_).", width=400]
...
image::opsi-modules:licensemanagement-table-sw-rowcursor.png["Zeilencursor SW-Tabelle", width="100mm"]
