...
Dafür nutzt man im linken Bereich den Reiter "Produkt Gruppen".

TIP: Wieviele Clients gerade ausgewählt sind, sieht man auf der unteren Leiste links: hinter "Anzahl Clients" folgt "In Tabelle ausgewählt".
...
Produkte können per Drag-and-Drop in eine Gruppe gezogen werden. Dies ist sowohl aus dem Produktbaum im linken Bereich als auch aus dem rechten Bereich in den Reitern „Localboot-Produkte“ und "Netboot-Produkte" möglich. +
