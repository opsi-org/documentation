...
|UEFI pur|image::opsi-modules:supported.png[width=15]|image::opsi-modules:supported.png[width=15]|image::opsi-modules:supported.png[width=15]
|UEFI + CSM|image::opsi-modules:supported.png[width=15]|image::opsi-modules:unsupported.png[width=15]|image::opsi-modules:supported.png[width=15]
|Legacy|image::opsi-modules:supported.png[width=15]|image::opsi-modules:unsupported.png[width=15]|image::opsi-modules:supported.png[width=15]
|Both|image::opsi-modules:supported.png[width=15]|image::opsi-modules:unsupported.png[width=15]|image::opsi-modules:unsupported.png[width=15]
|UEFI Netboot|image::opsi-modules:supported.png[width=15]|image::opsi-modules:supported.png[width=15]|image::opsi-modules:supported.png[width=15]
|Aktivierbarer Eintrag|image::opsi-modules:supported.png[width=15]|image::opsi-modules:unsupported.png[width=15]|image::opsi-modules:supported.png[width=15]
|Netboot ohne Interaktion|image::opsi-modules:supported.png[width=15]|image::opsi-modules:unsupported.png[width=15]|image::opsi-modules:supported.png[width=15]
|==========================

image::opsi-modules:supported.png[width=15]: Supported
image::opsi-modules:unsupported.png[width=15]: Unsupported
image::opsi-modules:develop.png[width=15]: Under Development
image::opsi-modules:discontinued.png[width=15]: Discontinued
