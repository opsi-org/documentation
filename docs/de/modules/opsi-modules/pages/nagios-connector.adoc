...
Nun der Teil der das Softwarerollout überwacht. Dabei wird in einem Check auf das {opsi-product} 'opsi-client-agent' verwiesen und zwei andere Checks verwenden hier eine opsi-Produktgruppe 'opsiessentials' sowie eine opsi-Clientgruppe 'productiveclients'.
