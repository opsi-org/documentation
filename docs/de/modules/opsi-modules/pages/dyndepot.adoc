...
.Aufruf der Depoteigenschaften (2. Button von oben)
...
[source,shell]
----
opsi-cli jsonrpc execute method host_getObjects [] '{"id":"dep1.uib.local"}'
----
...
[source,shell]
----
opsi-cli jsonrpc execute method host_getObjects [] '{"id":"dep1.uib.local"}' > /tmp/depot_config.json
----
