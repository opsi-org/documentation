...
image::opsi-modules:clonezilla_expert.png[pdfwidth=80%]
...
image::opsi-modules:clonezilla_parameters6.png[pdfwidth=80%]
...
image::opsi-modules:clonezilla_imagename.png[pdfwidth=80%]
...
image::opsi-modules:clonezilla_choose_diskimage2restore.png[pdfwidth=80%]
...
.Fortschrittsanzeige
image::opsi-modules:clonezilla_restoredisk_progress.png[pdfwidth=80%]
...
image::opsi-modules:clonezilla_choose_partimage2restore.png[pdfwidth=80%]
...
.Das resultierende Kommando. Dieses kann auch im Produktproperty 'runcommand' verwendet werden
image::opsi-modules:clonezilla_restorepart_command.png[pdfwidth=90%]

.Rückfrage vor dem Beginn des Überschreibens der disk. Kann durch Entfernen der Option -c aus dem Kommando unterdrückt werden.
image::opsi-modules:clonezilla_restorepart_askbeforeinst.png[pdfwidth=90%]

.Fortschrittsanzeige
image::opsi-modules:clonezilla_restorepart_progress.png[pdfwidth=80%]
