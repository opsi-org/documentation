...
Es ist empfohlen die folgenden 'Hostparameter' anzulegen.
...
Die 'Hostparameter' können über den 'opsi-configed' oder 'opsi-cli' angelegt werden.

Zum Anlegen der 'Hostparameter' über 'opsi-cli' sind die folgenden Befehle auf dem 'OPSI-Configserver' auszuführen:
...
Das lässt sich am einfachsten per opsi-configed mit dem "WAN-Konfiguration"-Häkchen setzen.
