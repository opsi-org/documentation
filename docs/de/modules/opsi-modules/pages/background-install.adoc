...
* Den Config `opsi-script.backgroundinstall.backgroundinstall_enabled` auf *`true`* setzen.
...
Ist der Config `opsi-script.backgroundinstall.backgroundinstall_enabled` *nicht auf `true`* gesetzt,
...
* backgroundinstall_enabled (Default zunächst false) +
Dieser Defaultwert kann mit dem Config
`opsi-script.backgroundinstall.backgroundinstall_enabled` überschrieben werden.
...
Dieser Defaultwert kann mit dem Config
`opsi-script.backgroundinstall.dialogtimeout` überschrieben werden.
