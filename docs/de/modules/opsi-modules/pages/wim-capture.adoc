...
CAUTION: Um `opsi-wim-capture` verwenden zu können, muss die Freigabe `opsi_depot_rw` für `pcpatch` les- und schreibbar sein. Bitte überprüfen Sie Ihre Samba-Konfiguration.
