...
[source,bash]
----
opsi-cli jsonrpc execute configState_create opsiclientd.event_on_shutdown.active myclient.domain.de true
----
...
[source,bash]
----
opsi-cli jsonrpc execute configState_create opsiclientd.event_on_shutdown.active myclient.domain.de false
----
...
[source,shell]
----
opsi-cli jsonrpc execute configState_create opsiclientd.event_gui_startup.active myclient.domain.de false
----
