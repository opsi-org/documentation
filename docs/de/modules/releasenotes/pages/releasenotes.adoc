...
Tragen Sie jetzt das Repository für opsi 4.2 in die Paketquellen auf Ihrem Linux-Rechner ein. Dabei fügen Sie auch (sofern benötigt) den GnuPG-Schlüssel des Repositorys hinzu. Die Befehle führen Sie als Benutzer `root` aus
