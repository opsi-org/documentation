...
* Aktualisieren Sie zunächst Ihren Server auf opsi 4.2 wie oben beschrieben.
* Aktualisieren Sie dann den opsi-client-agent auf die neueste stabile Version 4.2.
