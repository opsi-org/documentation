...
|sles15-4        | distribution | image:supported.png[width=15] |
|sles15-3        | distribution | image:supported.png[width=15] |
|sles15-2        | distribution | image:supported.png[width=15] |
|sles15-1        | distribution | image:supported.png[width=15] |
