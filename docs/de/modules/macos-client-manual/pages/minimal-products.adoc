...
Die Konfiguration der opsi Repositorys für Mac-Clients findet sich im Verzeichnis `/etc/opsi/package-updater.repos.d/` in den Dateien `uib-mac-testing.repo` und `uib-mac.repo`.
