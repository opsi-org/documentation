...
Weitere Informationen zu opsi-client-agent Installer und weiteren Möglichkeiten den opsi-client-agent zu installieren finden Sie im opsi-Handbuch im Kapitel +Nachträgliche Installation des opsi-client-agents
