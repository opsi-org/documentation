...
.Auf einem frisch installierten opsi-Server spielen Sie zunächst die Standard-Produkte ein.
image::opsi-package-updater.png["Auf einem frisch installierten opsi-Server spielen Sie zunächst die Standard-Produkte ein.", pdfwidth=80%]
