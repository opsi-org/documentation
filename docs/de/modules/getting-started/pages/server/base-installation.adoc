...
* Laden Sie die aktuelle opsi-ServerVM von link:https://opsi.org/de/get-started/[opsi.org]
...
Proxy::	Soweit zum Internetzugriff benötigt, die Angaben zum Proxy: z.B. `http://myuser:mypass@<proxy-address>:8080`
