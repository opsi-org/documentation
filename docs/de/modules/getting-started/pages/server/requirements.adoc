...
Dieses Kapitel beschreibt die Voraussetzungen für die Installation des opsi-Servers unter Linux. Eine Liste der unterstützten Distributionen finden Sie im Kapitel xref:supportmatrix:supportmatrix.adoc[Unterstützte Systeme].
