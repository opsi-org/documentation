...
include::common:partial$firststeps-configed.adoc[]

// include::../common/firststeps-adding-clients.asciidoc[]

include::common:partial$firststeps-osinstall-hwinvent.adoc[]
...
https://download.uib.de/opsi_stable/doc/html/opsi-winst-manual/opsi-winst-manual.html#GetOS +
#####################

* `getMsVersionInfo : string` // Windows Version Information [W] +
https://download.uib.de/opsi_stable/doc/html/opsi-winst-manual/opsi-winst-manual.html#GetMsVersionInfo +
#####################

* `getMSVersionMap : stringlist` [W] +
https://download.uib.de/opsi_stable/doc/html/opsi-winst-manual/opsi-winst-manual.html#GetMSVersionMap +
#####################
