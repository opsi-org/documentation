...
image::first-steps:opsi-configed-login.png["*opsi-configed*: Login-Fenster", pdfwidth=80%]

War die Anmeldung erfolgreich, dann sehen Sie das Hauptfenster:

.*opsi-configed*: Hauptfenster
image::first-steps:opsi-configed-clients.png["*opsi-configed*: Hauptfenster", width=800, pdfwidth=80%]
