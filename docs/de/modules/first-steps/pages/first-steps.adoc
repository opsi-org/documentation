...
1. Installieren Sie einen opsi-Server. Entweder mit xref:server/installation-docker.adoc[docker] oder der vorgefertigten xref:server/server-installation-vm.adoc[VM].
