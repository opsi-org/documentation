...
Das Objekt vom Typ _product_, welches das {opsi-product} _javavm_ beschreibt sieht z.B. so aus:
...
Löscht alle {product-properties} zum Produkt _productid_.
...
Liefert die möglichen {installation-status} (_installed_, _not_installed_,... ).
