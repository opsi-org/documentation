...
Damit kann definiert welcher Benutzername bei der Authentifizierung am LDAP/AD übergeben werden soll. Hierbei können die Platzhalter*\{username\}*und*\{base\}*verwendet werden. Im Normalfall ist jedoch die Angabe der _ldap_url_ ausreichend.
