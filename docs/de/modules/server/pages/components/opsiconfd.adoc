...
NOTE: Wenn Sie den opsi-Server als Docker-Container betreiben, steuern Umgebungsvariablen das Verhalten (siehe Abschnitt xref:modules:server/installation/docker.adoc#server-installation-docker-compose[]).
