...
image::opsiconfd/opsiconfd-admin-info.png["Auf dem Reiter _Info_ können Sie auch die `opsiconfd`-Konfiguration betrachten.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-maintenance.png["Der Reiter _Maintenance_ (de)aktiviert den Wartungsmodus und zeigt den aktuellen Status an.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-users.png["Auf dem Reiter _Users_ können Sie die Zwei-Faktor-Authentifizierung einrichten.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-blocked-clients.png["Auf diesem Reiter sehen Sie eine Liste gesperrter Clients und geben diese ggf. wieder frei.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-depots-1.png["Neue opsi-Depots tragen Sie auf diesem Reiter ein.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-depots-2.png["Gibt es gesperrte Produkte? Der Reiter _Depots_ zeigt diese an und bietet einen Button zum Entsperren.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-rpc-info.png["In dieser Tabelle sehen Sie die letzten RPC-Aufrufe.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-rpc-interface.png["Über diesen Reiter können Sie Methoden der JSON-RPC-API ausführen.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-redis-interface.png["Zeigen Sie auf diesem Reiter Informationen zu Redis an.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-addons.png["Installieren Sie Addons und zeigen Sie Informationen zu diesen an.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-log-viewer.png["Die Admin-Seite bietet schnellen Zugriff auf die `opsiconfd`-Logfiles.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-terminal.png["Öffnen Sie über diesen Reiter ein Terminal auf dem opsi-Server.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-messagebus.png["Kommunizieren Sie mit dem opsi-Message-Bus über diesen Reiter.", width=900, pdfwidth=80%]
...
image::opsiconfd/opsiconfd-admin-licensing.png["Informationen zu Lizenzen für die Erweiterungen finden Sie auf diesem Reiter.", width=600, pdfwidth=80%]
