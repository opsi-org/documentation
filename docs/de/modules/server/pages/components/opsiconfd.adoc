...
image::opsi-webinterface-depot.png["Neue opsi-Depots tragen Sie auf diesem Reiter ein.", pdfwidth=80%]
...
.Gibt es gesperrte Produkte? Der Reiter _Depots_ zeigt diese an und bietet einen Button zum Entsperren.
image::opsi-webinterface-depot-lock.png["Gibt es gesperrte Produkte? Der Reiter _Depots_ zeigt diese an und bietet einen Button zum Entsperren.", pdfwidth=80%]
