...
* `backup`: Erstellt ein xref:server:components/backup.adoc#server-components-opsiconfd-backup[Backup].
* `restore`: Stellt ein xref:server:components/backup.adoc#server-components-opsiconfd-backup[Backup] wieder her.
