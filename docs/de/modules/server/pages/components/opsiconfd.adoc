...
TIP: Alternativ können Sie den Health Check auch mit dem Kommandozeilentool `opsi-cli` aufrufen (siehe Abschnitt ##). Einen schnellen Zugriff auf ein Terminal auf dem opsi-Server bietet die <<server-components-opsiconfd-admin-page>>.
