...
Der Zugriff erfolgt über `\https://<opsi-server>:4447/admin`; Benutzer müssen Mitglied der opsi-Admin-Gruppe sein (siehe Kapitel xref:authorization.adoc[Berechtigungen]). 
