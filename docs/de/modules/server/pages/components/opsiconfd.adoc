...
image::opsi-webinterface-blocked-clients.png["Auf diesem Reiter sehen Sie eine Liste gesperrter Clients und geben diese ggf. wieder frei.", width=954, pdfwidth=80%]
