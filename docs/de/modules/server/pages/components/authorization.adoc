...
saml-idp-slo-url:: (optional) Die URL des Single Logout (SLO) des Identitätsanbieters (IdP).
...
* Deaktivieren Sie _Client signature required_ unter _Keys_ => _Signing keys config_.
