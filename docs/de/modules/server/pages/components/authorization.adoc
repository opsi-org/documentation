...
* Speichern Sie den Wert zwischen den Tags _<ds:X509Certificate>_ und _</ds:X509Certificate>_ aus den XML-Daten von weiter oben in einer Datei mit der Endung `.crt`.
