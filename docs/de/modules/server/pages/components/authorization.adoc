...
Wenn Sie dennoch verschlüsselte Assertions aktivieren möchten, aktivieren Sie `saml-encrypted-assertions` in der opsiconfd-Konfiguration und stellen Sie sicher, dass RSA1_5 (http://www.w3.org/2001/04/xmlenc#rsa-1_5) als Key-Transport-Algorithmus auf der Seite des Service Providers eingestellt ist, da RSA-OAEP-11 und RSA-OAEP-MGF1P derzeit nicht unterstützt werden.
