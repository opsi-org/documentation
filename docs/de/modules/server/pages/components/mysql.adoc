...
`connectionPoolSize`:: Anzahl der Verbindungen zur MySQL-Datenbank, die permanent offen gehalten werden.
`connectionPoolMaxOverflow`:: Anzahl der zusätzlichen Verbindungen, die bei Bedarf geöffnet werden. Diese zusätzlichen Verbindungen werden wieder geschlossen wenn sie nicht mehr benötigt werden.
