...
Es gibt zwei Arten von Repositories,*Internet-Repositories*und _opsi-Server_.
...
Ein Repository hat den Typ _opsi-server_, wenn in der Repository-Konfigurationsdatei unter dem Punkt*opsiDepotId*die ID eines anderen {opsi-server}s eingetragen wird.
