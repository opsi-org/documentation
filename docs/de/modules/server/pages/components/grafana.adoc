...
image::server:opsiconfd-grafana-hour.png["*opsiconfd*-Werte der letzten 3 Stunden", pdfwidth=80%]

.*opsiconfd*-Werte des letzten Tages
image::server:opsiconfd-grafana-day.png["*opsiconfd*-Werte des letzten Tages", pdfwidth=80%]
