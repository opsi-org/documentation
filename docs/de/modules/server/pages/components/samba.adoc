...
NOTE: Ist der opsi-Server Mitglied einer Windows-/Samba4-Domäne und der Benutzer `pcpatch` ein Domänen-Benutzer, dann steht hier `<Name der Domäne>\pcpatch` oder `<NetBIOS-Name des opsi-Servers>\pcpatch`.
