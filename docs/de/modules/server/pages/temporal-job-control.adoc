...
Das Produkt `opsi-auto-update` ist im Kapitel xref:opsi-products:localboot-products.adoc#opsi-manual-localboot-opsi-auto-update[Localboot-Produkte] beschrieben.
...
xref:configuration-tools.adoc#opsi-manual-configuration-tools-opsi-cli-commands-client-actions[opsi-cli].
...
Wie dieses `working_window` konfiguriert wird ist hier beschrieben: xref:clients:client-agent/opsi-client-agent#opsi-manual-clientagent-working-window[opsi-client-agent Working Window]
