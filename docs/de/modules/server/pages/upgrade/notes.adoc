...
Der UEFI Haken wird somit nicht zum Umschalten benötigt. Der Haken zeigt jetzt nach der ersten Installation an, ob das System über UEFI oder Lagacy gebootet wurde. Maßgeblich hierfür ist der Konfiguartionswert `clientconfig.uefibootlabel`. 
