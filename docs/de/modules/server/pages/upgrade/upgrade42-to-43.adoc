...
Diese beiden Änderungen sind optional:
...
* Setzen Sie `opsiclientd.global.verify_server_cert = true`, um die Server-Zertifikats-Prüfung der Clients zu aktivieren.
