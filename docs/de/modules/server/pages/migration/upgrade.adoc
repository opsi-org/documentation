...
*Ubuntu 22.04 LTS _Focal Fossa_:*
[source,prompt]
[subs="attributes"]
----
...
[subs="attributes"]
----
echo "deb http://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.3:/{release}/xUbuntu_18.04/ /" > /etc/apt/sources.list.d/opsi.list
wget -q -O - https://download.opensuse.org/repositories/home:/uibmz:/opsi:/4.3:/{release}/xUbuntu_18.04/Release.key | sudo apt-key add -
----
...
----
cd /etc/yum.repos.d
wget https://download.opensuse.org/repositories/home:uibmz:opsi:4.3:{release}/CentOS_8/home:uibmz:opsi:4.3:{release}.repo
yum makecache
----
...
----
cd /etc/zypp/repos.d
wget https://download.opensuse.org/repositories/home:uibmz:opsi:4.3:{release}/openSUSE_Leap_15.1/home:uibmz:opsi:4.3:{release}.repo
zypper refresh
----
...
----
cd /etc/zypp/repos.d
wget https://download.opensuse.org/repositories/home:uibmz:opsi:4.3:{release}/openSUSE_Leap_15.2/home:uibmz:opsi:4.3:{release}.repo
zypper refresh
----
...
RedHat und CentOS werden mit folgenden Befehlen auf opsi 4.3 aktualisiert:
