...
Wenn das `opsiconfd`-Addon WebGUI installiert ist (siehe Kapitel xref:gui:webgui.adoc[opsi-WebGUI]), dann wird der Server um eine REST-API erweitert. 
Diese ist speziell an die Bedürfnisse des WebGUI angepasst.
