...
Verwaltete die clientspezifischen Konfigurationen.
...
== Beispieli: Key in mehreren Objekten ändern
:sectitle: Änderung an Objekten

Hier soll erläutert werden, wie Änderungen an einem Objekt durchgeführt werden können.
