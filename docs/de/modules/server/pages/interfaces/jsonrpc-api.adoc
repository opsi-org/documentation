...
[source,console]
----
opsi-cli jsonrpc execute host_getObjects '[]' '{"type":"OpsiDepotserver"}' | sed  -e 's/"maxBandwidth"\s:\s0/"maxBandwidth" : 100/' > /tmp/maxBand.json
----
...
[source,console]
----
opsi-cli jsonrpc execute host_createObjects < /tmp/maxBand.json
----
...
[source,console]
----
opsi-cli jsonrpc execute group_createHostGroup "windows-clients" "Windows clients"
----
...
[source,console]
----
opsi-cli jsonrpc execute group_getObjects [] '{"id": "windows-clients", "type": "HostGroup"}'
----
...
[source,console]
----
opsi-cli jsonrpc execute group_createHostGroup "win10-clients" "Windows 10 clients" "" "windows-clients"
----
...
[source,console]
----
opsi-cli jsonrpc execute host_createOpsiClient "client1.company.internal"
----
...
[source,console]
----
opsi-cli jsonrpc execute objectToGroup_create "HostGroup" "win10-clients" "client1.company.internal"
----
...
[source,console]
----
opsi-cli jsonrpc execute objectToGroup_getObjects [] '{"groupType": "HostGroup", "groupId": "win10-clients"}'
----
...
[source,console]
----
opsi-cli jsonrpc execute objectToGroup_delete "HostGroup" "win10-clients" "client1.company.internal"
----
...
[source,console]
----
opsi-cli jsonrpc execute group_delete "win10-clients"
----
