...
image::server:create-depot-admin.png["Admin-Seite: ein neues Depot erzeugen", pdfwidth=80%]
...
image::server:depot-host-key.png["Admin-Seite: den Host-Key des Depots einblenden", pdfwidth=80%, width=800]
