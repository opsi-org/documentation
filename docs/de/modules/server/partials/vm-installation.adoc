...
image::server:1stboot-language-selection.png["Wählen Sie die Sprache für Ihren neuen opsi-Server aus.", pdfwidth=80%]
...
image::server:1st-startup-mask.png["Das Skript *1stboot.py* unterstützt Sie bei der Netzwerkkonfiguration.", pdfwidth=80%]
