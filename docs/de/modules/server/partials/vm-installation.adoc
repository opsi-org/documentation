...
Sie können die virtuelle Maschine unter link:https://www.virtualbox.org/[VirtualBox], link:https://www.vmware.com/products/desktop-hypervisor[VMware Desktop Hypervisor], link:https://www.vmware.com/products/cloud-infrastructure/vsphere[VMware vSphere] oder link:https://www.proxmox.com/de/[Proxmox] betreiben. Wir empfehlen die virtuelle Maschine vor allem zum Testen von OPSI. Für den produktiven Betrieb verwenden Sie bitte eine Installationsvariante aus dem Kapitel xref:server:installation/installation.adoc[Installation und Inbetriebnahme].  
