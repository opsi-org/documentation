...
image::opsiconfd/opsi-vm-import-de.png["VirtualBox: Import der virtuellen Maschine", pdfwidth=80%]
...
image::opsiconfd/opsi-vm-welcome-de.png["Die grafische Arbeitsumgebung auf dem opsi-Server", pdfwidth=80%]
