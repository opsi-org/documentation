...
image::opsi-cli-client-action-help.png["Ausgabe: opsi-cli client-action --help", width=800, pdfwidth=80%]
...
image::opsi-cli-set-action-request-help.png["Ausgabe: opsi-cli client-action set-action-request --help", width=800, pdfwidth=80%]
...
image::opsi-cli-plugin-help.png["Ausgabe: opsi-cli plugin --help", width=800, pdfwidth=80%]
...
image::opsi-cli-self-command-structure.png["Ausgabe: opsi-cli self command-structure", width=800, pdfwidth=80%]
...
image::opsi-cli-health-check.png["Ausgabe: opsi-cli support health-check", width=800, pdfwidth=80%]
