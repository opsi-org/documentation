...
TIP: Deaktivieren Sie die Farbformatierung mit der Option `--no-color` oder durch Setzen der Umgebungsvariable `NO_COLOR`. Verwendung: `NO_COLOR=1 opsi-cli log view [OPTIONS] HOST_ID`
