...
==== *log*
Der `log` Plugin bietet die Möglichkeit, Live-Logs vom opsi Server und von Clients über die `opsi-messagebus` Verbindung anzuzeigen.
...
[source,console]
----
opsi-cli package make --overwrite <source_dir> <destination_dir>
----
...
[source,console]
----
opsi-cli package list --depots <depot_id>
----
...
[source,console]
----
opsi-cli package install --depots <depot_id> --force <package1> <package2>
----
