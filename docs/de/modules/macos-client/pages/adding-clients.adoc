...
Sobald der Agent installiert ist, können vorhandene opsi-Produkte auf diesen Clients xref:rollout-products#firststeps-software-deployment-product-tests[installiert] werden.
