...
image::opsi-script-manual:testsyntax_ok_configed_de.png[Testsyntax Ergebnis im opsi-configed: 1. Zeile: failed, 2.Zeile: erfolgreich, pdfwidth=50%]
...
image::opsi-script-manual:opsi-script-interaktiv.png["Screenshot: opsi-script im interaktiven Modus", pdfwidth=90%]
