...
Erweitern Sie das Script aus Übung 2, indem Sie aus der Liste der Dateien mit Hilfe der Funktionen "getListContaining" die DLL-Files separieren. Mit Hifle von "count" können Sie die Anzahl auslesen.
