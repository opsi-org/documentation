...
image::opsi-script-manual:waitforprocess_scheme_std.png["waitforprocess_scheme_std", pdfwidth=40%]
...
image::opsi-script-manual:waitforprocess_scheme_fork1.png["waitforprocess_scheme_fork1", pdfwidth=50%]
...
image::opsi-script-manual:waitforprocess_scheme_fork2.png["waitforprocess_scheme_fork2", pdfwidth=50%]
