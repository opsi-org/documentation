...
NOTE: Wir empfehlen Ihnen, stattdessen ModifyTOML2 zu verwenden. +
...
* `ModifyTOML2(`<TOMLcontents: String> , <command: String> , <keyPath: String> , <value: String>`) : String`   //seit 4.12.5.0 +
Diese Funktion ermöglicht es, den als Eingabe angegebenen <TOMLcontents>-String zu ändern: +

- Wenn die Änderungen für die ROOT TABLE gelten, muss <tablePath> eine leere String "" sein.
- Wenn die Änderungen für eine andere Tabelle innerhalb der root table bestimmt sind, muss <tablePath> der Name der Table sein.
- Wenn die Änderungen für eine Untertabelle bestimmt sind, muss <tablePath> die durch Punkte getrennte Folge der Tabellennamen sein. Beispiel: ""myTable.mySubTable"".

4 Befehle sind verfügbar: +
...
anchor:AddTableToTOML[]

* `AddTableToTOML(`<TOMLcontents: String> , <tablePath: String>`) : String`   //since 4.12.8.0 +
Fügt dem angegebenen <TOMLcontents>-String eine neue leere Tabelle hinzu. +
Der <tablePath> kann ein einfacher Tabellenname sein, der der root table hinzugefügt wird, oder die Namen einer Sequenztabelle, die durch Punkte getrennt sind. Beispiel: "myTable.mySubTable".
...
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', '', 'title',  '"newADDvalueInRootTable"')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'ADD', 'newADDkeyInRootTable', '"newADDvalueInRootTable"')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', '', 'newADDkeyInRootTable', '"newADDvalueInRootTable"')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'ADD', 'servers.alpha.a.newADDkeyInAlphaA', '"newADDvalueInAlphaA"')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', 'servers.alpha.a', 'newADDkeyInAlphaA', '"newADDvalueInAlphaA"')

Set $TOMLString$ = ModifyTOML($TOMLString$, 'ADD', 'newTable.newADDtableKey', '"newADDtableValue"')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', 'newTable', 'newADDtableKey', '"newADDtableValue"')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'ADD', 'newTable.newStringKey', '"newStringValue"')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', 'newTable', 'newStringKey', '"newStringValue"')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'ADD', 'newTable.newIntegerKey', '1')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', 'newTable', 'newIntegerKey', '1')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'ADD', 'newTable.newFloatKey', '10.1')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', 'newTable', 'newFloatKey', '10.1')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'ADD', 'newTable.newDateKey', '2022-02-02T16:16:00Z-16:16')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', 'newTable', 'newDateKey', '2022-02-02T16:16:00Z-16:16')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'ADD', 'newTable.newArray', '[ "a", "b", "c" ]')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', 'newTable', 'newArray', '[ "a", "b", "c" ]')

Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', 'newEmptyTable', '', '')
Set $TOMLString$ = ModifyTOML2($TOMLString$, 'ADD', 'newEmptyTable.newEmptySubTable', '', '')

Set $TOMLString$ = ModifyTOML($TOMLString$, 'SET',' newADDkeyInRootTable', '"newSETValueInRootTable"')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'SET', '', ' newADDkeyInRootTable', '"newSETValueInRootTable"')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'SET', 'newSETkeyInRootTable', '"newSETValueInRootTable"')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'SET', '', 'newSETkeyInRootTable', '"newSETValueInRootTable"')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'SET', 'servers.alpha.a.newADDkeyInAlphaA', '"newSETValueInAlphaA"')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'SET', 'servers.alpha.a', 'newADDkeyInAlphaA', '"newSETValueInAlphaA"')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'SET', 'newTable.newADDtableKey', '"newSETtableValue"'
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'SET', 'newTable', 'newADDtableKey', '"newSETtableValue"'

Set $TOMLString$ = ModifyTOML($TOMLString$, 'CHANGE', 'newCHANGEkeyInRootTable', ' "newCHANGEValueInRootTable" ')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'CHANGE', '', 'newCHANGEkeyInRootTable', ' "newCHANGEValueInRootTable" ')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'CHANGE', 'newSETkeyInRootTable', '"newCHANGEValueInRootTable"')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'CHANGE', '', 'newSETkeyInRootTable', '"newCHANGEValueInRootTable"')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'CHANGE', 'servers.alpha.a.newADDkeyInAlphaA', '"newCHANGEValueInAlphaA"')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'CHANGE', 'servers.alpha.a', 'newADDkeyInAlphaA', '"newCHANGEValueInAlphaA"')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'CHANGE', 'newCHANGETable.newCHANGEtableKey', ' "newCHANGEtableValue" '
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'CHANGE', 'newCHANGETable', 'newCHANGEtableKey', ' "newCHANGEtableValue" '

Set $TOMLString$ = ModifyTOML($TOMLString$, 'DEL', 'newSETkeyInRootTable', '')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'DEL', '', 'newSETkeyInRootTable', '')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'DEL', 'DELkeyInRootTable', '')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'DEL', '', 'DELkeyInRootTable', '')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'DEL', 'servers.alpha.a.newADDkeyInAlphaA', '')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'DEL', 'servers.alpha.a', 'newADDkeyInAlphaA', '')
Set $TOMLString$ = ModifyTOML($TOMLString$, 'DEL', 'DELTable.DELtableKey', '')
;or Set $TOMLString$ = ModifyTOML2($TOMLString$, 'DEL', 'DELTable', 'DELtableKey', '')

Set $TOMLString$ = AddTableToTOML($TOMLString$, "newAddedTable")
Set $TOMLString$ = AddTableToTOML($TOMLString$, "newAddedTable.newAddedSubTable")
...
[newEmptyTable]
  [newEmptyTable.newEmptySubTable]
  
[newAddedTable]
  [newAddedTable.newAddedSubTable]
----
