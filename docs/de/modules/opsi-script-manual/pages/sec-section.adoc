...
CAUTION: Das Dateinamen encoding als dritter Parameter sollte nur gesetzt werden wenn notwendig. Die encodings 'cp437' und 'utf8' werden per default gehandhabt und sollten nicht als dritter Parameter gesetzt werden.
