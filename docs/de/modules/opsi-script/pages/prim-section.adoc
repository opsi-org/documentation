...
* `NormalizeWinst` +
setzt das _{opsi-script}_ Fenster auf _normal_ Modus.

anchor:IconizeWinst[]

* `IconizeWinst` +
setzt das _{opsi-script}_ Fenster auf _minimierten_ Modus.

anchor:MaximizeWinst[]

* `MaximizeWinst` +
setzt das _{opsi-script}_ Fenster auf _maximierten_ Modus. // since 4.11.5.1
...
(Beispiel im Kochbuch siehe xref:cook-book#psi-script-cookbook-xmlnamespace[Kapitel "Einfügen einer Namensraumdefinition in eine XML-Datei"]).
