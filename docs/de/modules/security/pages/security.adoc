...
Sicherheitsrelevante Updates und Informationen finden Sie im https://forum.opsi.org/viewforum.php?f=10[News-Bereich des opsi-Forums] sowie auf der https://opsi.org/de/produkt/releases[opsi-Website].
