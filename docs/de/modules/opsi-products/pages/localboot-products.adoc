...
CAUTION: opsi-auto-update ist nicht geeignet für Clients mit der WAN-Erweiterung. Verwenden Sie hier: xref:server:components/commandline.adoc#server-components-opsi-outdated-to-setup[opsi-outdated-to-setup]
