...
== Produktabhängigkeiten und Reihenfolgen von Produkt-Aktionen
...
Mit Produktabhängigkeiten ist es möglich einen Installations-Status eines anderen Produkts (`requiredInstallationStatus`) als Bedingung zu setzen.
