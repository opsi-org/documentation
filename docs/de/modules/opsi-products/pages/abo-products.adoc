...
Es bietet sich anschließend an, gezielt nur die benötigten Pakete aus den neuen Repositories zu installieren, etwa Windows 11 24h2/25h2 Server Server 2016 / 2019 / 2022 / 2025:
[source,shell]
----
# Beispiel: Pakete für mshotfix, Plattform Windows 10 x64 2009-22h2 / Server 2016 / 2019 / 2022 / Windows 11 22H2/23H2 installieren
opsi-package-updater --repo uib_abo_mshotfix install mshotfix mshotfix-win10-1607-x64-glb mshotfix-win10-1809-x64-glb mshotfix-win2022 mshotfix-win11-22h2 mshotfix-win11-24h2
...
Es ist möglich, gezielt benötigte Pakete zu installieren, bspw. nur die Pakete für das Update von Windows 11 23H2/24h2/25h2:
[source,shell]
----
opsi-package-updater -v install mshotfix mshotfix-win11-22h2 mshotfix-win11-24h2
----
...
Regelmäßige Updates des Produktes mshotfix (Hotfixes für Windows 10 / Windows 2016 / Windows 2019 / Windows 2022 / Windows 11).
...
Das opsi-mshotfix Paket verwendet Microsoft's Update-Katalogdatei wsusscn2.cab um die erforderlichen Patches zu ermitteln.
...
|==========================================
|OS
|Windows 10 LTSC / Windows 2016 / Windows 2019 / Windows 2022 / Windows 2025
|Windows 11
|==========================================
...
|Windows 10 2021LTS/22h2ESU | 32/64Bit | mshotfix-win10-2009-x86-glb mshotfix-win10-2009-x64-glb
|Windows Server 2022 | 64Bit | mshotfix-win2022
|Windows 11 22h2/23H2 | 64Bit | mshotfix-win11-22h2
|Windows 11 24h2/25H2/ Server 2025 | 64Bit | mshotfix-win11-24h2
|Windows 11 24h2/25H2 | arm64 | mshotfix-win11-24h2-arm64
|=======================
...
extrareboot:: for  local-image and wim-capture: make two extrareboots to ensure windows is really finished with configure windows / trusted installer. Verify checks on Windows 10 if updates with ExitCode 3010 really installed, needs  one more reboot and may show erroneously failed
...
----
dotnetfx                  26200.4.8.1-0                .NET Framework
----

Paket zur Installation der Dotnet Framework Versionen 4.7 und höher sowie der Nachinstallation von Dotnet 3.5 für Windows 10 bis 11 25H2, Windows Server 2016 bis 2025
...
values: ["3.5", "4.7", "4.7.1", "4.7.2","4.8","4.8.1","latest", "latestAnd3.5"] +
default: ["latest"]
...
Regelmäßige Updates der Produkte:
    ...
    Google Chrome for business (international, 32 Bit / 64 Bit)
...
----
adobe.reader.dc.classic		20202000530793-1		Adobe Acrobat Reader DC classic
----
...
----
adobe.reader.dc.continuous	252500120982-1							Adobe Acrobat Reader DC Continuous (MUI-Version)
adobe.reader.dc.x64        25.001.20982-1            Adobe acrobat reader (MUI-Version) x64
...
=== Google Chrome for Business
----
google-chrome-for-business	143.0.7499.41-1           Google Chrome for Business
----
...
----
libreoffice					25.2.7or25.8.3-1						LibreOffice
----
...
//
lockPref("browser.startup.homepage", "https://uib.de");
...
----
thunderbird					140.5.0esror145.0-1
----
...
===  Open JDK 11 LTS / 17 LTS / 21LTS : javavm
----
javavm						 11.0.29or17.0.17or21.0.9-1 JDK 11, 17 or 21
----
Das javavm Paket enthält die Open JDK 11 LTS / 17 LTS / 21LTS Implementationen von Amazon (Amazon Corretto)
...
values: ["17amazoncorretto","21amazoncorretto","jdkamazoncorretto"]
...
----
javavm-oracle-jdk			25.0.1-1								Open JDK
----
