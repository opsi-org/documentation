...
Am einfachsten kann man dies mit _opsi-cli_ machen:
...
In der Ausgabe des Aufrufs findet sich der Passworthash, welcher zugleich als serverweiter Host-Parameter für _opsi-linux-bootimage.append_ eingetragen wird. Dieser sieht beispielhaft wie folgt aus:
...
Mit dieser Einstellung wird bei jedem Client, der ein Netboot-Produkt auf setup gesetzt bekommt beim Start des _opsi-linux-bootimage_ das Passwort des Benutzers 'root' geändert.
Man kann mit dem anschliessendem Aufruf von 
[source,shell]
----
opsipxeconfd setup
----
den Passworthash in die allgemeine Grub Menü Konfiguration zu schreiben und somit auch den Start des _opsi-linux-bootimage_ über das Menü per Passwort zu schützen.
...
image::opsi-products:netboot-pxe.png[pdfwidth=70%, width=70%]
...
image::opsi-products:netboot-pxelinux.png[pdfwidth=70%, width=70%]
...
image::opsi-products:netboot-pxeos.png[pdfwidth=70%, width=70%]
...
image::opsi-products:netboot-win-nt6-properties.png["NT6 Productproperties", pdfwidth=40%]
...
.NT6 Imagenames
image::opsi-products:netboot-win-nt6-properties-imagenames.png["NT6 Imagenames", pdfwidth=40%]
...
image::opsi-products:netboot-win-nt6-properties-keyboards.png["Sprachauswahl für die Tastatur", pdfwidth=40%]
...
image::opsi-products:netboot-win-nt6-properties-winpartionsize.png["Größe der C: Partition", pdfwidth=40%]
