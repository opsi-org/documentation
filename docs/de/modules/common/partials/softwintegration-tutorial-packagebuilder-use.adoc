...
image::common:opb_firststart.png["opsi PackageBuilder: Erster Start im Offlinemodus", pdfwidth=80%]
...
image::common:opb_conf_general.png["oPB-Einstellungen: Reiter *Allgemein*", pdfwidth=80%]
...
image::common:opb_conf_program.png["oPB-Einstellungen: Reiter *Programm*", pdfwidth=80%]
...
image::common:opb_conf_commands.png["oPB-Einstellungen: Reiter *opsi Verwaltungsbefehle*", pdfwidth=80%]
...
image::common:opb_start.png["opsi PackageBuilder: Start im Onlinemodus", pdfwidth=80%]
...
image::common:opb_tab_product.png["Öffnen Sie ein vorhandenes opsi-Paket.", pdfwidth=80%]
...
.oPB: *Edit*-Button
image::common:opb_btnSkriptEdit.png["oPB: *Edit*-Button", pdfwidth=40%]
...
image::common:opb_tab_dependencies.png["oPB: Reiter *Abhängigkeiten*", pdfwidth=80%]
...
image::common:opb_tab_property.png["oPB: Reiter *Produktvariable*", pdfwidth=80%]
...
|image::common:opb_btnPacken.png[] | Startet eine eine SSH-Verbindung zum opsi-Server und ruft dort das Kommando zum Paketieren auf (siehe Abschnitt <<opsi-softwintegration-create-opsi-package-makeproductfile>>).
|image::common:opb_btnInstallieren.png[] | Startet eine eine SSH-Verbindung zum opsi-Server und ruft dort das Kommando zum Installieren auf (siehe Abschnitt <<opsi-softwintegration-create-opsi-package-manager>>).
|image::common:opb_InstSetup.jpg[] | Ähnlich wie _Installieren_, allerdings wird das Paket zusätzlich auf allen Clients, auf denen es als _installed_ gekennzeichnet ist, auf _setup_ gesetzt.
|====
