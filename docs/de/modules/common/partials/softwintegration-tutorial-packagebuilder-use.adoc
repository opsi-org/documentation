...
Auf dem Reiter _Abhängigkeiten_ sehen Sie die definierten Abhängigkeiten zu anderen opsi-Produkten (siehe Abschnitt <<opsi-setup-detector-product-configuration-priority_dependecy>>):
