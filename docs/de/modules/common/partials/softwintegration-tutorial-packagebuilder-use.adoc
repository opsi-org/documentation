...
Auf dem Reiter _Produktvariable_ stehen links jeweils die Produkt-Propertys (siehe Abschnitt <<opsi-setup-detector-product-configuration-properties>>), inklusive Typ, Wert usw:
