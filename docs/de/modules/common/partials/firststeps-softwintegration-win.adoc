...
Dieses Template können Sie mit dem `opsi-setup-detector` erstellen (siehe Kapitel xref:opsi-modules:setup-detector.adoc[*opsi-setup-detector* (frei)]).

include::4.3@opsi-docs-en:common:partial$firststeps-opsi-template-win.adoc[]
