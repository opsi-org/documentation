...
Die GUID kann sich beim selben Produkt von Version zu Version ändern. Um vorhandene und evtl. ältere Installtionen zu löschen, muss also ermittelt werden welche GUID diese Installationen haben. +
