...
image::common:osd_config_dlg_de.png["Nach dem ersten Start konfigurieren Sie den *opsi-setup-detector*.", pdfwidth=40%, width=500]
...
image::common:osd_help-circle22.png["Über dieses Icon zeigen Sie die Onlinehilfe an.", pdfwidth=10%]

[[osd_page_start]]
.Die *opsi-setup-detector*-Startseite
image::common:osd_page_start_de.png["Die *opsi-setup-detector*-Startseite", pdfwidth=80%, width=800]
