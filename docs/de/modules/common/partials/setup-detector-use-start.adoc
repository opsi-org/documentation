...
Unter Windows starten Sie den `opsi-setup-detector` aus dem Startmenü heraus; Sie finden das Werkzeug unter _opsi.org_ / _opsi-setup-detector_. Unter macOS finden Sie den `opsi-setup-detector` über _Programme_.
