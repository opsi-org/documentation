...
Der Vorteil dieser Konstruktion ist, dass Sie auch in Sektionen, die außerhalb des `opsi-script`-Skriptes ausgeführt werden (`DosBatch`, `ExecWith`), problemlos mit `opsi-script`-Variablen arbeiten können.
