...
* Sie testen das komplette Produkt, indem Sie es auf dem Server installieren und auf einem Client ausrollen (<<opsi-softwintegration-tutorial-create-and-test-script-integratedopsi-softwintegration-tutorial-create-and-test-script-integrated>>).
