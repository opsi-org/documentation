...
image::common:opsi-script-interaktiv.png["Öffnen Sie *opsi-script-gui* im interaktiven Modus.", pdfwidth=80%, width=800]
...
image::common:jedit-with-winst-script.png["Der Texteditor jEdit unterstützt Syntax-Highlighting für *opsi-script*-Skripte.", pdfwidth=80%]
...
image::common:newprod-localboot.png["Wählen Sie zuerst den Typ des OPSI-Produktes aus.", width=800, pdfwidth=80%]
...
image::common:newprod-product-info.png["Geben Sie Informationen zum Produkt ein.", width=800, pdfwidth=80%]
...
image::common:newprod-script-names.png["Geben Sie die Namen der Skripte ein.", width=800, pdfwidth=80%]
...
image::common:newprod-product-new-dependency.png["Wollen Sie eine Abhängigkeit definieren?", width=800, pdfwidth=80%]

Wenn Sie _Ja_ gewählt haben, dann erscheint dieser Dialog:

.Definieren Sie die Produktabhängigkeit genau.
image::common:newprod-product-dependency.png["Definieren Sie die Produktabhängigkeit genau.", width=800, pdfwidth=80%]
...
image::common:newprod-new-property.png["Wollen Sie Produkt-Propertys definieren?", width=800, pdfwidth=80%]
...
image::common:newprod-property-type.png["Wählen Sie den Datentyp der Produkteigenschaft.", width=800, pdfwidth=80%]
...
image::common:newprod-property-desc.png["In diesem Dialog beschreiben Sie die Produkteigenschaften.", width=800, pdfwidth=80%]
...
image::common:newprod-property-boolean.png["Tragen Sie den Namen und eine Beschreibung ein.", width=800, pdfwidth=80%]
...
image::common:newprod-maintainer.png["Als Letztes geben Sie die Daten des Betreuers ein.", width=800, pdfwidth=80%]
