...
Ist der Service nicht erreichbar oder zu alt, wird der _opsi-package-builder_ ohne interaktive GUI aufgerufen um aus dem erstellten Verzeichnisbaum das opsi-Paket zu erstellen und danach wieder beendet. Die genauen Abläufe werden dabei durch das Auswahlfeld _Bau Modus_ bestimmt:
