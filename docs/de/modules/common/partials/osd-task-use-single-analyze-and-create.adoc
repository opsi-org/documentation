...
image::common:osd_page_analyze_de.png["Der *opsi-setup-detector* hat eine Datei analysiert.", pdfwidth=80%, width=800]

War die Analyse nicht erfolgreich, sehen Sie stattdessen entweder diesen Dialog:

.Der Dialog *Sorry Unknown Installer*
image::common:osd_unknown_select_installer.png["Der Dialog *Sorry Unknown Installer*", pdfwidth=30%]
...
image::common:osd_detected_not_known_installer_de.png["Der Dialog *Detektierter Installer ist nicht bekannt*", pdfwidth=30%]
...
image::common:osd_installer_info_installshield_de.png["Additional Info: InstallShield", pdfwidth=90%]

image::common:osd_installer_info_QT_de.png["Additional Info: Qt-Installer", pdfwidth=90%]

image::common:osd_installer_info_anywhere_de.png["Additional Info: InstallAnywhere", pdfwidth=90%]
...
image::common:osd_page_setup1_de.png["Auf diesem Reiter sehen Sie das Ergebnis einer erfolgreichen Analyse.", pdfwidth=80%, width=800]
...
image::common:osd_page_product1_de.png["Konfigurieren Sie das opsi-Produkt.", pdfwidth=80%, width=800]
...
image::common:osd_page_product2_de.png["Konfigurieren Sie Prioritäten und Abhängigkeiten.", pdfwidth=80%, width=800]
...
image::common:osd_password_dlg.png["Dialog zur Passworteingabe", pdfwidth=40%]
...
image::common:osd_dependency_editor.png["In diesem Dialog konfigurieren Sie Abhängigkeiten.", pdfwidth=40%]
...
image::common:osd_property-editor.png["In diesem Dialog konfigurieren Sie Produkt-Propertys.", pdfwidth=40%]
...
image::common:osd_page_producticon_de.png["In diesem Dialog wählen Sie ein Symbol für Ihr Produkt aus.", pdfwidth=80%, width=800]
...
image::common:osd_page_create_de.png["Auf dem letzten Reiter erzeugen Sie das opsi-Produkt.", pdfwidth=80%, width=800]
...
image::common:osd_overwrite_dlg.png["Backup-Dialog", pdfwidth=40%]
