...
* *Schulungen*: +
Die uib GmbH bietet opsi-Schulungen in Mainz, bei Ihnen vor Ort und online an: https://uib.de/de/support-schulung/schulung/

* *Handbücher*: +
  - Wir stellen mehrere Handbücher für unterschiedliche opsi-Versionen auf Deutsch und auf Englisch bereit:  https://docs.opsi.org/

  - Für dieses Tutorial empfehlen wir besonders das xref:opsi-script-manual:opsi-script-manual.adoc[`opsi-script`-Kapitel].

  - Links zu unseren Handbüchern in verschiedenen Formaten, zu Release Notes und mehr finden Sie auch hier: https://uib.de/de/opsi-dokumentation/dokumentationen/
