...
image::common:opsi-hwinvent.png["Führen Sie eine Hardware-Inventarisierung mit dem Netboot-Produkt `hwinvent` durch.", width=800, pdfwidth=80%]
...
image::common:opsi-bootimage-parameter.png["Startparameter für das opsi-Bootimage konfigurieren Sie über Host-Parameter.", width=800, pdfwidth=80%]
