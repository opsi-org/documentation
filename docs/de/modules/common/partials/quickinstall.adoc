...
image::common:oqi.png["Wählen Sie die Sprache und die Art der Installation aus.", pdfwidth=80%]
...
image::common:oqiInfo.png["Fahren Sie mit der Maus über das kleine Symbol, um weitere Informationen einzublenden.", pdfwidth=80%]
...
image::common:quickinstall_l-opsi-server.png["Die opsi-server-Installation läuft.", pdfwidth=80%]
...
image::common:oqiFailed.png["Falls die Installation fehlschlägt, finden Sie in den Logdateien mögliche Fehlerursachen.", pdfwidth=80%]

TIP: Wenn Sie einen Support-Vertrag haben, können Sie sich auch direkt an den https://opsi.org/de/services/support/[uib-Support] mit Ihren Fragen wenden.
...
image::common:quickinstallNoGuiFailed.png["Das Setup-Programm gibt Hinweise auf Fehler und Logdateien.", pdfwidth=80%]
