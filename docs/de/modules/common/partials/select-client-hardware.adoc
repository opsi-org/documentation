...
Ein kabelgebundener Netzwerkanschluss ist für viele Funktionen im Client-Management von großer Bedeutung bzw. notwendig. Wenn möglich, ist eine Lösung mit Ethernet (RJ45-Stecker) am Gerät einem USB-Adapter vorzuziehen.
