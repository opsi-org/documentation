...
image::common:Ethernet_RJ45_connector_p1160054.jpg["RJ45-Stecker (Ethernet)", pdfwidth=20%, width=400]
...
.USB-RJ45-Adapter
image::common:usb_ext_rj45.png["USB-RJ45-Adapter", pdfwidth=20%, width=400]
...
image::common:bios_macpassthroug.png["MAC-Adressen-Pass-Through im BIOS aktivieren", pdfwidth=100%]
...
* https://www.configjon.com/dell-bios-settings-management-psmodule/
