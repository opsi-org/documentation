...
Die Network Driver Interface Specification (NDIS) ist ein gemeinsam von Microsoft und 3Com entwickelter Standard zur Integration von Netzwerkkarten. Folgende ilink:https://de.wikipedia.org/wiki/Network_Driver_Interface_Specification[NDIS-Versionen] wurden implementiert: 
