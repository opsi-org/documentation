...
image::common:oca_installer_download.png["Den Installer finden Sie auf dem OPSI-Configserver unter `\https://<fqdn_oder_ip_des_configservers>:4447/public/opsi-client-agent/`.", pdfwidth=60%, width=800]
...
image::common:oca_installer_start.png["Der Installer startet den `oca-installation-helper`.", pdfwidth=40%]
