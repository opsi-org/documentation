...
* _Erzeuge ein opsi Paket Template 'with user'__: Fragt nicht nach einer Setup-Datei, sondern erstellt ein opsi-Template-Produkt für eine Installation bei angemeldetem Benutzer und übernimmt dazu die Angaben aus der Produkt-Konfiguration.
