...
* _Analysiere Datei und erzeuge ein opsi Paket_: Ausgehend von einer Setup-Datei wird hier der gesamte Prozess durchlaufen bis zum Erzeugen eines opsi-Paketes (siehe Abschnitt <<opsi-setup-detector-use-single-analyze-and-create>>).
