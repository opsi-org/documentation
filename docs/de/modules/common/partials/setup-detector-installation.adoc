...
Anschließend rollen Sie die das Produkt auf den gewünschten Clients aus, beispielsweise über die Management-Oberfläche `opsi-configed`.
...
image::common:opsi-packagebuilder-install.png["Den opsi PackageBuilder (oPB) können Sie als Localboot-Produkt auf den Clients ausrollen.",width=800, pdfwidth=80%]
