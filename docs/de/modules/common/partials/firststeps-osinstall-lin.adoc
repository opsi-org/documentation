...
* `additional_packages`:  Welche zusätzlichen Pakete sollen installiert werden? Geben Sie die Pakete als durch Leerzeichen unterteilte Liste an. Angabe der Pakete Leerzeichen separiert. (Default: leer)
