...
. Klicken Sie neben dem Produkt _opsi-configed_ in die Spalte _Angefordert_ und wählen Sie aus dem Drop-down-Menü den Eintrag _setup_. Das zweite Symbol von links (die Diskette) wechselt seine Farbe auf Rot. Klicken Sie sie an, um die Einstellungen zum OPSI-Server zu übermitteln.
+
