...
xref:clients:windows-client/windows-client-agent.adoc#opsi-manual-client-agent-msi[test]
* als MSI-Paket (nur Windows, siehe Abschnitt xref:clients:windows-client/win-client-agent.adoc#opsi-manual-client-agent-msi[Client-Agent via MSI installieren])
