...
TIP: Mehr zur Konfiguration des `opsiclientd shutdown notifier` lesen Sie im nächsten Abschnitt, in dem es um den Ablauf von Events und die wichtigsten Parameter geht.
