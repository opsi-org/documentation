...
TIP: Die Logdateien zu `opsi-client-systray` finden Sie unter `c:\opsi.org\applog` (Windows), . Weitere Informationen zu wichtigen Verzeichnissen lesen Sie in Abschnitt <<opsi-manual-client-agent-directories>>.
