...
CAUTION: When using the WAN/VPN extension, the files of '{opsi-products}' on the '{opsi-depot}' should not be changed manually, otherwise the information contained in the '.files' file would be outdated, causing errors during the synchronization process.
