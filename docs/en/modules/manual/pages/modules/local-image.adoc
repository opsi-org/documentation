...
NOTE: This product is useful, not just in the context of `opsi-local-image`. For a detailed description, see the xref:products/localboot-products[opsi-products] chapter, section xref:products/localboot-products#opsi-manual-localboot-opsi-auto-update[opsi-auto-update].
