...
An example configuration is provided as `/usr/share/opsi-directoy-connector/opsi-directory-connector.example.conf`
This file can be used as a template for your own configuration.

[source,prompt]
----
cp `/usr/share/opsi-directoy-connector/opsi-directory-connector.example.conf /etc/opsi/opsi-directory-connector-custom.conf
----
