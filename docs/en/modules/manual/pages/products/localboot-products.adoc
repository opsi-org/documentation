...
See also chapter: xref:configed.adoc#opsi-manual-configed[opsi-Management GUI: opsi-configed]
...
ifeval::["{mode}" == "antora"]
xref:opsi-script-manual:cook-book.adoc#opsi-script-cookbook-local-admin[Script for installations in the context of a local user]
endif::[]
ifeval::["{mode}"!= "antora"]
link:https://docs.opsi.org/opsi-docs-en/4.2/opsi-script-manual/cook-book.html#opsi-script-cookbook-local-admin[Script for installations in the context of a local user]
endif::[]
...
ifeval::["{mode}" == "antora"]
xref:windows-client-manual:os-installation.adoc#firststeps-osinstall-driverintegration-byaudit[Drivers automatically assigned to the clients using the inventory fields.]
endif::[]
ifeval::["{mode}"!= "antora"]
link:https://docs.opsi.org/opsi-docs-en/4.2/windows-client-manual/os-installation.html#firststeps-osinstall-driverintegration-byaudit[Drivers automatically assigned to the clients using the inventory fields.]
endif::[]

and in the opsi-manual chapter: +
xref:configed.adoc#opsi-manual-configed-driverupload[Automatic driver upload]
