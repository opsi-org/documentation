...
https://explore.transifex.com/opsi-org/opsiorg/[transifex.com/opsi-org/opsiorg/].
...
After logging in you will be able to access the resource configed.properties.
