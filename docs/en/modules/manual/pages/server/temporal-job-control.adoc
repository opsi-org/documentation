...
Another powerful way of setting action requests is via xref:server/configuration-tools.adoc#opsi-cli opsi-manual-configuration-tools-opsi-cli-commands-client-actions[opsi-cli].
