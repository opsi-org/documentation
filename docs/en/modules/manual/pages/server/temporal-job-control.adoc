...
An alternative is `opsi-oudated-to-setup` which is part of the package `opsi-utils`.
...
The options --exclude-products and --include-products can be used to limit the considered products. --dry-run can be used to simulate a run without actually changing anything.
