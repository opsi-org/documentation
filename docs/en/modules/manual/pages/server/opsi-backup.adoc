...
This directory is located under `/tftpboot/` on most systems. On SLES this directory is `/var/lib/tftpboot/`.

Possibly modified files are e.g. `opsi/opsi-linux-bootimage/cfg/grub.cfg`.
