...
** In section `[installation]` set for `service_hidden_password=` the base64 encoded password of this user. For encoding of the pawword you may use the opsi-script function `base64EncodeStr(<string>)` or a online service like  http://www.base64encode.org/ +
