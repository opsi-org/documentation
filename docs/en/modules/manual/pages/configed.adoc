...
The 'client count' warning level defines the absolute difference between the client number and the licensed number, from which the warning should be issued. The warning level 'client percentage' defines the percentage of the client number to the licensed number, from which the warning should be issued. The 'days until end of license' warning level specifies the number of days remaining until the end of the license, from which warnings should be issued. 
