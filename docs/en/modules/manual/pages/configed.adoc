...
In order to automate this you find will two helpers at link:https://download.uib.de/opsi4.1/misc/helper/[]: the setup program `opsi-configed-setup.exe` works for Microsoft Windows and `opsi-configed-linux-setup.tar.gz` works for various Linux systems.
