...
WARNING: If there is some command declared as 'editable' then in fact 'any' program addressed
...
WARNING: If the client received the signal, it will going down with out any more questions.
...
== Server-Console
WARNING: Some of the following features require at least python-opsi version 4.0.7.38,
