...
To change the log level the command line option  --loglevel [LEVEL]  can be used. It is not recommended to set level 7 or higher only when the starting process needs to be inspected.
