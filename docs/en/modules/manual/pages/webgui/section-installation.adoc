...
There are several ways to install the {opsi-webgui} on your {opsi-server}. 
This chapter shows you two ways: The installation through the opsi repository and through admininterface.
