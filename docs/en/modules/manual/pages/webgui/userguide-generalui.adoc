...
[horizontal]
Menu:: at the top, contains image:webgui/opsi-webgui_breadcrumb.png[Breadcrumb] breadcrumb navigation that shows users their location within the application. 
