...
|mint2-2         | distribution | image:supported.png[width=15] |
|mint2-1         | distribution | image:supported.png[width=15] |
|centos8         | distribution | image:discontinue.png[width=15] |
|centos70        | distribution | image:discontinue.png[width=15] |
|redhat9         | distribution | image:supported.png[width=15] |
|redhat8         | distribution | image:supported.png[width=15] |
|redhat70        | distribution | image:discontinue.png[width=15] |
...
|sles15-4        | distribution | image:develop.png[width=15] |
|sles15-3        | distribution | image:develop.png[width=15] |
|sles15-2        | distribution | image:develop.png[width=15] |
|sles15-1        | distribution | image:develop.png[width=15] |
|sles12sp5       | distribution | image:supported.png[width=15] |
|sles12sp4       | distribution | image:supported.png[width=15] |
|sles12sp3       | distribution | image:supported.png[width=15] |
|sles12sp2       | distribution | image:discontinue.png[width=15] |
|sles12sp1       | distribution | image:discontinue.png[width=15] |
|sles12          | distribution | image:discontinue.png[width=15] |
|opensusel15-4   | distribution | image:supported.png[width=15] |
|opensusel15-3   | distribution | image:supported.png[width=15] |
|opensusel15-2   | distribution | image:discontinue.png[width=15] |
|opensusel15-1   | distribution | image:discontinue.png[width=15] |
|opensusel15     | distribution | image:discontinue.png[width=15] |
...
|ucs43           | distribution | image:discontinue.png[width=15] |
|==========================
