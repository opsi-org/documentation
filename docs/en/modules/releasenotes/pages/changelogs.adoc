...
l-opsi-server (4.2.0.3-2); testing; urgency=low
  ...
  * opsi 4.2: Aborting if group pcpatch or {opsi-file-admin-group} already exists
...
l-opsi-server (4.2.0.1-4); testing; urgency=low
  ...
  * running {opsiconfd} setup to enable {opsi-admin-group} page
...
{opsi-server} (4.2.0.7-1) stable; urgency=medium
  ...
  * Feature:  new default fileadmingroup is {opsi-file-admin-group}
...
python-opsi (4.2.0.44-1) stable; urgency=medium
  ...
  * Feature:  {opsi-file-admin-group} is now the new default file admin group for fresh installs
