...
* Set the config `opsi-script.backgroundinstall.backgroundinstall_enabled` to *`true`*.
...
If the Config `opsi-script.backgroundinstall.backgroundinstall_enabled` *is not set to `true`*,
...
* backgroundinstall_enabled (default initially false) +
This default value can be overwritten with the config
`opsi-script.backgroundinstall.backgroundinstall_enabled`.
...
This default value can be overwritten with the config
`opsi-script.backgroundinstall.dialogtimeout`.
