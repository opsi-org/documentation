...
A detailed description of this file you will find at the chapter for the opsi-client-agent for Windows:  xref:clients:windows-clients/windows-client-agent.adoc#opsi-manual-clientagent-configuration[opsi-client configuration]
