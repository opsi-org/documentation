...
A opsilic file with the require Activations can be stored in the custom directory of the product.
If a opsilic file is found there, then will this one used.
