...
image::opsi-modules:multidepot-without.png["Scheme: opsi-config server without attached depot server",pdfwidth=90%]

.Scheme: OPSI config server with attached depot server (multi location)
image::opsi-modules:multidepot-with.png["Scheme: opsi-config server with attached depot server",pdfwidth=90%]
