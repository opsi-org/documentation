...
[source,shell]
----
opsi-cli jsonrpc execute hostControl_fireEvent silent_install client.domain.local
----
...
[source,shell]
----
opsi-cli jsonrpc execute config_createBool opsiclientd.event_timer_silentinstall.active "event_timer_silentinstall active" false
----
...
[source,shell]
----
opsi-cli jsonrpc execute configState_create opsiclientd.event_timer_silentinstall.active silentclient.domain.de true
----
...
[source,shell]
----
opsi-cli jsonrpc execute config_createUnicode opsiclientd.event_silent_install.action_processor_productIds "event_silent_install productIds" "swaudit,hwaudit" "swaudit,hwaudit"
----
...
[source,shell]
----
opsi-cli jsonrpc execute configState_create opsiclientd.event_silent_install.action_processor_productIds client.domain.de "firefox"
----
