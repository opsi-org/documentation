...
It is recommended to create the following 'Hostparameter':
...
The 'Hostparameter' can be created using the 'opsi-configed' or 'opsi-cli'.

For creating the 'Hostparameter' by 'opsi-cli', the following commands have to be executed on the opsi config server:
...
This is done most easily with the 'WAN configuration'-checkmark in opsi-configed.
