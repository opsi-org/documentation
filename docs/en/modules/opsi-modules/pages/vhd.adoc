...
image::opsi-modules:opsi-vhd-inst1.png["Scheme: Partition and create a VHD (`opsi-vhd-win10-x64`)", width=332]

.Scheme: Install Windows (`opsi-vhd-win10-x64`)
image::opsi-modules:opsi-vhd-inst2.png["Scheme: Install Windows (`opsi-vhd-win10-x64`)", width=332]
...
image::opsi-modules:opsi-vhd-inst3.png["Scheme: Install application software (`opsi-vhd-win10-x64`)", width=332]
...
image::opsi-modules:opsi-vhd-inst4.png["Scheme: Activate Windows PE partition (`opsi-vhd-win10-x64`)", width=332]
