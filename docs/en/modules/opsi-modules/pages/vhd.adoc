...
. initial Windows 11 installation in a VHD container
...
Install a Windows 11 system in a VHD container using the `opsi-vhd-win11-x64` product.

.Scheme: Partition and create a VHD (`opsi-vhd-win11-x64`)
image::opsi-modules:opsi-vhd-inst1.png["Scheme: Partition and create a VHD (`opsi-vhd-win11-x64`)", width=332]

.Scheme: Install Windows (`opsi-vhd-win11-x64`)
image::opsi-modules:opsi-vhd-inst2.png["Scheme: Install Windows (`opsi-vhd-win11-x64`)", width=332]

After that, you can install the necessary applications on this Windows system.

.Scheme: Install application software (`opsi-vhd-win11-x64`)
image::opsi-modules:opsi-vhd-inst3.png["Scheme: Install application software (`opsi-vhd-win11-x64`)", width=332]
...
.Scheme: Activate Windows PE partition (`opsi-vhd-win11-x64`)
image::opsi-modules:opsi-vhd-inst4.png["Scheme: Activate Windows PE partition (`opsi-vhd-win11-x64`)", width=332]
...
image::opsi-modules:opsi-vhd-control-1stsnap.png["Scheme: Seal initial installation (`opsi-vhd-control`)", width=332]

From now on, all changes are stored in the child VHD.

.Scheme: Working with the sealed system
image::opsi-modules:opsi-vhd-control-work.png["Scheme: Working with the sealed system", width=332]
...
image::opsi-modules:opsi-vhd-control-activatepe.png["Scheme: Restore initial installation, part 1 (`opsi-vhd-control`) 1", width=332]
...
image::opsi-modules:opsi-vhd-control-resnap.png["Scheme: Restore initial installation, part 2 (`opsi-vhd-control`)", width=332]
...
NOTE: The following properties do not exist in the netboot product `opsi-vhd-win11-x64`:
