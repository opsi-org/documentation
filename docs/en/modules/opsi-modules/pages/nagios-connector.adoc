...
image::opsi-modules:opsi-config-server.png["opsi config server",width=200]
...
image::opsi-modules:central-config-server.png["opsi multi depot environment",width=200]
...
.Distributed checks
image::opsi-modules:verteilte_checks_en.png["opsi distributed checks",width=400]
...
On RedHat, Alma Linux, Rocky Linux and Oracle Linux Servers please use the follwing command:
...
[source, shell]
----
opsi-cli jsonrpc execute user_setCredentials monitoring monitoring123
----
