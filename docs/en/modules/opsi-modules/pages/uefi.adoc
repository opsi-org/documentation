...
|UEFI pure|image::opsi-modules:supported.png[width=15]|image::opsi-modules:supported.png[width=15]|image::opsi-modules:supported.png[width=15]
...
|Entry can be activated|image::opsi-modules:supported.png[width=15]|image::opsi-modules:unsupported.png[width=15]|image::opsi-modules:supported.png[width=15]
