...
[source,shell]
----
opsi-cli jsonrpc execute configState_create "clientconfig.dhcpd.filename" "<Host-ID>" "opsi/opsi-linux-bootimage/loader/shimx64.efi.signed"
----
...
|UEFI pur|image:common:supported.png[width=15]|image:common:supported.png[width=15]|image:common:supported.png[width=15]
|UEFI + CSM|image:common:supported.png[width=15]|image:common:unsupported.png[width=15]|image:common:supported.png[width=15]
|Legacy|image:common:supported.png[width=15]|image:common:unsupported.png[width=15]|image:common:supported.png[width=15]
|Both|image:common:supported.png[width=15]|image:common:unsupported.png[width=15]|image:common:unsupported.png[width=15]
|UEFI Netboot|image:common:supported.png[width=15]|image:common:supported.png[width=15]|image:common:supported.png[width=15]
|Aktivierbarer Eintrag|image:common:supported.png[width=15]|image:common:unsupported.png[width=15]|image:common:supported.png[width=15]
|Netboot ohne Interaktion|image:common:supported.png[width=15]|image:common:unsupported.png[width=15]|image:common:supported.png[width=15]
|==========================
