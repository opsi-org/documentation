...
There you have to change to the tab `Product groups` in the left pane.

TIP: You can see how many clients are currently selected in the bottom-left status bar: after "Number of Clients", the value shown under "Selected in Table" indicates the number of selected clients.
...
Products can be added to a group via drag-and-drop. This is possible both from the product tree in the left pane and from the “Localboot Products” and "Netboot Products" tabs in the right pane.
