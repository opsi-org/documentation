...
image::opsi-modules:clonezilla_skip.png[pdfwidth=90%]

The mounted partition will be displayed:

.Mounted partitions.
image::opsi-modules:clonezilla_existing_setting.png[pdfwidth=90%]
...
.Expert or Beginner ?
image::opsi-modules:clonezilla_expert.png[pdfwidth=70%]
...
.Choose operation.
image::opsi-modules:clonezilla_select_mode.png[pdfwidth=90%]
...
image::opsi-modules:clonezilla_tool-priority.png[pdfwidth=90%]

.miscellaneous: unset -c here to suppress interactive questions for automation.
image::opsi-modules:clonezilla_parameters1.png[pdfwidth=90%]
...
image::opsi-modules:clonezilla_compression.png[pdfwidth=90%]


.Check filesystem (den default 'skip' nutzen)
image::opsi-modules:clonezilla_parameter4.png[pdfwidth=90%]

.Check the saved image (den default 'yes' nutzen)
image::opsi-modules:clonezilla_parameter5.png[pdfwidth=90%]

.Action after cloning (use the default '-p true', the reboot is triggered by the OPSI boot image).
image::opsi-modules:clonezilla_parameters6.png[pdfwidth=70%]
...
image::opsi-modules:clonezilla_imagename.png[pdfwidth=70%]


.Select the disc to create the image from
image::opsi-modules:clonezilla_choose_disk.png[pdfwidth=90%]

.The resulting command. This can be set as product property 'runcommand'
image::opsi-modules:clonezilla_savedisk_command.png[pdfwidth=90%]


.Progress bar
image::opsi-modules:clonezilla_savedisk_progress.png[pdfwidth=90%]
...
image::opsi-modules:clonezilla_choosepart.png[pdfwidth=90%]

.The resulting command. This can be set as product property 'runcommand'
image::opsi-modules:clonezilla_saveparts_command.png[pdfwidth=90%]

.Progress bar
image::opsi-modules:clonezilla_savepart_progress.png[pdfwidth=90%]
...
image::opsi-modules:clonezilla_choose_diskimage2restore.png[pdfwidth=70%]

.Select the disc where the image is to be restored
image::opsi-modules:clonezilla_choose_restore_targetdisk.png[pdfwidth=90%]

.The resulting command. This can be set as product property 'runcommand'
image::opsi-modules:clonezilla_restoredisk_command.png[pdfwidth=90%]

.Query before starting to overwrite the disc. Can be suppressed by omitting the option -c from the command.
image::opsi-modules:clonezilla_restoredisk_askbeforeinst.png[pdfwidth=90%]

.Progress bar
image::opsi-modules:clonezilla_restoredisk_progress.png[pdfwidth=70%]
...
image::opsi-modules:clonezilla_choose_partimage2restore.png[pdfwidth=70%]

.Select the partition where the image is to be restored.
image::opsi-modules:clonezilla_choose_restore_targetpart.png[pdfwidth=90%]

.The resulting command. This can be set as product property 'runcommand'image::opsi-modules:clonezilla_restorepart_command.png[pdfwidth=90%]

.Query before starting to overwrite the disc. Can be suppressed by omitting the option -c from the command.
image::opsi-modules:clonezilla_restorepart_askbeforeinst.png[pdfwidth=90%]

.Progress bar
image::opsi-modules:clonezilla_restorepart_progress.png[pdfwidth=70%]
