...
image::common:opsi-script-interactive.png["Open *opsi-script-gui* in interactive Mode.", pdfwidth=80%, width=800]
...
image::common:jedit-with-winst-script.png["The text editor jEdit supports syntax highlighting for *opsi-script* scripts.", pdfwidth=80%]
...
image::common:newprod-localboot.png["First, select the Type of opsi Product you wish to create.", width=800, pdfwidth=80%]
...
image::common:newprod-product-info.png["Enter the Information about the Product.", width=800, pdfwidth=80%]
...
image::common:newprod-script-names.png["Enter the Name of the Scripts.", width=800, pdfwidth=80%]
...
image::common:newprod-product-new-dependency.png["Would you like to define a Dependency?", width=800, pdfwidth=80%]

If you've chosen _Yes_, the following dialog appears:

.Define the Product Dependency accurately.
image::common:newprod-product-dependency.png["Define the Product Dependency accurately.", width=800, pdfwidth=80%]
...
image::common:newprod-new-property.png["Do you want to create Properties?", width=800, pdfwidth=80%]
...
image::common:newprod-property-type.png["Select the Property Type.", width=800, pdfwidth=80%]
...
image::common:newprod-property-boolean.png["Enter the Name and the Description.", width=800, pdfwidth=80%]
...
image::common:newprod-maintainer.png["Finally, enter the Contact Details of the Maintainer.", width=800, pdfwidth=80%]
