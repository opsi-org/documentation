...
ifeval::["{mode}" == "antora"]
xref:server:components/commandline.adoc#server-components-opsi-makepackage[opsi-makepackage]
endif::[]
ifeval::["{mode}"!= "antora"]
link:https://docs.opsi.org/opsi-docs-en/stable/server/commandline.html#server-components-opsi-makepackage[https://docs.opsi.org/opsi-docs-en/stable/server/commandline.html#server-components-opsi-makepackage]
endif::[]
...
ifeval::["{mode}"!= "antora"]
link:https://docs.opsi.org/opsi-docs-en/stable/manual/server/configuration-tools.html#opsi-manual-configuration-tools-opsi-package-manager[https://docs.opsi.org/opsi-docs-en/stable/manual/server/configuration-tools.html#opsi-manual-configuration-tools-opsi-package-manager]
endif::[]
