...
ifeval::["{mode}"!= "antora"]
link:https://docs.opsi.org/opsi-docs-en/stable/server/components/commandline.html#server-components-opsi-package-manager[https://docs.opsi.org/opsi-docs-en/stable/server/components/commandline.html#server-components-opsi-package-manager]
endif::[]
