...
* Testing the created script as 'standalone' i.e. without installing it on the opsi-Server and deploying it from there to the client (<<opsi-softwintegration-tutorial-create-and-test-script-standalone>>).

* 'Integrated' testing of the complete product with installation on the server and deployment on a client (<<opsi-softwintegration-tutorial-create-and-test-script-integrated>>).
...
see also: xref:opsi-script-manual:cli-params.adoc#opsi-script-testsyntax[Check syntax]

* Now open the logfile with the _opsi-logviewer_ to see how the opsi-script interprets the script. +
