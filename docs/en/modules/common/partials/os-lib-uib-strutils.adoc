...
Description::
Checks if two string lists are completely identical or not.
...
* Returns:     Returns string "true" if the given lists are identical.
Returns string "false" if the given lists are not identical
