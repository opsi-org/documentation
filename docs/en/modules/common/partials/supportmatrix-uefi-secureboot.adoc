...
|`ubuntu18-04`      | image:discontinued.png[width=15] | since ubuntu18-04_4.1.0.2-1
...
|`debian10`         | image:discontinued.png[width=15] | since debian10_4.1.0.3-1
...
|`opsi-local-image-win11-x64`     | image:supported.png[width=15]
