...
|`win2025`     | image:supported.png[width=15]   |
...
|`mint22`         | image:supported.png[width=15]   |
|`mint21-3`         | image:supported.png[width=15]   |
...
|`mint20-2`       | image:discontinued.png[width=15]   |
|`mint20-1`       | image:discontinued.png[width=15]   |
|`debian`         | image:supported.png[width=15] |
|`debian12`       | image:supported.png[width=15] |
|`debian11`       | image:discontinued.png[width=15] |
|`debian10`       | image:discontinued.png[width=15] |
...
|`opensusel15-6`  | image:supported.png[width=15] |
...
|`opsi-vhd-win11-x64`             | image:supported.png[width=15]   |
|==========================
