...
|Ubuntu Bionic 18.04 LTS       | image:discontinued.png[width=15]    | ubuntu, ubuntu18-04 | image:discontinued.png[width=15]
...
|Alma Linux 9                  | image:supported.png[width=15]    | alma9 | image:supported.png[width=15]
...
|openSuse Leap 15.4            | image:supported.png[width=15]    | opensusel15-4 | image:supported.png[width=15]
