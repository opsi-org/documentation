...
|Debian 11 _Bullseye_          | image:discontinued.png[width=15]    | `debian`, `debian11` | image:discontinued.png[width=15]
|Debian 10 _Buster_            | image:discontinued.png[width=15]    | `debian`, `debian10` | image:discontinued.png[width=15]
...
|Linux Mint 22                 | image:supported.png[width=15]    | `mint22`   | image:supported.png[width=15]
...
|Linux Mint 20.2               | image:discontinued.png[width=15]    | `mint20-2` | image:discontinued.png[width=15]
|Linux mint 20.1               | image:discontinued.png[width=15]    | `mint20-1` | image:discontinued.png[width=15]
...
|SLES 12 SP4                   | image:discontinued.png[width=15]    | `sles12sp4` | image:discontinued.png[width=15]
|SLES 12 SP3                   | image:discontinued.png[width=15]    | `sles12sp3` | image:discontinued.png[width=15]
...
|openSUSE Leap 15.6            | image:supported.png[width=15]    | `opensusel15-5` | image:supported.png[width=15]
...
|`debian11`        | Distribution | image:discontinued.png[width=15] |
|`debian10`        | Distribution | image:discontinued.png[width=15] |
...
|`mint22`          | Distribution | image:supported.png[width=15] |
...
|`mint20-2`        | Distribution | image:discontinued.png[width=15] |
|`mint20-1`        | Distribution | image:discontinued.png[width=15] |
...
|`opensusel15-6`   | Distribution | image:supported.png[width=15] |
