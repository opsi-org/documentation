...
|Ubuntu Bionic 22.04 LTS       | image:supported.png[width=15]    | ubuntu, ubuntu22-04 | image:supported.png[width=15]
|Ubuntu Bionic 20.04 LTS       | image:supported.png[width=15]    | ubuntu, ubuntu20-04 | image:supported.png[width=15]
|Ubuntu Bionic 18.04 LTS       | image:supported.png[width=15]    | ubuntu, ubuntu18-04 | image:supported.png[width=15]
|Ubuntu Xenial 16.04 LTS       | image:discontinued.png[width=15]    | ubuntu, ubuntu16-04 | image:discontinued.png[width=15]
|Ubuntu Trusty 14.04  LTS      | image:discontinued.png[width=15]    | ubuntu, ubuntu14-04 | image:discontinued.png[width=15]
...
|Alma Linux 9                  | image:supported.png[width=15]    | alma8 | image:supported.png[width=15]
|Alma Linux 8                  | image:supported.png[width=15]    | alma8 | image:supported.png[width=15]
...
|UCS 4.4                       | image:supported.png[width=15]      | ucs44 | image:supported.png[width=15]
|UCS 4.3                       | image:discontinued.png[width=15]    | ucs43 | image:supported.png[width=15]
|==========================
