...
image::common:oca_installer_download.png["The Installer is located on the OPSI config server at `\https://<fqdn_oder_ip_des_configservers>:4447/public/opsi-client-agent/`.", pdfwidth=60%, width=800]
...
image::common:oca_installer_start.png["The Installer launches the `oca-installation-helper`.", pdfwidth=40%]
