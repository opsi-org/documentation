...
image::common:opsi-configed-hwaudit-setup.png["Select *setup* for the two Products and confirm your Changes.", width=800, pdfwidth=80%]
. The second icon from the left (the floppy disc) will turn pink. Click on this icon to apply the settings to the opsi server.
. (Re)boot the client.
...
image::common:opsi-install-swaudit.png["After you've (re)booted the Client, *swaudit* is installed. (here: Windows)", pdfwidth=80%]
