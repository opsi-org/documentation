...
. Next to the _opsi-configed_ product in the _Requested action_ column, click and choose the _setup_ option from the drop-down menu. The second icon from the left (the floppy disc) will turn red. Click on this icon to apply the settings to the OPSI server.
+
