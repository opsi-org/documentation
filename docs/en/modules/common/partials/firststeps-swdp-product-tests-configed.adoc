...
. Next to the _opsi-configed_ product in the _Requested action_ column, click and choose the _setup_ option from the drop-down menu. The second icon from the left (the floppy disc) will turn pink. Click on this icon to apply the settings to the opsi server.
+
.Select *setup* for the Product and confirm the Changes.
image::common:opsi-configed-setup.png["Select *setup* for the Product and confirm the Changes.", width=800, pdfwidth=80%]
...
image::common:install-opsi-configed.png["After you've (re)booted the Client, *opsi-configed* is installed. (here: Windows)", pdfwidth=80%]
