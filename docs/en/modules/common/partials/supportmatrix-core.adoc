...
|Debian 11 _Bullseye_  | image:discontinued.png[width=18] | image:discontinued.png[width=18]
|Debian 10 _Buster_  | image:discontinued.png[width=18] | image:discontinued.png[width=18]
...
|Ubuntu 18.04 LTS _Bionic Beaver_    | image:discontinued.png[width=18] | image:discontinued.png[width=18]
...
|openSUSE Leap 15.6 | image:supported.png[width=18] | image:unsupported.png[width=18]
|openSUSE Leap 15.5 | image:supported.png[width=18] | image:unsupported.png[width=18]
|openSUSE Leap 15.4 | image:discontinued.png[width=18] | image:discontinued.png[width=18]
