...
image::common:opsi-hwinvent.png["Perform a hardware inventory with the netboot product `hwinvent`.", width=800, pdfwidth=80%]
...
image::common:opsi-bootimage-parameter.png["Configure start parameters for the opsi boot image via host parameters.", width=800, pdfwidth=80%]
