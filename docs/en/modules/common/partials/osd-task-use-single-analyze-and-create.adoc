...
image::common:osd_page_analyze_en.png["The *opsi-setup-detector* has successfully analyzed a File.", pdfwidth=80%, width=800]

If the analysis was not successful, you will see this dialog instead:

.The *Sorry Unknown Installer* Dialog
image::common:osd_unknown_select_installer_en.png["The *Sorry Unknown Installer* Dialog", pdfwidth=30%]
...
image::common:osd_detected_not_known_installer_en.png["The *Detected Installer not known* Dialog", pdfwidth=30%]
...
image::common:osd_installer_info_installshield_en.png["Additional Info: InstallShield", pdfwidth=90%]

image::common:osd_installer_info_QT_en.png["Additional Info: Qt Installer", pdfwidth=90%]

image::common:osd_installer_info_anywhere_en.png["Additional Info: InstallAnywhere", pdfwidth=90%]
...
image::common:osd_page_setup1_en.png["This Tab shows the Result of a successful Analysis.", pdfwidth=80%, width=800]
...
image::common:osd_page_product1_en.png["Configure the opsi Product.", pdfwidth=80%, width=800]
...
image::common:osd_page_product2_en.png["Configure Priority and Dependencies.", pdfwidth=80%, width=800]
...
image::common:osd_password_dlg_en.png["Password Dialog", pdfwidth=40%]
...
image::common:osd_dependency_editor.png["You can configure Dependencies in this Dialog.", pdfwidth=40%]
...
image::common:osd_property-editor.png["You can configure Product Properties in this dialog.", pdfwidth=40%]
...
image::common:osd_page_producticon_en.png["Select an Icon for your Product.", pdfwidth=80%, width=800]
...
image::common:osd_page_create_en.png["Create the Product on the last Tab.", pdfwidth=80%, width=800]
...
image::common:osd_overwrite_dlg_en.png["Backup Dialog", pdfwidth=40%]
