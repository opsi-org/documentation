...
* References:     <<Doc_func_install_macos_pkg>>, <<Doc_func_install_macos_dmg>>, <<Doc_func_install_macos_zip>>, <<Doc_func_install_macos_generic>> 
...
* Returns:     Returns string "true" if all is ok
* OnError:     Returns string "false"; error counter increased ; Error messages in the log
* References:     <<Doc_func_install_macos_app>>, <<Doc_func_install_macos_dmg>>, <<Doc_func_install_macos_zip>>, <<Doc_func_install_macos_generic>> 
* Author:     Detlef Oertel
* Date:     28.12.2020
* Email:     d.oertel@uib.de
* Version:     1.0
...
* Returns:     Returns string "true" if all is ok
* OnError:     Returns string "false"; error counter increased ; Error messages in the log
* References:     <<Doc_func_install_macos_app>>, <<Doc_func_install_macos_pkg>>, <<Doc_func_install_macos_zip>>, <<Doc_func_install_macos_generic>> 
* Author:     Detlef Oertel
* Date:     28.12.2020
* Email:     d.oertel@uib.de
* Version:     1.0
...
* Returns:     Returns string "true" if all is ok
* OnError:     Returns string "false"; error counter increased ; Error messages in the log
* References:     <<Doc_func_install_macos_app>>, <<Doc_func_install_macos_dmg>>, <<Doc_func_install_macos_pkg>>, <<Doc_func_install_macos_generic>> 
* Author:     Detlef Oertel
* Date:     28.12.2020
* Email:     d.oertel@uib.de
* Version:     1.0
...
* Returns:     Returns string "true" if all is ok
* OnError:     Returns string "false"; error counter increased ; Error messages in the log
* References:     <<Doc_func_install_macos_app>>, <<Doc_func_install_macos_dmg>>, <<Doc_func_install_macos_zip>>, <<Doc_func_install_macos_pkg>> 
* Author:     Detlef Oertel
* Date:     28.12.2020
* Email:     d.oertel@uib.de
* Version:     1.0
