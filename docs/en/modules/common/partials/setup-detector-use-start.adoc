...
image::common:osd_config_dlg_en.png["After the first start, configure the *opsi-setup-detector*.", pdfwidth=40%, width=500]
...
image::common:osd_help-circle22.png["Click this Icon to access the Manual.", pdfwidth=10%]
...
image::common:osd_page_start_en.png["*opsi-setup-detector* Start Page", pdfwidth=80%, width=800]
