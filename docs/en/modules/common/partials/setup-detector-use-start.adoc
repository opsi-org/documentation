...
image::common:opsi-setup-detector-context.png["You can start the *opsi-setup-detector* via the Explorer's Context Menu.", width=600, pdfwidth=60%]
...
image::opsi-modules:osd_config_dlg_en.png["After the first start, configure the *opsi-setup-detector*.", pdfwidth=40%, width=500]
...
TIP: For a comprehensive explanation of all the available settings, refer to the chapter xref:opsi-modules:setup-detector.adoc#opsi-setup-detector-configuration[*opsi-setup-detector configuration*].
...
image::opsi-modules:osd_help-circle22.png["Click this Icon to access the Manual.", pdfwidth=10%]
...
image::opsi-modules:osd_page_start_en.png["*opsi-setup-detector* Start Page", pdfwidth=80%, width=800]
