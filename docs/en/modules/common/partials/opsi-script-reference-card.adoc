...
=== ShellScript (deprecated: DosBatch, DosInAnIcon ShellBatch, ShellInAnIcon) [W/L/M]

ifdef::manual[see also : xref:sec-section.adoc#opsi-script-dosbatch[ShellScript section]]
...
see also: ShellScript sections <<opsi-script-rc-dosbatch>>
