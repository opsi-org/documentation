...
`ModifyTOML2(`<TOMLcontents: String> , <command: String> , <tablePath: String> , <key: String>, <value: String>`) : String`   //since 4.12.8.0 [W/L/M]
ifdef::manual[see also : xref:prim-section.adoc#ModifyTOML2[ModifyTOML2]]

`AddTableToTOML(`<TOMLcontents: String> , <tablePath: String>`) : String`   //since 4.12.8.0 [W/L/M] 
ifdef::manual[see also : xref:prim-section.adoc#AddTableToTOML[AddTableToTOML]]

`DeleteTableFromTOML(`<TOMLcontents: String> , <tablePath: String>`) : String`   //since 4.12.5.0 [W/L/M] 
