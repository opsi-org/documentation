...
[[opsi-script-rc-shellscript]]
=== ShellScript (deprecated: DosBatch, DosInAnIcon, ShellBatch, ShellInAnIcon) //since 4.12.10.0 [W/L/M] 

ifdef::manual[see also : xref:sec-section.adoc#opsi-script-shellscript[ShellScript section]]
...
see also: ShellScript sections <<opsi-script-rc-shellscript>>
