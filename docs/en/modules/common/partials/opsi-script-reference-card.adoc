...
ifdef::manual[see also : xref:prim-section.adoc#ExitScript[ExitScript]]
...
----
markErrorNumber
LogError "log error and thereby increase the error counter"
if errorsOccurredSinceMark > 0
	isFatalError "There was an error ..."
endif
----
