...
=== ShellScript (deprecated: ShellScript, DosInAnIcon, ShellBatch, ShellInAnIcon) //since 4.12.10.0 [W/L/M]
...
ifdef::manual[see also : xref:prim-section.adoc#isCertInstalledInSystem[]]

`importCertToSystem(`<filename>`) : noresult` [W/L/M] //since 4.12.4.37 
ifdef::manual[see also : xref:prim-section.adoc#mportCertToSystem[]]

`removeCertFromSystem(`<label>`) : noresult` [W/L/M] //since 4.12.4.37 
ifdef::manual[see also : xref:prim-section.adoc#emoveCertFromSystem[]]
