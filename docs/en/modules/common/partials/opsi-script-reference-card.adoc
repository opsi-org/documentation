...
ifdef::manual[see also : xref:prim-section.adoc#forceLogInAppenMode[forceLogInAppenMode]]
...
Function: edit XML files +
Depricated: please use xml2 sections: xref:reference-card.adoc#opsi-script-rc-XML2-sections[] +
