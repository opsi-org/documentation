...
On the _Dependencies_ tab, the dependencies established with other opsi products are displayed, as detailed in the section <<opsi-setup-detector-product-configuration-priority_dependecy>>.
