...
image::common:opb_firststart.png["OPSI PackageBuilder: First Start in Offline Mode", pdfwidth=80%]
...
image::common:opb_conf_general.png["oPB Settings: *General* Tab", pdfwidth=80%]
...
image::common:opb_conf_program.png["oPB Settings: *Program* Tab", pdfwidth=80%]
...
image::common:opb_conf_commands.png["oPB Settings: *OPSI Commands* Tab", pdfwidth=80%]
...
image::common:opb_start.png["OPSI PackageBuilder: Start in Online Mode", pdfwidth=80%]
...
image::common:opb_tab_product.png["Open an existing OPSI Package.", pdfwidth=80%]
...
image::common:opb_tab_dependencies.png["oPB: *Dependencies* Tab", pdfwidth=80%]

The _Properties_ tab shows the product properties, including type, value, etc:

.oPB: *Properties* Tab
image::common:opb_tab_property.png["oPB: *Properties* Tab", pdfwidth=80%]
...
|image::common:opb_btnPacken.png[] | Starts an SSH connection to the OPSI server and executes the command for packaging (see section <<opsi-softwintegration-create-opsi-package-makeproductfile>>).
|image::common:opb_btnInstallieren.png[] | Starts an SSH connection to the OPSI server and executes the install command (see section <<opsi-softwintegration-create-opsi-package-manager>>).
|image::common:opb_InstSetup.jpg[] | Similar to _Install_, but the package is also set to _setup_ on all clients on which it is marked as _installed_.
|====
