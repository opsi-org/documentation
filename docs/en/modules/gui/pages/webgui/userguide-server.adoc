...
Expand the Quick Panel to select one or more servers. On the first tab in the quick selection (icon image::gui:webgui/opsi-webgui_quickpanel_tab_selection.png[Selection]), you will see a list of all currently marked elements. Click on the small cross to remove a server from the list.
...
Switch to the second tab in the quick selection (icon image::gui:webgui/opsi-webgui_quickpanel_tab_depots.png[Servers]). The number next to the icon indicates the number of currently selected servers.
