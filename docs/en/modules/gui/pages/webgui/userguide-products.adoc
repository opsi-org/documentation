...
It is currently not possible to add a product to a group in {opsi-webgui}. 
However, if groups are already defined in your environment, for example via {opsi-configed}, you can select the groups.
This will select all products within the group.
