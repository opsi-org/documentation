...
If the navigation bar on the left and top edge is visible, but the display remains otherwise blank, your session may have expired.
Reload the page, e.g., with the key combination [Ctrl]{plus}[F5]; this will also clear the page cache.
Alternatively, open a new tab in your browser and open the WebGUI there.
