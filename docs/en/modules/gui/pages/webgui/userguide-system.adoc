...
== Terminal
The terminal provides access to a server.
...
image::gui:webgui/opsi-webgui_opsisystem_terminal.png[Admin terminal, width=600]
...
image::gui:webgui/opsi-webgui_opsisystem_healthcheck.png[Health check, width=600]
...
// image::gui:webgui/opsi-webgui_opsisystem_admin.png[Admin ]
...
image::gui:webgui/opsi-webgui_opsimodules.png[Modules, width=600]
// TODO: update image