...
* System: 
  ...
  - Health Check: An overview of the results of the {opsiconfd} HealthCheck (see xref:server/configuration-tools#opsi-manual-configuration-tools-health[opsi-server Health])
