...
The respective tables show elements that are reloaded with a delay when you scroll down or up. Use the image::gui:webgui/opsi-webgui_buttonclearselect.png[Clear selection] button to clear the selection for selected elements.
