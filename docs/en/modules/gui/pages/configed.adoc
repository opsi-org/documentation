...
`clientconfig.dhcpd.filename` is changed to `opsi/opsi-linux-bootimage/loader/shimx64.efi.signed` geändert. (For more infos cf xref:modules/uefi.adoc#opsi-manual-uefi[opsi with UEFI / GPT])
