...
image::gui:opsi-configed-hardwareinfo-treiberintegration.png["*opsi-configed*: Hardware Information, Driver Upload", width=800, pdfwidth=80%]
...
image::gui:opsi-configed-hostparameters.png["*opsi-configed*: Host Parameters in the Client Configuration", width=800, pdfwidth=80%]
