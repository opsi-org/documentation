...
image::gui:configed_toolbar_icons_filter.png["*opsi-configed*: Use this Icon to only show selected Clients.", pdfwidth=80%]
...
image::gui:opsi-configed-failedactions-today.png["*opsi-configed*: Search for Failed Actions.", width=800, pdfwidth=80%]
