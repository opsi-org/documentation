...
image::gui:opsi-configed-toolbar-left.png["*opsi-configed*: Icons on the Left", pdfwidth=80%]
...
image::gui:opsi-configed-toolbar-right.png["*opsi-configed*: Icons on the Right", pdfwidth=80%]
