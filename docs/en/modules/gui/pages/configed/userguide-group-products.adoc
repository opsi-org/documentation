...
image::gui:configed_groupaction_localimage.png["*opsi-configed*: Group Actions (for *opsi-local-image*)", width=800, pdfwidth=80%]
...
image::gui:configed_package-actions.png["*opsi-configed*: Package and Product Actions", width=800, pdfwidth=80%]
