...
TIP: Alternatively, you can download the version tailored to your operating system through a web browser. Simply navigate to `\https://<opsidepotserver>:4447/`, go to the _Links_ tab, and click on the relevant download link.
