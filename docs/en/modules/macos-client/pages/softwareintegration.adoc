...
include::common:partial$os-lib-uib-macosinstalllib.adoc[leveloffset=-1]
...
include::common:partial$firststeps_opsi-template-mac.adoc[]
...
include::common:partial$setup-detector-installation.asciidoc[leveloffset=-1]
...
include::common:partial$setup-detector-use-start.asciidoc[leveloffset=-1]

// include docu: macos specific tasks in opsi-setup-detector
include::common:partial$osd_tasks_macos.asciidoc[leveloffset=-1]
...
include::common:partial$osd-task-use-single-analyze-and-create.asciidoc[leveloffset=-1]
