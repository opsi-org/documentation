...
To do this, the following parameter is set in the '[control_server]' section of `opsiclientd.conf`:
[source,configfile]
----
interface = ::1, 127.0.0.1
----
Commands can then only be sent to the client via the opsi message bus.
