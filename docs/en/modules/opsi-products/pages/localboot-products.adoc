...
The 'opsi-client-agent' is the client agent of opsi and is described in detail above: see chapter xref:clients:winodws-client/windows-client-agent.adoc#opsi-manual-clientagent[opsi-client-agent].
...
For details see here: xref:server:components/commandline.adoc#server-components-opsi-wakeup-clients[opsi-wakeup-clients, opsi-auto-update and working_window]
