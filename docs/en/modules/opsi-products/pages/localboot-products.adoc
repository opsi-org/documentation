...
The 'opsi-client-agent' is the client agent of opsi and is described in detail above: see chapter xref:clients:winodws-client/windows-client-agent#opsi-manual-clientagent[opsi-client-agent].
