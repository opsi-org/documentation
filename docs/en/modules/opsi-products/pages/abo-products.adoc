...
[source,shell]
----
# Example: Install packages for mshotfix, OS WindowsServer 2016 / 2019 / 2022 / Windows 11 22H2/23H2/24H2/25H2
...
It is possible to install only required packages, e.g. only the packages to update Windows Windows 11 22h2/23H2/24H2/25H2:
[source,shell]
----
...
The opsi-mshotfix package uses Microsoft's update catalog file wsusscn2.cab to identify the required patches.
...
|==========================================
|OS
|Windows 10 / Windows 2016 / Windows 2019 / Windows 2022 / WIndows 2025
|Windows 11
|==========================================
...
|Windows 10 2021LTSC| 32/64Bit | mshotfix-win10-2009-x86-glb mshotfix-win10-2009-x64-glb
...
|Windows 11 24h2/25H2// Windows Server 2025 | 64Bit | mshotfix-win11-24h2
|=======================
...
Package for installing NET Framework versions 4.7 and higher.
...
----
ooffice						4.1.16-1									Apache OpenOffice
----
...
===  Open JRE / JDK 11 LTS / JDK 17 LTS  / JDK 21 LTS: javavm
----
javavm						 11.0.29or17.0.17or21.0.9-1 JDK 11, 17 or 21
----
The javavm-package contains the Open JDK 11 LTS implementations from Amazon (Amazon Corretto)
...
values: ["21amazoncorretto","17amazoncorretto","jdkamazoncorretto"]
default: ["jdksap"]
