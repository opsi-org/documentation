...
.*opsi-configed*: Login
image::first-steps:opsi-configed-login.png["*opsi-configed*: Login", pdfwidth=80%]

If your login is successful, the main window will be displayed:

.*opsi-configed*: Main Window
image::first-steps:opsi-configed-clients.png["*opsi-configed*: Main Window", width=800, pdfwidth=80%]
