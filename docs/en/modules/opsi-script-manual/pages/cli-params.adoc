...
image::opsi-script-manual:testsyntax_ok_configed_en.png[Testsyntax Result in the opsi-configed: 1. line: failed, 2.line: success, pdfwidth=50%]
...
image::opsi-script-manual:opsi-script-interactive.png["Screenshot: opsi-script in interactive mode", pdfwidth=90%]
