...
CAUTION: The old function `LogLevel=` is discouraged since _opsi-script_ version 4.10.3. For backward compatibility reasons Loglevels ste by this old function will be increased by 4 before they are used.
...
CAUTION: Working with regular expressions has some disadvantages: +
