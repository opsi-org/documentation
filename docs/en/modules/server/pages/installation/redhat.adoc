...
= Installation on RHEL/AlmaLinux/Rocky Linux/Oracle Linux

This chapter focuses on the package-based installation process of an opsi server on Red Hat Enterprise Linux (RHEL), AlmaLinux, Rocky Linux and Oracle Linux.
...
Depending or Oracle Linux 8, 9 or 10 is being used.
...
Depending it Redhat 8, 9 or 10 is the operating system.
