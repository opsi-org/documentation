...
image::server:oqi.png["Choose the Language and a Setup Type.", pdfwidth=80%]
...
image::server:oqiInfo.png["Screenshot: Hover the mouse over the small icon to display more information.", width=800, pdfwidth=80%]
...
image::server:quickinstall_l-opsi-server.png["The opsi server installation is running.", pdfwidth=80%]
...
image::server:oqiFailed.png["If the installation fails, please check the logfiles for error messages.", pdfwidth=80%]
...
image::server:quickinstallNoGuiFailed.png["The setup program provides information about errors and logfiles.", width=800, pdfwidth=80%]
