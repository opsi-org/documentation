...
In a multi-depot environment the upgrade must be done first on the config server and then on the depots.
...
Before you start upgrading your opsi environment, you should run an upgrade check that will give you hints about potential problems.
...
If possible, fix any problems that are indicated before you proceed with the upgrade.
