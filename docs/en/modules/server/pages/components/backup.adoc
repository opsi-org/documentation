...
CAUTION: By default, restoring a backup does not include configuration files or Redis data. To restore this data, you need to use the parameters `--redis-data` or `--config-files`.
