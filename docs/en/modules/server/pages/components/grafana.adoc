...
image::server:opsiconfd-grafana-hour.png["Displays *opsiconfd* metrics for the last 3 hours.", pdfwidth=80%]

.Shows *opsiconfd* metrics for the last day.
image::server:opsiconfd-grafana-day.png["Shows *opsiconfd* metrics for the last day.", pdfwidth=80%]
