...
.The role of the server is defined in the */etc/opsi/opsi.conf* configuration file.
image::opsi-conf.png["The role of the server is defined in the */etc/opsi/opsi.conf* configuration file.", pdfwidth=80%]
