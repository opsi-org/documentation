...
NOTE: If you run the opsi server as a Docker container, environment variables control the behavior (see section xref:modules:server/installation/docker.adoc#server-installation-docker-compose[Docker Compose]).
...
image::opsi-webinterface-info.png["You can also view the `opsiconfd` configuration on the _Info_ tab.", pdfwidth=80%]
...
image::opsi-webinterface-maintenance.png["The _Maintenance_ (en)tab activates maintenance mode and displays the current status.", pdfwidth=80%]
...
image::opsi-webinterface-2fa.png["You can set up two-factor authentication on the _Users_ tab.", pdfwidth=80%]
...
image::opsi-webinterface-blocked-clients.png["On this tab you can see a list of blocked clients and release them again if necessary.", width=800, pdfwidth=80%]
...
image::opsi-webinterface-depot.png["Enter new opsi depots on this tab.", pdfwidth=80%]
...
image::opsi-webinterface-depot-lock.png["Are there locked products? The _Depots_ tab shows these and provides a button to unlock them.", width=800, pdfwidth=80%]
...
image::opsi-webinterface-rpc-list.png["In this table you can see the last RPC calls.", pdfwidth=80%]
...
image::opsi-webinterface-rpc-interface.png["You can execute JSON-RPC-API methods via this tab.", pdfwidth=80%]
...
image::opsi-webinterface-redis.png["Show information about Redis on this tab.", pdfwidth=80%]
...
image::opsi-webinterface-addons.png["Install addons and display information about them.", width=800, pdfwidth=80%]
...
image::opsi-webinterface-log-viewer.png["The admin page provides quick access to the `opsiconfd` log files.", pdfwidth=80%]
...
image::opsi-webinterface-terminal.png["Open a terminal on the opsi server via this tab.", pdfwidth=80%]
...
image::opsi-webinterface-messagebus.png["Communicate with the opsi message bus via this tab.", pdfwidth=80%]
...
image::opsi-webinterface-licensing.png["Information about licenses for the extensions can be found on this tab.", pdfwidth=80%]
