...
image::server:opsi-conf.png["The Server Role is defined in the */etc/opsi/opsi.conf* Configuration File.", pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-info.png["The Configuration of *opsiconfd* is accessible for Review on the *Info* Tab.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-maintenance.png["The *Maintenance* Tab (de)activates Maintenance Mode and displays the Current Status.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-users.png["You can set up Two-Factor Authentication on the *Users* Tab.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-blocked-clients.png["On this Tab, a list of Blocked Clients is displayed, and you have the Option to unblock them if necessary.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-depots-1.png["Add additional Depot Servers on this Tab.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-depots-2.png["Are there any Locked Products? The *Depots* Tab will display these and provide a Button to unlock them.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-rpc-info.png["This Table shows the last RPC Calls.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-rpc-interface.png["You can execute JSON-RPC API Methods through this Tab.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-redis-interface.png["This Tab provides a Display of Information related to Redis.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-addons.png["This Tab is used for installing Addons and provides detailed Information about each one.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-log-viewer.png["The Admin Page provides quick Access to the *opsiconfd* Logfiles.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-terminal.png["Open a Terminal on the opsi Server through this Tab.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-messagebus.png["Communicate with the opsi Message Bus through this Tab.", width=800, pdfwidth=80%]
...
image::server:opsiconfd/opsiconfd-admin-licensing.png["Information about Licenses for the Extensions can be found on this Tab.", pdfwidth=80%]

NOTE: Previous versions of opsi used the `/etc/opsi/modules` file for activation and licensing purposes. While this method remains valid, new licenses are now issued exclusively in the new format. If you require a license file in the new format, please contact  mailto:sales@uib.de[sales@uib.de] for assistance.
