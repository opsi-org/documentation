...
image::server:1stboot-language-selection.png["Select the language for your new opsi server.", pdfwidth=80%]
...
image::server:1st-startup-mask.png["The script *1stboot.py* assists you in setting up the network configuration.", pdfwidth=80%]
