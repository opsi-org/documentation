...
* `http_proxy`: This sets up the proxy for HTTP connections. It requires a complete URL (not just the hostname and port). If authentication is required, include it in the URL: +
