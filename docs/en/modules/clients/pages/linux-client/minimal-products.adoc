...
////
NOTE: Please note that OS installation products such as win10-x64 are not immediately ready for use after installation. The installation has to be supplemented by the installation files of the corresponding installation medium (see: <<firststeps-osinstall-fill-base-packages>>).
