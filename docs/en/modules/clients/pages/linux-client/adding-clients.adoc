...
Once the agent is installed, existing opsi products can be xref:clients:linux-client/rollout-products.adoc#firststeps-software-deployment-product-tests[installed] on these clients.
