...
image::clients:macos_sharing_ssh_login.png["Activate SSH access on macOS.", pdfwidth=80%]
...
image::clients:opsi-deploy-agent.png["*opsi-deploy-client-agent*: Online Help", width=800, pdfwidth=80%]
