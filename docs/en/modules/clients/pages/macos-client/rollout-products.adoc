...
image::clients:install-m-homebrew.png["Install the two products *m-xcode-tools* and *m-homebrew*.", width=800, pdfwidth=80%]
...
image::clients:install-mac-opsi-configed.png["Install the Product *opsi-configed*." width=800, pdfwidth=80%]
