...
<<opsi-getting-started-installation-base-quickinstall>>, and the <<opsi-getting-started-installation-base-packages>> on Debian, Ubuntu, openSUSE/Suse Linux Enterprise Server (SLES), CentOS, Red Hat Enterprise Linux (RHEL), Alma Linux, Rocky Linux, as well as the <<opsi-getting-started-installation-base-ucs>>.
