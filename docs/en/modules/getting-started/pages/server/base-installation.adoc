...
Install a new client with _File_ / _Deploy OVF Template_ and browse to the location of the `.ovf` file.
* Click next, give the server a name, click _Next_, check the summary, and finally click _Finish_.

*VirtualBox* 

* Select _File / _Import Appliance_.
...
.Select the Language of your new opsi Server.
image::1stboot-language-selection.png["Select the Language of your new opsi Server.", pdfwidth=80%]

The opsi server will now be adapted to your network environment.
...
image::opsiserver_start_gui.png["Screenshot: View of newly started opsi-server", pdfwidth=80%]
...
* * Open the start menu and navigate to a terminal application (menu _System Tools_ ).
