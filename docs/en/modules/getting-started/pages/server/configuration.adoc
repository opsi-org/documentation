...
By default, the MySQL backend is used for inventory data. It is possible to use the file-based backend for inventory--this is significantly slower, though.
