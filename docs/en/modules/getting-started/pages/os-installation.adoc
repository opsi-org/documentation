...
For the following chapter you should create a corresponding client in opsi (xref:adding-clients.adoc#opsi-getting-started-firststeps-osinstall-create-client[Creation of a new opsi client]).
This can be done easily xref:opsiconfiged.adoc#opsi-getting-started-firststeps-osinstall-create-client[through {opsi-configed}].
