...
+
image::contribute:readme/opsidoc-edit-page-en.png["Click _Edit this Page_ in your web browser"]
+
...
+
image::contribute:readme/opsidoc-gitlab-login.png["Log into our opsi GitLab instance"300]
+
. After logging in, the GitLab editor opens.
+
image::contribute:readme/opsidoc-edit.png["The GitLab editor"]
+
