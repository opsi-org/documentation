...
+
image::contribute:readme/opsidoc-gitlab-register.png["Registering for the opsi GitLab Instance",300]
+
...
+
image::contribute:readme/opsidoc-gitlab-welcome.png["Choosing a role for the opsi GitLab Instance",300]
+
